...
class Graph(object):  # pylint: disable=too-many-public-methods
    ...
    * edges_hdf: hana_ml.DataFrame of the edges
    ...
    def describe(self) -> pd.Series:
        ...
        desc_series = desc_series.concat(describer.self_loops)
        desc_series = desc_series.concat(describer.degree)
        desc_series = desc_series.concat(describer.density)

        try:
            # Not supported on on-prem, so it won't be added
            desc_series = desc_series.concat(describer.triangles_count)
            desc_series = desc_series.concat(describer.is_connected)
