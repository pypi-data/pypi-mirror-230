...
from .model import (
    ...
    AccountTakeoverServiceUnavailableErrorDeserializationContract,
...
class FraudPreventionV2Client:
    def __init__(self, client_config: ClientConfig):
        ...
        sdk_metadata = "expediagroup-fraudpreventionv2-python-sdk/2.0.0"
    ...
    def screen_account(
        ...
        error_responses = {
            ...
            503: AccountTakeoverServiceUnavailableErrorDeserializationContract,
