...
def load_slingshot_project_config(
    ...
    if force_reload or not _cached_config or config_path != _cached_config_path:
        _cached_config = _load_slingshot_project_config(config_path, silence_warnings=silence_warnings)
...
def _load_slingshot_project_config(config_path: Path, silence_warnings: bool = False) -> schemas.ProjectManifest:
    """
