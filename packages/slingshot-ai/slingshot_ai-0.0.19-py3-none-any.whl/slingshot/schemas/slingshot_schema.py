...
class LabelStudioComponentSpec(AbstractComponentSpec):
    ...
    def get_default_import_run() -> RunSpec:
        return RunSpec(
            ...
            mounts=[
                DownloadMountSpec(path="/mnt/data", selector=MountSelector(name="dataset")),
                DownloadMountSpec(path="/mnt/annotations", selector=MountSelector(name="annotations")),
            ],
        )
    ...
    def get_default_export_run() -> RunSpec:
        return RunSpec(
            ...
            mounts=[UploadMountSpec(path="/mnt/annotations", target=MountTarget(name="annotations"))],
