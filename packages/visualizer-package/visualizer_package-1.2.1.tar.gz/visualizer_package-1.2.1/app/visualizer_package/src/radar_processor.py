...
from utils import *
from cfar_detector import CA_CFAR
...
class RadarProcessor:
    ...
    def cal_doppler_fft(self, rangeProfile):
        ...
        return fftshift(fft(rangeProfile[self.RMinIdx:self.RMaxIdx, :], fftCfg['NFFTVel'], 1), 1)

    def cal_angle_fft(self, rangeProfile):
        '''# apply fft on each antenna to get angle profile'''
        return fftshift(fft(rangeProfile[self.RMinIdx:self.RMaxIdx, :], fftCfg['NFFTAnt'], 2), 2)
