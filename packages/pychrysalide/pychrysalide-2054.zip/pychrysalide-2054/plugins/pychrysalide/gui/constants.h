 ...
 * constants.h - prototypes pour l'ajout des constantes liées à l'interface graphique
 *
...
#ifndef _PLUGINS_PYCHRYSALIDE_GUI_CONSTANTS_H
#define _PLUGINS_PYCHRYSALIDE_GUI_CONSTANTS_H
