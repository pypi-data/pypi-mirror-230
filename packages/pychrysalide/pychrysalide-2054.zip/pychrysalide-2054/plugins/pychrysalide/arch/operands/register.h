 ...
 * register.h - prototypes pour l'équivalent Python du fichier "arch/operands/register.h"
 *
...
#ifndef _PLUGINS_PYCHRYSALIDE_ARCH_OPERANDS_REGISTER_H
#define _PLUGINS_PYCHRYSALIDE_ARCH_OPERANDS_REGISTER_H
