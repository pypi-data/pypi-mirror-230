...
class DataOktaBrand(
    ...
    def __init__(
        ...
        *,
        ...
        :param brand_id: Brand ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.2/docs/data-sources/brand#brand_id DataOktaBrand#brand_id}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
