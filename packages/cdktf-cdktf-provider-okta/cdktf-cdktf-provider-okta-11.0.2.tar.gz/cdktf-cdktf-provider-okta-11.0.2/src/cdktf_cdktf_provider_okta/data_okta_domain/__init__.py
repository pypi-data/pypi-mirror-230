...
class DataOktaDomain(
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/okta/okta/4.4.1/docs/data-sources/domain okta_domain} Data Source.

        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param domain_id_or_name: Brand ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.1/docs/data-sources/domain#domain_id_or_name DataOktaDomain#domain_id_or_name}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
