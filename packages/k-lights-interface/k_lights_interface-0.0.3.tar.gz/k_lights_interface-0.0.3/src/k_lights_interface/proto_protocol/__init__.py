...
class RequestMessage(betterproto.Message):
    ...
    request_param1: Optional[int] = betterproto.int32_field(
        2, optional=True, group="_request_param1"
    )
...
class CalibrationDataChannelBasicMessage(betterproto.Message):
    channel_index: Optional[int] = betterproto.int32_field(
        1, optional=True, group="_channelIndex"
    )
    x: Optional[float] = betterproto.float_field(2, optional=True, group="_x")
    y: Optional[float] = betterproto.float_field(3, optional=True, group="_y")
    ynorm: Optional[float] = betterproto.float_field(4, optional=True, group="_Ynorm")
    lux_measured_during_calibration: Optional[float] = betterproto.float_field(
        5, optional=True, group="_luxMeasuredDuringCalibration"
    )
    watt_draw_at_measured_output: Optional[float] = betterproto.float_field(
        6, optional=True, group="_wattDrawAtMeasuredOutput"
    )
    output_value_when_measured: Optional[float] = betterproto.float_field(
        7, optional=True, group="_outputValueWhenMeasured"
    )
    emitter_temperature_when_measured: Optional[float] = betterproto.float_field(
        8, optional=True, group="_emitterTemperatureWhenMeasured"
    )
    number_of_output_vs_lux_measurements: Optional[int] = betterproto.int32_field(
        9, optional=True, group="_numberOfOutputVsLuxMeasurements"
    )
    temperature_compensation_enabled: Optional[bool] = betterproto.bool_field(
        10, optional=True, group="_temperatureCompensationEnabled"
    )
    x_xy_drift_temperature_compensation_enabled: Optional[
        bool
    ] = betterproto.bool_field(
        11, optional=True, group="_x_xyDriftTemperatureCompensationEnabled"
    )
    y_xy_drift_temperature_compensation_enabled: Optional[
        bool
    ] = betterproto.bool_field(
        12, optional=True, group="_y_xyDriftTemperatureCompensationEnabled"
    )
    current_per_output: Optional[float] = betterproto.float_field(
        13, optional=True, group="_currentPerOutput"
    )
    transistor_temperature_when_measured: Optional[float] = betterproto.float_field(
        14, optional=True, group="_transistorTemperatureWhenMeasured"
    )


@dataclass(eq=False, repr=False)
class CalibrationDataLightBasicMessage(betterproto.Message):
    version: Optional[int] = betterproto.int32_field(
        11, optional=True, group="_version"
    )
    number_of_channels: Optional[int] = betterproto.int32_field(
        1, optional=True, group="_numberOfChannels"
    )
    distance_to_sensor_in_cm: Optional[float] = betterproto.float_field(
        2, optional=True, group="_distanceToSensorInCm"
    )
    white_light_constant_light_level_max_y: Optional[float] = betterproto.float_field(
        3, optional=True, group="_whiteLightConstantLightLevelMaxY"
    )
    colored_light_constant_light_level_max_y: Optional[float] = betterproto.float_field(
        4, optional=True, group="_coloredLightConstantLightLevelMaxY"
    )
    maximum_watt_draw_for_light: Optional[float] = betterproto.float_field(
        5, optional=True, group="_maximumWattDrawForLight"
    )
    index_of_red_channel: Optional[int] = betterproto.int32_field(
        6, optional=True, group="_indexOfRedChannel"
    )
    index_of_green_channel: Optional[int] = betterproto.int32_field(
        7, optional=True, group="_indexOfGreenChannel"
    )
    index_of_blue_channel: Optional[int] = betterproto.int32_field(
        8, optional=True, group="_indexOfBlueChannel"
    )
    index_of_channel_used_in_optimized_lookup: Optional[int] = betterproto.int32_field(
        9, optional=True, group="_indexOfChannelUsedInOptimizedLookup"
    )
    booster_voltage_div_efficiency: Optional[float] = betterproto.float_field(
        10, optional=True, group="_boosterVoltageDivEfficiency"
    )
    idle_wattage: Optional[float] = betterproto.float_field(
        12, optional=True, group="_idleWattage"
    )
...
class LinearInterpolationMessage(betterproto.Message):
    ...
    ] = betterproto.enum_field(1, optional=True, group="_linearInterpolationAxisId")
    function_index: Optional[int] = betterproto.int32_field(
        2, optional=True, group="_functionIndex"
    )
    offset: Optional[int] = betterproto.uint32_field(3, optional=True, group="_offset")
...
class CalibrationDataLinearInterpolationMessage(betterproto.Message):
    ...
    channel_index: Optional[int] = betterproto.int32_field(
        2, optional=True, group="_channelIndex"
    )
    linear_interpolation_message: Optional[
        "LinearInterpolationMessage"
    ] = betterproto.message_field(3, optional=True, group="_linearInterpolationMessage")
...
class CalibrationDataChannelArrayMessage(betterproto.Message):
    ...
    ] = betterproto.enum_field(2, optional=True, group="_cDataChannelArrayId")
    array: Optional["ArrayMessage"] = betterproto.message_field(
        3, optional=True, group="_array"
    )
...
class CalibrationDataFlashMessage(betterproto.Message):
    flash_contains_valid_calibration_data: Optional[bool] = betterproto.bool_field(
        1, optional=True, group="_flashContainsValidCalibrationData"
    )
    number_of_channels: Optional[int] = betterproto.int32_field(
        2, optional=True, group="_numberOfChannels"
    )
...
class CurrentLightOutputMessage(betterproto.Message):
    ...
    current_light_compensation_message: Optional[
        "LightCompensationMessage"
    ] = betterproto.message_field(
        9, optional=True, group="_currentLightCompensationMessage"
    )
...
class StrobeEffectParams(betterproto.Message):
    # oneof color_type {   CCTMessage cct = 1;   RGBMessage rgb = 2;   HSIMessage
    # hsi = 3;   XYMessage xy = 4; }
    color: Optional["MultiColorMessage"] = betterproto.message_field(
        1, optional=True, group="_color"
    )
...
class DriverMessage(betterproto.Message):
    # Epos 300: used to pass a message through the controller to the lamphead The
    # controller will send the contained driverMessage to the lamphead, and reply
    # with the response.
