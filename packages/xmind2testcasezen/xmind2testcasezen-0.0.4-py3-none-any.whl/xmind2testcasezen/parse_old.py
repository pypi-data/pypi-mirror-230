...
class ParseOld(ParseXmind):
    ...
    def parse_a_testcase(self, case_dict, parent):
        ...
        testcase.label = self.get_test_label(topics)
    ...
    def get_test_label(self, topics):
        return list_get([topic["label"] for topic in topics if topic["label"]], -1, [])
