...
class ProjectResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "internal_id", "name", "users", "data_count", "feedback_types", "team_id", "created_at", "updated_at", "active_experiment", "active_config", "config_type", "active_evaluators", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "internal_id", "name", "users", "data_count", "feedback_types", "team_id", "created_at", "updated_at", "active_experiment", "active_config", "config_type", "active_evaluators", ], str]):
