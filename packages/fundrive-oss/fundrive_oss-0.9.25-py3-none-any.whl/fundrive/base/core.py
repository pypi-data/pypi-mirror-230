...
def download_by_request(url, file_path, size=None, overwrite=False) -> bool:
    ...
    with requests.Session() as sess:
        ...
        with open(file_path, "wb") as file:
            with tqdm(total=size, ncols=120, desc=file_path, unit="B", unit_scale=True, unit_divisor=1024) as bar:
