...
def main() -> int:
    ...
    static_folder = os.path.join(
        project_root, cli_args.static_folder)
    templates_folder = os.path.join(
        project_root, cli_args.templates_folder)
    root_layout_template = os.path.join(
        templates_folder, cli_args.template_root_layout)
    live_reload_file = os.path.join(
        static_folder, cli_args.live_reload_file)
    twcss_file = os.path.join(
        static_folder, cli_args.twcss_file)
    minified_twcss_file = os.path.join(
        static_folder, cli_args.minified_twcss_file)
    tw_content_glob = f'{templates_folder}/{cli_args.templates_glob}'
