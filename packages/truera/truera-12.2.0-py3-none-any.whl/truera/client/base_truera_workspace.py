...
class BaseTrueraWorkspace(ABC):
    ...
    def add_data_split(
        ...
        **DEPRECATED**: This function is no longer supported. Use `add_data` function instead.
    ...
    def add_data_split_no_features_for_model(
        ...
        **DEPRECATED**: This function is no longer supported. Use `add_data` function instead.
        ...
        """
        self.logger.warning(
            "`add_data_split_no_features_for_model()` is being deprecated. Please use `add_data()` instead."
        )
                ...
                for data_split in data_splits:
                    ...
                    for computation in computations:
                        if computation == "predictions":
                            ...
                            self.compute_feature_influences(ingest=True)
                        elif computation == "error influences":
                            self.compute_error_influences(ingest=True)
                        else:
                            raise ValueError(
