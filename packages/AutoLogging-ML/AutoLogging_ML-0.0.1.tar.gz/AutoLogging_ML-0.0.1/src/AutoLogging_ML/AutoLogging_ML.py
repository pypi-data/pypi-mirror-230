...
class AutoLogging_ML():
        def train_and_log_classification(x_train,y_train,x_test,y_test):
                model=['svm-linear','svm-rbf','knn','naive bayes','decision tree','random forest','adaboost','gradient boost','xgboost','logistic regression','bagging classifier']
