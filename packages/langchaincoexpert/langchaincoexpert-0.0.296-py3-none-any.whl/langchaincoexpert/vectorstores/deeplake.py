...
class DeepLake(VectorStore):
    ...
    Example:
        .. code-block:: python
                ...
                from langchaincoexpert.vectorstores import DeepLake
                from langchaincoexpert.embeddings.openai import OpenAIEmbeddings

                embeddings = OpenAIEmbeddings()
                vectorstore = DeepLake("langchaincoexpert_store", embeddings.embed_query)
    """

    _langchaincoexpert_DEFAULT_DEEPLAKE_PATH = "./deeplake/"

    def __init__(
        self,
        dataset_path: str = _langchaincoexpert_DEFAULT_DEEPLAKE_PATH,
        ...
        **kwargs: Any,
        ...
        Args:
            dataset_path (str): Path to existing dataset or where to create
                a new one. Defaults to _langchaincoexpert_DEFAULT_DEEPLAKE_PATH.
