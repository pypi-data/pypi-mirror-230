...
from langchaincoexpert import schema
from langchaincoexpert.chat_loaders.base import BaseChatLoader, ChatSession

logger = logging.getLogger(__name__)


class TelegramChatLoader(BaseChatLoader):
    """Load `telegram` conversations to langchaincoexpert chat messages.
