"""Helper functions for deprecating parts of the langchaincoexpert API.
...
class langchaincoexpertDeprecationWarning(DeprecationWarning):
    """A class for issuing deprecation warnings for langchaincoexpert users."""
    ...
    *,
    ...
    if not message:
        ...
        if pending:
            ...
            message += f" was deprecated in langchaincoexpert {since}"
    ...
    warning_cls = PendingDeprecationWarning if pending else langchaincoexpertDeprecationWarning
    warning = warning_cls(message)
    warnings.warn(warning, category=langchaincoexpertDeprecationWarning, stacklevel=2)
...
def suppress_langchaincoexpert_deprecation_warning() -> Generator[None, None, None]:
    """Context manager to suppress langchaincoexpertDeprecationWarning."""
    with warnings.catch_warnings():
        warnings.simplefilter("ignore", langchaincoexpertDeprecationWarning)
        yield
