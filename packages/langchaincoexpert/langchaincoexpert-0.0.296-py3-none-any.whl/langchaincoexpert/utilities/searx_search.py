...
Then create a searx search instance like this:
    ...
    .. code-block:: python
        ...
        from langchaincoexpert.utilities import SearxSearchWrapper
...
For example the following query:
    ...
    .. code-block:: python
        ...
        s = SearxSearchWrapper("langchaincoexpert library", engines=['github'])

        # can also be written as:
        s = SearxSearchWrapper("langchaincoexpert library !github")
        # or even:
        s = SearxSearchWrapper("langchaincoexpert library !gh")
...
engines.
    ...
    .. code-block:: python
        ...
        s = SearchWrapper("langchaincoexpert library", query_suffix="!gh")


        s = SearchWrapper("langchaincoexpert library")
...
from langchaincoexpert.pydantic_v1 import (
    BaseModel,
    Extra,
    Field,
    PrivateAttr,
