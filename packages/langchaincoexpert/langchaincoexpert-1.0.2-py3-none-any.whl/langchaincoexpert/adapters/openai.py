...
from langchaincoexpert.chat_loaders.base import ChatSession
...
def convert_openai_messages(messages: Sequence[Dict[str, Any]]) -> List[BaseMessage]:
    """Convert dictionaries representing OpenAI messages to langchaincoexpert format.

    Args:
        messages: List of dictionaries representing OpenAI messages

    Returns:
        List of langchaincoexpert BaseMessage objects.
    """
...
class ChatCompletion:
    ...
    def create(
        ...
        **kwargs: Any,
        ...
        models = importlib.import_module("langchaincoexpert.chat_models")
