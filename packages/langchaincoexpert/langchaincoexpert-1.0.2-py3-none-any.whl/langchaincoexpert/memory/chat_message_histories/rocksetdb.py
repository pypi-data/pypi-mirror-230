...
from langchaincoexpert.schema import BaseChatMessageHistory
from langchaincoexpert.schema.messages import BaseMessage, _message_to_dict, messages_from_dict
    ...
    Example:
        .. code-block:: python
            ...
            history = RocksetChatMessageHistory(
                ...
                collection="langchaincoexpert_demo",
                sync=True
            )
