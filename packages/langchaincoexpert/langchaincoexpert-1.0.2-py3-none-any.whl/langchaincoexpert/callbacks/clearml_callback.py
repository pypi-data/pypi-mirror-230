...
class ClearMLCallbackHandler(BaseMetadataCallbackHandler, BaseCallbackHandler):
    ...
    def __init__(
        ...
        project_name: Optional[str] = "langchaincoexpert_callback_demo",
        ...
        warning = (
            ...
            "https://github.com/allegroai/clearml/issues with the tag `langchaincoexpert`."
        )
        ...
        if langchaincoexpert_asset:
            ...
            try:
                ...
                output_model = clearml.OutputModel(
                    task=self.task, config_text=load_json(langchaincoexpert_asset_path)
                )
                output_model.update_weights(
                    weights_filename=str(langchaincoexpert_asset_path),
