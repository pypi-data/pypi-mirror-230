...
class WandbCallbackHandler(BaseMetadataCallbackHandler, BaseCallbackHandler):
    ...
    def __init__(
        ...
        project: Optional[str] = "langchaincoexpert_callback_demo",
    ...
    def flush_tracker(
        ...
        if langchaincoexpert_asset:
            ...
            try:
                ...
                model_artifact.add_file(str(langchaincoexpert_asset_path))
                model_artifact.metadata = load_json_to_dict(langchaincoexpert_asset_path)
            except ValueError:
