"""A Tracer implementation that records to langchaincoexpert endpoint."""
...
from langchaincoexpert.callbacks.tracers.schemas import Run, TracerSession
from langchaincoexpert.env import get_runtime_environment
from langchaincoexpert.load.dump import dumpd
from langchaincoexpert.schema.messages import BaseMessage

logger = logging.getLogger(__name__)
_LOGGED = set()
_TRACERS: weakref.WeakSet[langchaincoexpertTracer] = weakref.WeakSet()
...
class langchaincoexpertTracer(BaseTracer):
    """An implementation of the SharedTracer that POSTS to the langchaincoexpert endpoint."""
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """Initialize the langchaincoexpert tracer."""
        ...
        self.project_name = project_name or os.getenv(
            "langchaincoexpert_PROJECT", os.getenv("langchaincoexpert_SESSION", "default")
        )
        if use_threading:
    ...
    def _persist_run(self, run: Run) -> None:
        """The langchaincoexpert Tracer uses Post/Patch rather than persist."""
