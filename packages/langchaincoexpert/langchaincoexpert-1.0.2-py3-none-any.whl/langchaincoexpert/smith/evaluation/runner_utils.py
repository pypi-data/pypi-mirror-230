...
from langchaincoexpert.callbacks.manager import Callbacks
from langchaincoexpert.callbacks.tracers.evaluation import EvaluatorCallbackHandler
from langchaincoexpert.callbacks.tracers.langchaincoexpert import langchaincoexpertTracer, wait_for_all_tracers
from langchaincoexpert.chains.base import Chain
from langchaincoexpert.evaluation.loading import load_evaluator
from langchaincoexpert.evaluation.schema import EvaluatorType, StringEvaluator
from langchaincoexpert.schema import ChatResult, LLMResult
from langchaincoexpert.schema.language_model import BaseLanguageModel
from langchaincoexpert.schema.messages import BaseMessage, messages_from_dict
from langchaincoexpert.schema.runnable import Runnable, RunnableConfig, RunnableLambda
from langchaincoexpert.schema.runnable import config as runnable_config
from langchaincoexpert.schema.runnable import utils as runnable_utils
from langchaincoexpert.smith import evaluation as smith_eval
from langchaincoexpert.smith.evaluation import config as smith_eval_config
from langchaincoexpert.smith.evaluation import name_generation, progress
...
async def arun_on_dataset(
    ...
    **kwargs: Any,
    ...
    .. code-block:: python
        ...
        from langchaincoexpert.chat_models import ChatOpenAI
        from langchaincoexpert.chains import LLMChain
        from langchaincoexpert.smith import smith_eval.RunEvalConfig, arun_on_dataset
    ...
    :class:`StringEvaluator <langchaincoexpert.evaluation.schema.StringEvaluator>`
    or LangSmith's `RunEvaluator` classes.

    .. code-block:: python

        from typing import Optional
        from langchaincoexpert.evaluation import StringEvaluator
...
def run_on_dataset(
    ...
    **kwargs: Any,
    ...
    .. code-block:: python
        ...
        from langchaincoexpert.chat_models import ChatOpenAI
        from langchaincoexpert.chains import LLMChain
        from langchaincoexpert.smith import smith_eval.RunEvalConfig, run_on_dataset
