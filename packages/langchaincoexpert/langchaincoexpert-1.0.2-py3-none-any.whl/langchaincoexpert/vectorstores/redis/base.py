...
from langchaincoexpert._api import deprecated
from langchaincoexpert.callbacks.manager import (
    AsyncCallbackManagerForRetrieverRun,
    CallbackManagerForRetrieverRun,
)
from langchaincoexpert.docstore.document import Document
from langchaincoexpert.embeddings.base import Embeddings
from langchaincoexpert.utilities.redis import (
    _array_to_buffer,
    _buffer_to_array,
...
from langchaincoexpert.vectorstores.base import VectorStore, VectorStoreRetriever
from langchaincoexpert.vectorstores.redis.constants import (
    REDIS_REQUIRED_MODULES,
    REDIS_TAG_SEPARATOR,
)
from langchaincoexpert.vectorstores.utils import maximal_marginal_relevance
...
if TYPE_CHECKING:
    ...
    from langchaincoexpert.vectorstores.redis.filters import RedisFilterExpression
    from langchaincoexpert.vectorstores.redis.schema import RedisModel
...
class Redis(VectorStore):
    ...
    .. code-block:: python
        ...
        from langchaincoexpert.vectorstores import Redis
        from langchaincoexpert.embeddings import OpenAIEmbeddings
    ...
    schema according to the following rules:
        ...
        - All lists of strings are indexed as tag fields (joined by
            langchaincoexpert.vectorstores.redis.constants.REDIS_TAG_SEPARATOR)
    ...
    def from_texts_return_keys(
        ...
        **kwargs: Any,
        ...
        always present in the langchaincoexpert schema.
        ...
        try:
            ...
            from langchaincoexpert.vectorstores.redis.schema import read_schema
    ...
    def _get_schema_with_defaults(
        ...
        from langchaincoexpert.vectorstores.redis.schema import RedisModel, read_schema
