...
_langchaincoexpert_DEFAULT_EMBEDDING_DIM = 1536
_langchaincoexpert_DEFAULT_COLLECTION_NAME = "langchaincoexpert_document"
...
class AnalyticDB(VectorStore):
    ...
    def __init__(
        ...
        embedding_dimension: int = _langchaincoexpert_DEFAULT_EMBEDDING_DIM,
