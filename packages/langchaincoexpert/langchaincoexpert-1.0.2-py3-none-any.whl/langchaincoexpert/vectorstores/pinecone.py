...
from langchaincoexpert.utils.iter import batch_iterate
from langchaincoexpert.vectorstores.base import VectorStore
from langchaincoexpert.vectorstores.utils import DistanceStrategy, maximal_marginal_relevance
...
class Pinecone(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from langchaincoexpert.vectorstores import Pinecone
            ...
            index = pinecone.Index("langchaincoexpert-demo")
        ...
        **kwargs: Any,
        ...
        Example:
            .. code-block:: python
                ...
                from langchaincoexpert import Pinecone
                ...
                pinecone = Pinecone.from_texts(
                    texts,
                    embeddings,
                    index_name="langchaincoexpert-demo"
                )
        """
