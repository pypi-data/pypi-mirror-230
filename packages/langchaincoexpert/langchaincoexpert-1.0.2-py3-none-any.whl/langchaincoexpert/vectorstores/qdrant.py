...
from langchaincoexpert.vectorstores import VectorStore
...
class Qdrant(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from langchaincoexpert import Qdrant
    ...
    def similarity_search_with_score_by_vector(
        ...
        **kwargs: Any,
        ...
        results = self.client.search(
            ...
            offset=offset,
            with_payload=True,
            with_vectors=False,  # langchaincoexpert does not expect vectors to be returned
            score_threshold=score_threshold,
            consistency=consistency,
            **kwargs,
        )
