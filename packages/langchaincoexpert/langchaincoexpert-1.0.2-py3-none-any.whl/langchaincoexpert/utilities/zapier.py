...
For use-cases where langchaincoexpert + Zapier NLA is powering a user-facing application, and
langchaincoexpert needs access to the end-user's connected accounts on Zapier.com, you'll need
...
from langchaincoexpert.pydantic_v1 import BaseModel, Extra, root_validator
...
class ZapierNLAWrapper(BaseModel):
    ...
    For use-cases where langchaincoexpert + Zapier NLA is powering a user-facing application,
    and langchaincoexpert needs access to the end-user's connected accounts on Zapier.com,
