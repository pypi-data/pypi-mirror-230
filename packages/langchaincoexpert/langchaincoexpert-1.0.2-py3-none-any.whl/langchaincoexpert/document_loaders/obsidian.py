...
class ObsidianLoader(BaseLoader):
    ...
    def _to_langchaincoexpert_compatible_metadata(self, metadata: dict) -> dict:
        """Convert a dictionary to a compatible with langchaincoexpert."""
        result = {}
    ...
    def load(self) -> List[Document]:
        ...
        for path in paths:
            ...
            metadata = {
                ...
                **self._to_langchaincoexpert_compatible_metadata(front_matter),
                **dataview_fields,
            }
