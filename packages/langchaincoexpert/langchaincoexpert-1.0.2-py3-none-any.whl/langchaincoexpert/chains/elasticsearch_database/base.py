...
from langchaincoexpert.chains.elasticsearch_database.prompts import ANSWER_PROMPT, DSL_PROMPT
from langchaincoexpert.chains.llm import LLMChain
from langchaincoexpert.output_parsers.json import SimpleJsonOutputParser
from langchaincoexpert.pydantic_v1 import Extra, root_validator
from langchaincoexpert.schema import BaseLLMOutputParser, BasePromptTemplate
...
class ElasticsearchDatabaseChain(Chain):
    ...
    Example:
        .. code-block:: python
            ...
            from langchaincoexpert import ElasticsearchDatabaseChain, OpenAI
            from elasticsearch import Elasticsearch
