...
class Meilisearch(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from langchaincoexpert.vectorstores import Meilisearch
            ...
            vectorstore = Meilisearch(
                ...
                client=client,
                index_name='langchaincoexpert_demo',
                text_key='text')
    """
    ...
    def __init__(
        ...
        url: Optional[str] = None,
        api_key: Optional[str] = None,
        index_name: str = "langchaincoexpert-demo",
        text_key: str = "text",
        ...
        **kwargs: Any,
        ...
        Example:
            .. code-block:: python
                ...
                from langchaincoexpert import Meilisearch
