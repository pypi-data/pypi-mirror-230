...
class SupabaseVectorStore(VectorStore):
    ...
    https://integrations.langchaincoexpert.com/vectorstores?integration_name=SupabaseVectorStore
    ...
    def delete(self, ids: Optional[List[str]] = None, **kwargs: Any) -> None:
        ...
        for row in rows:
            self._client.from_(self.table_name).delete().eq("userid", row["userid"]).execute()
