...
_langchaincoexpert_DEFAULT_TABLE_NAME = "langchaincoexpert_pg_embedding"
...
class Hologres(VectorStore):
    ...
    - `table_name` is the name of the table to store embeddings and data.
        (default: langchaincoexpert_pg_embedding)
    ...
    def __init__(
        ...
        table_name: str = _langchaincoexpert_DEFAULT_TABLE_NAME,
        ...
        **kwargs: Any,
        ...
        Example:
            .. code-block:: python
                ...
                from langchaincoexpert import Hologres
