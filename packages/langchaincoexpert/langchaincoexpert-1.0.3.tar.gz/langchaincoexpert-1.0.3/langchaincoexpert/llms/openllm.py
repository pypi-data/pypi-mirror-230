...
from langchaincoexpert.pydantic_v1 import PrivateAttr
...
class OpenLLM(LLM):
    ...
    Example running an LLM model locally managed by OpenLLM:
        .. code-block:: python
            ...
            from langchaincoexpert.llms import OpenLLM
            llm = OpenLLM(
                model_name='flan-t5',
    ...
    def __init__(
        ...
        **llm_kwargs: Any,
        ...
        if server_url is not None:
            ...
            # the init_local here so that langchaincoexpert users can still use the LLM
    ...
    def runner(self) -> openllm.LLMRunner:
        ...
        .. code-block:: python
            ...
            svc = bentoml.Service("langchaincoexpert-openllm", runners=[llm.runner])
