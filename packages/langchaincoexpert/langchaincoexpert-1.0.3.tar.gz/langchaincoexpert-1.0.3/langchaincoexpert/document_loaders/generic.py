...
from langchaincoexpert.document_loaders.base import BaseBlobParser, BaseLoader
from langchaincoexpert.document_loaders.blob_loaders import BlobLoader, FileSystemBlobLoader
from langchaincoexpert.document_loaders.parsers.registry import get_parser
from langchaincoexpert.schema import Document
from langchaincoexpert.text_splitter import TextSplitter
...
class GenericLoader(BaseLoader):
    ...
    Examples:
       ...
       .. code-block:: python
        ...
        from langchaincoexpert.document_loaders import GenericLoader
        from langchaincoexpert.document_loaders.blob_loaders import FileSystemBlobLoader
        ...
        .. code-block:: python
            ...
            from langchaincoexpert.document_loaders.parsers.pdf import PyPDFParser
