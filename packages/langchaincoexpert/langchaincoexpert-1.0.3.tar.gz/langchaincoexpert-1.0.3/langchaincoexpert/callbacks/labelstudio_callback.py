...
class LabelStudioCallbackHandler(BaseCallbackHandler):
    ...
    Examples:
        ...
        >>> from langchaincoexpert.callbacks import LabelStudioCallbackHandler
        >>> handler = LabelStudioCallbackHandler(
        ...             api_key='<your_key_here>',
        ...             url='http://localhost:8080',
        ...             project_name='langchaincoexpert-%Y-%m-%d',
        ...             mode='prompt'
        ... )
    ...
    DEFAULT_PROJECT_NAME: str = "langchaincoexpert-%Y-%m-%d"
