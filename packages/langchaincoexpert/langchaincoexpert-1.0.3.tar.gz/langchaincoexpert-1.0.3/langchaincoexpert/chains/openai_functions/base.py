...
from langchaincoexpert.base_language import BaseLanguageModel
from langchaincoexpert.chains import LLMChain
from langchaincoexpert.output_parsers.openai_functions import (
    JsonOutputFunctionsParser,
    PydanticAttrOutputFunctionsParser,
    PydanticOutputFunctionsParser,
)
from langchaincoexpert.prompts import BasePromptTemplate
from langchaincoexpert.pydantic_v1 import BaseModel
from langchaincoexpert.schema import BaseLLMOutputParser
from langchaincoexpert.utils.openai_functions import convert_pydantic_to_openai_function
    ...
    **kwargs: Any,
    ...
    Example:
        .. code-block:: python
                ...
                from langchaincoexpert.chains.openai_functions import create_openai_fn_chain
    ...
    **kwargs: Any,
    ...
    Example:
        .. code-block:: python
                ...
                from langchaincoexpert.chains.openai_functions import create_structured_output_chain
                from langchaincoexpert.chat_models import ChatOpenAI
                from langchaincoexpert.prompts import ChatPromptTemplate
