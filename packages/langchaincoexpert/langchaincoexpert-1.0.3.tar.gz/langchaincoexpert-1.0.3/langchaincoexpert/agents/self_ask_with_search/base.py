...
from langchaincoexpert.agents.self_ask_with_search.output_parser import SelfAskOutputParser
from langchaincoexpert.agents.self_ask_with_search.prompt import PROMPT
...
class SelfAskWithSearchChain(AgentExecutor):
    ...
    Example:
        .. code-block:: python
            ...
            from langchaincoexpert import SelfAskWithSearchChain, OpenAI, GoogleSerperAPIWrapper
