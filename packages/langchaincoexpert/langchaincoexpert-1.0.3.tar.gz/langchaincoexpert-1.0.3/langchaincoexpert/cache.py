...
from langchaincoexpert.llms.base import LLM, get_prompts
from langchaincoexpert.load.dump import dumps
from langchaincoexpert.load.load import loads
from langchaincoexpert.schema import ChatGeneration, Generation
from langchaincoexpert.schema.cache import RETURN_VAL_TYPE, BaseCache
from langchaincoexpert.utils import get_from_env
from langchaincoexpert.vectorstores.redis import Redis as RedisVectorstore
...
class SQLiteCache(SQLAlchemyCache):
    ...
    def __init__(self, database_path: str = ".langchaincoexpert.db"):
...
class RedisSemanticCache(BaseCache):
    ...
    def __init__(
        ...
        .. code-block:: python
            ...
            from langchaincoexpert.cache import RedisSemanticCache
            from langchaincoexpert.embeddings import OpenAIEmbeddings

            langchaincoexpert.llm_cache = RedisSemanticCache(
...
class GPTCache(BaseCache):
    ...
    def __init__(
        ...
        .. code-block:: python
            ...
            langchaincoexpert.llm_cache = GPTCache(init_gptcache)
...
CASSANDRA_CACHE_DEFAULT_TABLE_NAME = "langchaincoexpert_llm_cache"
...
CASSANDRA_SEMANTIC_CACHE_DEFAULT_TABLE_NAME = "langchaincoexpert_llm_semantic_cache"
