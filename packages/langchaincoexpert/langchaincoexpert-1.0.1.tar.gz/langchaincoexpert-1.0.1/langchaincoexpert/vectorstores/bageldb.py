...
class Bagel(VectorStore):
    ...
    Example:
        .. code-block:: python
                ...
                from langchaincoexpert.vectorstores import Bagel
                vectorstore = Bagel(cluster_name="langchaincoexpert_store")
    """

    _langchaincoexpert_DEFAULT_CLUSTER_NAME = "langchaincoexpert"

    def __init__(
        self,
        cluster_name: str = _langchaincoexpert_DEFAULT_CLUSTER_NAME,
