...
class Vectara(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from langchaincoexpert.vectorstores import Vectara
    ...
    def add_files(
        ...
        **kwargs: Any,
        ...
        This method provides a way to use that API in langchaincoexpert
    ...
    def add_texts(
        ...
        **kwargs: Any,
        ...
        if doc_metadata:
            doc_metadata["source"] = "langchaincoexpert"
        else:
            doc_metadata = {"source": "langchaincoexpert"}
        doc = {
            "document_id": doc_id,
        ...
        **kwargs: Any,
        ...
        Example:
            .. code-block:: python
                ...
                from langchaincoexpert import Vectara
