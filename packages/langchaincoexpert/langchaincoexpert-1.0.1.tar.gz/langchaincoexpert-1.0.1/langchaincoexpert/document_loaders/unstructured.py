...
class UnstructuredFileLoader(UnstructuredBaseLoader):
    ...
    Examples
    --------
    from langchaincoexpert.document_loaders import UnstructuredFileLoader
...
class UnstructuredAPIFileLoader(UnstructuredFileLoader):
    ...
    Examples
    ```python
    from langchaincoexpert.document_loaders import UnstructuredAPIFileLoader
...
class UnstructuredFileIOLoader(UnstructuredBaseLoader):
    ...
    Examples
    --------
    from langchaincoexpert.document_loaders import UnstructuredFileIOLoader
