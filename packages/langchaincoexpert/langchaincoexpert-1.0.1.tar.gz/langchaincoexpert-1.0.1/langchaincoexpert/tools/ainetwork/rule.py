...
from langchaincoexpert.callbacks.manager import AsyncCallbackManagerForToolRun
from langchaincoexpert.pydantic_v1 import BaseModel, Field
from langchaincoexpert.tools.ainetwork.base import AINBaseTool, OperationType
...
## SET Example
- type: SET
- path: /apps/langchaincoexpert_project_1/$from/$to/$img
- eval: auth.addr===$from&&!getValue('/apps/image_db/'+$img)

## GET Example
- type: GET
- path: /apps/langchaincoexpert_project_1
"""  # noqa: E501
