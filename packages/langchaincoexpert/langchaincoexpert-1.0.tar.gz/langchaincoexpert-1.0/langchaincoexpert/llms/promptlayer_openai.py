...
from langchaincoexpert.llms import OpenAI, OpenAIChat
from langchaincoexpert.schema import LLMResult
...
class PromptLayerOpenAI(OpenAI):
    ...
    Example:
        .. code-block:: python
            ...
            from langchaincoexpert.llms import PromptLayerOpenAI
        ...
        **kwargs: Any,
        ...
        for i in range(len(prompts)):
            ...
            pl_request_id = promptlayer_api_request(
                "langchaincoexpert.PromptLayerOpenAI",
                "langchaincoexpert",
                [prompt],
                params,
                self.pl_tags,
        ...
        **kwargs: Any,
        ...
        for i in range(len(prompts)):
            ...
            pl_request_id = await promptlayer_api_request_async(
                "langchaincoexpert.PromptLayerOpenAI.async",
                "langchaincoexpert",
                [prompt],
                params,
                self.pl_tags,
...
class PromptLayerOpenAIChat(OpenAIChat):
    ...
    Example:
        .. code-block:: python
            ...
            from langchaincoexpert.llms import PromptLayerOpenAIChat
    ...
    def _generate(
        ...
        **kwargs: Any,
        ...
        for i in range(len(prompts)):
            ...
            params = {**self._identifying_params, **kwargs}
            pl_request_id = promptlayer_api_request(
                "langchaincoexpert.PromptLayerOpenAIChat",
                "langchaincoexpert",
                [prompt],
                params,
                self.pl_tags,
    ...
    async def _agenerate(
        ...
        **kwargs: Any,
        ...
        for i in range(len(prompts)):
            ...
            params = {**self._identifying_params, **kwargs}
            pl_request_id = await promptlayer_api_request_async(
                "langchaincoexpert.PromptLayerOpenAIChat.async",
                "langchaincoexpert",
                [prompt],
                params,
                self.pl_tags,
