...
from langchaincoexpert.chains.qa_with_sources.base import BaseQAWithSourcesChain
...
class VectorDBQAWithSourcesChain(BaseQAWithSourcesChain):
    ...
    def raise_deprecation(cls, values: Dict) -> Dict:
        warnings.warn(
            ...
            "please use `from langchaincoexpert.chains import RetrievalQAWithSourcesChain`"
        )
        return values
