...
from langchaincoexpert.schema import BaseStore
...
class CacheBackedEmbeddings(Embeddings):
    ...
    Examples:
        ...
        .. code-block: python
            ...
            from langchaincoexpert.embeddings import CacheBackedEmbeddings, OpenAIEmbeddings
            from langchaincoexpert.storage import LocalFileStore
