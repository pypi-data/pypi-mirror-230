...
from langchaincoexpert.pydantic_v1 import BaseSettings
...
class ClickhouseSettings(BaseSettings):
    ...
    Attribute:
        ...
        column_map (Dict) : Column type map to project column name onto langchaincoexpert
...
class Clickhouse(VectorStore):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """ClickHouse Wrapper to langchaincoexpert
