...
from langchaincoexpert.document_loaders.base import BaseLoader
from langchaincoexpert.document_loaders.blob_loaders import Blob
from langchaincoexpert.document_loaders.parsers.pdf import (
...
from langchaincoexpert.document_loaders.unstructured import UnstructuredFileLoader
...
class UnstructuredPDFLoader(UnstructuredFileLoader):
    ...
    langchaincoexpert Document object. If you use "elements" mode, the unstructured
    ...
    Examples
    --------
    from langchaincoexpert.document_loaders import UnstructuredPDFLoader
...
class AmazonTextractPDFLoader(BasePDFLoader):
    ...
    Example:
        .. code-block:: python
            from langchaincoexpert.document_loaders import AmazonTextractPDFLoader
