...
from langchaincoexpert.schema import ChatResult
...
class PromptLayerChatOpenAI(ChatOpenAI):
    ...
    Example:
        .. code-block:: python
            ...
            from langchaincoexpert.chat_models import PromptLayerChatOpenAI
        ...
        **kwargs: Any
        ...
        for i, generation in enumerate(generated_responses.generations):
            ...
            pl_request_id = promptlayer_api_request(
                "langchaincoexpert.PromptLayerChatOpenAI",
                "langchaincoexpert",
                message_dicts,
                params,
                self.pl_tags,
        ...
        **kwargs: Any
        ...
        for i, generation in enumerate(generated_responses.generations):
            ...
            pl_request_id = await promptlayer_api_request_async(
                "langchaincoexpert.PromptLayerChatOpenAI.async",
                "langchaincoexpert",
                message_dicts,
                params,
                self.pl_tags,
