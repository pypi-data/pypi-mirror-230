...
from langchaincoexpert.adapters.openai import convert_message_to_dict
from langchaincoexpert.chat_models.openai import (
    ChatOpenAI,
    _import_tiktoken,
)
...
class ChatAnyscale(ChatOpenAI):
    ...
    Example:
        .. code-block:: python
            ...
            from langchaincoexpert.chat_models import ChatAnyscale
