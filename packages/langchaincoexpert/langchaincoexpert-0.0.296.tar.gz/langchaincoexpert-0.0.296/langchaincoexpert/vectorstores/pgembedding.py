...
class CollectionStore(BaseModel):
    ...
    __tablename__ = "langchaincoexpert_pg_collection"
...
class EmbeddingStore(BaseModel):
    ...
    __tablename__ = "langchaincoexpert_pg_embedding"
...
class PGEmbedding(VectorStore):
    ...
    - `collection_name` is the name of the collection to use. (default: langchaincoexpert)
    ...
    def create_hnsw_index(
        ...
        create_index_query = sqlalchemy.text(
            "CREATE INDEX IF NOT EXISTS langchaincoexpert_pg_embedding_idx "
            "ON langchaincoexpert_pg_embedding USING hnsw (embedding) "
            "WITH ("
            "maxelements = {}, "
            "dims = {}, "
            "m = {}, "
