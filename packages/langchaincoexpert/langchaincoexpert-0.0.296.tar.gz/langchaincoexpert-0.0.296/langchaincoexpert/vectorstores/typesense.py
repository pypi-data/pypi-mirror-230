...
class Typesense(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from langchaincoexpert.embedding.openai import OpenAIEmbeddings
            from langchaincoexpert.vectorstores import Typesense
            import typesense
            ...
            typesense_collection_name = "langchaincoexpert-memory"
    ...
    def __init__(
        ...
        *,
        ...
        self._typesense_collection_name = (
            typesense_collection_name or f"langchaincoexpert-{str(uuid.uuid4())}"
        )
