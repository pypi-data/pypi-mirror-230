...
class DashVector(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from langchaincoexpert.vectorstores import dashvector
            from langchaincoexpert.embeddings.openai import OpenAIEmbeddings
            import dashvector

            client = dashvector.Client.init(api_key="***")
            client.create("langchaincoexpert")
            collection = client.get("langchaincoexpert")
    ...
    def from_texts(
        ...
        collection_name: str = "langchaincoexpert",
        text_field: str = "text",
        batch_size: int = 25,
        ids: Optional[List[str]] = None,
        **kwargs: Any,
