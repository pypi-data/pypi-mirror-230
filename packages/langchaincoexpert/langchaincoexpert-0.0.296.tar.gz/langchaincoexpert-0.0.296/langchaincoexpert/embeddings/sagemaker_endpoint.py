...
from langchaincoexpert.llms.sagemaker_endpoint import ContentHandlerBase
...
class SagemakerEndpointEmbeddings(BaseModel, Embeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from langchaincoexpert.embeddings import SagemakerEndpointEmbeddings
            endpoint_name = (
                "my-endpoint-name"
            )
            region_name = (
    ...
    """
     Example:
        ...
        from langchaincoexpert.embeddings.sagemaker_endpoint import EmbeddingsContentHandler
