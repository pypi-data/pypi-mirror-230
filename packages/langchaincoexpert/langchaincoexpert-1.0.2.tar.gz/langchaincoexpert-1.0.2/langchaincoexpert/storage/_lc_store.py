"""Create a key-value store for any langchaincoexpert serializable object."""
...
from langchaincoexpert.schema import BaseStore, Document
...
def create_lc_store(
    ...
    *,
    ...
    """Create a store for langchaincoexpert serializable objects from a bytes store.
...
def create_kv_docstore(
    ...
    *,
    ...
    """Create a store for langchaincoexpert Document objects from a bytes store.
