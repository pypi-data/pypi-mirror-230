...
from langchaincoexpert.evaluation.agents.trajectory_eval_prompt import (
    EVAL_CHAT_PROMPT,
    TOOL_FREE_EVAL_CHAT_PROMPT,
)
from langchaincoexpert.evaluation.schema import AgentTrajectoryEvaluator, LLMEvalChain
from langchaincoexpert.pydantic_v1 import Extra, Field
from langchaincoexpert.schema import AgentAction, BaseOutputParser, OutputParserException
...
class TrajectoryEvalChain(AgentTrajectoryEvaluator, LLMEvalChain):
    ...
    .. code-block:: python
        ...
        from langchaincoexpert.agents import AgentType, initialize_agent
        from langchaincoexpert.chat_models import ChatOpenAI
        from langchaincoexpert.evaluation import TrajectoryEvalChain
        from langchaincoexpert.tools import tool
