...
from langchaincoexpert.chains.constitutional_ai.models import ConstitutionalPrinciple
from langchaincoexpert.chains.llm import LLMChain
from langchaincoexpert.evaluation.criteria.prompt import PROMPT, PROMPT_WITH_REFERENCES
from langchaincoexpert.evaluation.schema import LLMEvalChain, StringEvaluator
from langchaincoexpert.pydantic_v1 import Extra, Field
from langchaincoexpert.schema import RUN_KEY, BaseOutputParser, BasePromptTemplate
...
class CriteriaEvalChain(StringEvaluator, LLMEvalChain, LLMChain):
    ...
    **kwargs : Any
    ...
    >>> from langchaincoexpert.evaluation.criteria import CriteriaEvalChain
    ...
    >>> from langchaincoexpert.evaluation.criteria import LabeledCriteriaEvalChain
