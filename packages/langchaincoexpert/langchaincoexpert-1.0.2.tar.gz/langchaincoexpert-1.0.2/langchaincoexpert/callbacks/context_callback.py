...
class ContextCallbackHandler(BaseCallbackHandler):
    ...
    Chat Example:
        >>> from langchaincoexpert.llms import ChatOpenAI
        >>> from langchaincoexpert.callbacks import ContextCallbackHandler
        ...
        ...     HumanMessage(content="I love programming with langchaincoexpert."),
        ... ]
        >>> chat(messages)
