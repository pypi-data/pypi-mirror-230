...
from langchaincoexpert.document_loaders.parsers.language.javascript import JavaScriptSegmenter
from langchaincoexpert.document_loaders.parsers.language.python import PythonSegmenter
from langchaincoexpert.text_splitter import Language
...
class LanguageParser(BaseBlobParser):
    ...
    Examples:
       ...
       .. code-block:: python
            ...
            from langchaincoexpert.text_splitter.Language
            from langchaincoexpert.document_loaders.generic import GenericLoader
            from langchaincoexpert.document_loaders.parsers import LanguageParser
