...
from langchaincoexpert.pydantic_v1 import BaseModel, root_validator, validator
...
class EmbaasBlobLoader(BaseEmbaasLoader, BaseBlobParser):
    ...
    Example:
        .. code-block:: python
            ...
            # Default parsing
            from langchaincoexpert.document_loaders.embaas import EmbaasBlobLoader
...
class EmbaasLoader(BaseEmbaasLoader, BaseLoader):
    ...
    Example:
        .. code-block:: python
            ...
            # Default parsing
            from langchaincoexpert.document_loaders.embaas import EmbaasLoader
