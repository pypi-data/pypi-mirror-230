...
from langchaincoexpert.chains.question_answering.stuff_prompt import PROMPT_SELECTOR
...
class RetrievalQA(BaseRetrievalQA):
    ...
    Example:
        .. code-block:: python
            ...
            from langchaincoexpert.chains import RetrievalQA
            from langchaincoexpert.faiss import FAISS
            from langchaincoexpert.vectorstores.base import VectorStoreRetriever
...
class VectorDBQA(BaseRetrievalQA):
    ...
    def raise_deprecation(cls, values: Dict) -> Dict:
        warnings.warn(
            ...
            "please use `from langchaincoexpert.chains import RetrievalQA`"
        )
        return values
