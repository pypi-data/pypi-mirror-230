...
from langchaincoexpert.chains.llm_bash.prompt import PROMPT
from langchaincoexpert.pydantic_v1 import Extra, Field, root_validator
from langchaincoexpert.schema import BasePromptTemplate, OutputParserException
...
class LLMBashChain(Chain):
    ...
    Example:
        .. code-block:: python
            ...
            from langchaincoexpert import LLMBashChain, OpenAI
