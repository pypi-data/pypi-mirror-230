...
from langchaincoexpert.chains.combine_documents.base import BaseCombineDocumentsChain
from langchaincoexpert.chains.combine_documents.stuff import StuffDocumentsChain
from langchaincoexpert.chains.conversational_retrieval.prompts import CONDENSE_QUESTION_PROMPT
from langchaincoexpert.chains.llm import LLMChain
from langchaincoexpert.chains.question_answering import load_qa_chain
from langchaincoexpert.pydantic_v1 import Extra, Field, root_validator
from langchaincoexpert.schema import BasePromptTemplate, BaseRetriever, Document
...
class ChatVectorDBChain(BaseConversationalRetrievalChain):
    ...
    def raise_deprecation(cls, values: Dict) -> Dict:
        warnings.warn(
            ...
            "please use `from langchaincoexpert.chains import ConversationalRetrievalChain`"
        )
        return values
