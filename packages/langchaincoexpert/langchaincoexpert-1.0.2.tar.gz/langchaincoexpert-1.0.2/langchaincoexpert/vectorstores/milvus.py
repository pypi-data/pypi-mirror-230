...
class Milvus(VectorStore):
    ...
    Example:
        ...
        from langchaincoexpert import Milvus
        ...
        milvus_store = Milvus(
            ...
            collection_name = "langchaincoexpertCollection",
            drop_old = True,
        )
    ...
    def __init__(
        self,
        embedding_function: Embeddings,
        collection_name: str = "langchaincoexpertCollection",
