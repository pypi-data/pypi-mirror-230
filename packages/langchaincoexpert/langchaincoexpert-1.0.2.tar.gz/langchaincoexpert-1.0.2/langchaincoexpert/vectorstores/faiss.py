...
from langchaincoexpert.docstore.base import AddableMixin, Docstore
...
class FAISS(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from langchaincoexpert.vectorstores import FAISS

            embeddings = OpenAIEmbeddings()
            texts = ["FAISS is an important library", "langchaincoexpert supports FAISS"]
        ...
        **kwargs: Any,
        ...
        Example:
            .. code-block:: python
                ...
                from langchaincoexpert import FAISS
