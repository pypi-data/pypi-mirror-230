...
from langchaincoexpert.adapters.openai import convert_dict_to_message, convert_message_to_dict
from langchaincoexpert.callbacks.manager import (
    CallbackManagerForLLMRun,
)
from langchaincoexpert.chat_models.openai import ChatOpenAI, _convert_delta_to_message_chunk
from langchaincoexpert.pydantic_v1 import Field, root_validator
from langchaincoexpert.schema import ChatGeneration, ChatResult
from langchaincoexpert.schema.messages import AIMessageChunk, BaseMessage
...
class ChatKonko(ChatOpenAI):
    ...
    Example:
        .. code-block:: python
            ...
            from langchaincoexpert.chat_models import ChatKonko
