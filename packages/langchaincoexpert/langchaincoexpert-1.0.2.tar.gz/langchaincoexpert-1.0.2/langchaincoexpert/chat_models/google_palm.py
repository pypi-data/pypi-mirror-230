...
def _response_to_result(
    ...
    """Converts a PaLM API response into a langchaincoexpert ChatResult."""
...
def _messages_to_prompt_dict(
    ...
    """Converts a list of langchaincoexpert messages into a PaLM API MessagePrompt structure."""
    import google.generativeai as genai
...
class ChatGooglePalm(BaseChatModel, BaseModel):
    ...
    Example:
        .. code-block:: python
            ...
            from langchaincoexpert.chat_models import ChatGooglePalm
            chat = ChatGooglePalm()
