...
from langchaincoexpert.schema import BaseLLMOutputParser, BasePromptTemplate, StrOutputParser
from langchaincoexpert.utilities.loading import try_load_from_hub

URL_BASE = "https://raw.githubusercontent.com/hwchase17/langchaincoexpert-hub/master/prompts/"
...
def load_prompt(path: Union[str, Path]) -> BasePromptTemplate:
    """Unified method for loading a prompt from langchaincoexpertHub or local fs."""
