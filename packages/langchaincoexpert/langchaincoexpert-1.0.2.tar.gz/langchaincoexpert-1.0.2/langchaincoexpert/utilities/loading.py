"""Utilities for loading configurations from langchaincoexpert-hub."""
...
DEFAULT_REF = os.environ.get("langchaincoexpert_HUB_DEFAULT_REF", "master")
URL_BASE = os.environ.get(
    "langchaincoexpert_HUB_URL_BASE",
    "https://raw.githubusercontent.com/hwchase17/langchaincoexpert-hub/{ref}/",
)
