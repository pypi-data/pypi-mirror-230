...
from langchaincoexpert.output_parsers.format_instructions import (
...
from langchaincoexpert.schema import BaseOutputParser
...
class StructuredOutputParser(BaseOutputParser):
    ...
    def get_format_instructions(self, only_json: bool = False) -> str:
        ...
        example:
        ```python
        from langchaincoexpert.output_parsers.structured import (
