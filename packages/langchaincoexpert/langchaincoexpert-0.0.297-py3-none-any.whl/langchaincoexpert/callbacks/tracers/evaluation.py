...
from langchaincoexpert.callbacks import manager
from langchaincoexpert.callbacks.tracers import langchaincoexpert as langchaincoexpert_tracer
...
class EvaluatorCallbackHandler(BaseTracer):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.client = client or langchaincoexpert_tracer.get_client()
