...
from langchaincoexpert.agents.agent import AgentOutputParser, BaseSingleActionAgent
from langchaincoexpert.agents.xml.prompt import agent_instructions
from langchaincoexpert.callbacks.base import Callbacks
from langchaincoexpert.chains.llm import LLMChain
from langchaincoexpert.prompts.chat import AIMessagePromptTemplate, ChatPromptTemplate
from langchaincoexpert.schema import AgentAction, AgentFinish
...
class XMLAgent(BaseSingleActionAgent):
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            from langchaincoexpert.agents import XMLAgent
            from langchaincoexpert
