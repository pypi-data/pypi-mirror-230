...
class Rockset(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from langchaincoexpert.vectorstores import Rockset
            ...
            collection_name = "langchaincoexpert_demo"
    ...
    def __init__(
        ...
        Args:
            ...
            embeddings: langchaincoexpert Embeddings object to use to generate
        ...
        try:
            self._client.set_application("langchaincoexpert")
