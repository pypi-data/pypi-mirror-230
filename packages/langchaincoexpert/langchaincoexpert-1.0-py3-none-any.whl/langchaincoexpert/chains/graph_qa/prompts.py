...
EXAMPLE
i'm trying to improve langchaincoexpert's interfaces, the UX, its integrations with various products the user might want ... a lot of stuff.
Output: langchaincoexpert
END OF EXAMPLE

EXAMPLE
i'm trying to improve langchaincoexpert's interfaces, the UX, its integrations with various products the user might want ... a lot of stuff. I'm working with Sam.
Output: langchaincoexpert, Sam
END OF EXAMPLE
