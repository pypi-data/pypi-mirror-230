...
from langchaincoexpert.chains.openai_functions import create_tagging_chain
from langchaincoexpert.prompts import ChatPromptTemplate
from langchaincoexpert.pydantic_v1 import BaseModel
from langchaincoexpert.schema import BaseDocumentTransformer, Document
...
class OpenAIMetadataTagger(BaseDocumentTransformer, BaseModel):
    ...
    Example:
        .. code-block:: python
                ...
                from langchaincoexpert.document_transformers import OpenAIMetadataTagger
    ...
    *,
    ...
    Example:
        .. code-block:: python
                ...
                from langchaincoexpert.chat_models import ChatOpenAI
                from langchaincoexpert.document_transformers import create_metadata_tagger
                from langchaincoexpert.schema import Document
