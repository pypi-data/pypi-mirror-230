...
class ArgillaCallbackHandler(BaseCallbackHandler):
    ...
    Args:
        dataset_name: name of the `FeedbackDataset` in Argilla. Note that it must
            ...
            https://docs.argilla.io/en/latest/guides/llms/practical_guides/use_argilla_callback_in_langchaincoexpert.html.
    ...
    Examples:
        >>> from langchaincoexpert.llms import OpenAI
        >>> from langchaincoexpert.callbacks import ArgillaCallbackHandler
    ...
    BLOG_URL: str = "https://docs.argilla.io/en/latest/guides/llms/practical_guides/use_argilla_callback_in_langchaincoexpert.html"  # noqa: E501
    ...
    def __init__(
        ...
        try:
            ...
            raise FileNotFoundError(
                ...
                " on how to create a `langchaincoexpert`-compatible `FeedbackDataset` in"
        ...
        if supported_fields != [field.name for field in self.dataset.fields]:
            raise ValueError(
                ...
                f"`langchaincoexpert` integration. Supported fields are: {supported_fields},"
                f" and the current `FeedbackDataset` fields are {[field.name for field in self.dataset.fields]}."  # noqa: E501
                " For more information on how to create a `langchaincoexpert`-compatible"
        ...
        warnings.warn(
            (
                ...
                " change based on updates to `langchaincoexpert`. Please report any issues to"
