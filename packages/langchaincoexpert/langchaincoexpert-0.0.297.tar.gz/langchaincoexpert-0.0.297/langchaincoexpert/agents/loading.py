...
from langchaincoexpert.agents.agent import BaseMultiActionAgent, BaseSingleActionAgent
from langchaincoexpert.agents.tools import Tool
from langchaincoexpert.agents.types import AGENT_TO_CLASS
from langchaincoexpert.chains.loading import load_chain, load_chain_from_config
...
URL_BASE = "https://raw.githubusercontent.com/hwchase17/langchaincoexpert-hub/master/agents/"
...
def load_agent(
    ...
    """Unified method for loading an agent from langchaincoexpertHub or local fs.
