...
## Features
Django-Setup-Venv provides the following features:
...
- **Linux Operating System**: Django-Setup-Venv is designed to work on Linux-based systems.

- **Docker**: Django-Setup-Venv relies on Docker for certain functionality. Make sure you have Docker installed on your machine. You can find installation instructions for Docker on the [Docker website](https://docs.docker.com/get-docker/).

Once you have these dependencies in place, you can proceed with the installation and usage of Django-Setup-Venv.
<p align="right">(<a href="#django-setup">back to top</a>)</p>
...
Run the script to set up your Django project:
   ...
   ```bash
   django-setup <project_name>
   ```

### Command-Line Options
```bash
django-setup <project_name> [OPTIONS]
...
### Usage Example
   ```bash
   django-setup <project_name> -d mysql --htmx --smtp
   ```
...
Please review our [Code of Conduct](./CODE_OF_CONDUCT.md) before contributing to Django-Setup-Venv.
<p align="right">(<a href="#django-setup">back to top</a>)</p>
