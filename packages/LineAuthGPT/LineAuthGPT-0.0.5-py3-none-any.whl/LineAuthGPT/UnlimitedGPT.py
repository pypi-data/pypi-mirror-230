...
from LineAuthGPT.internal.selectors import ChatGPTVariables as CGPTV, ChatGPTVariables
from LineAuthGPT.internal.driver import ChatGPTDriver
from LineAuthGPT.internal.exceptions import InvalidConversationID
from LineAuthGPT.internal.objects import ChatGPTResponse, Conversations, DefaultAccount, SessionData, \
...
class ChatGPT:
    ...
    def use_gpt4_model(self):
        """
            use_gpt4_model
        """
        self.driver.safe_click(CGPTV.gpt4_model)
