...
class ProfilePartialUpdateQueryResourceObjectAttributes(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProfilePartialUpdateQueryResourceObjectAttributes:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProfilePartialUpdateQueryResourceObjectAttributes:
        """Create an instance of ProfilePartialUpdateQueryResourceObjectAttributes from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProfilePartialUpdateQueryResourceObjectAttributes.parse_obj(obj)

        _obj = ProfilePartialUpdateQueryResourceObjectAttributes.parse_obj({
            "email": obj.get("email"),
