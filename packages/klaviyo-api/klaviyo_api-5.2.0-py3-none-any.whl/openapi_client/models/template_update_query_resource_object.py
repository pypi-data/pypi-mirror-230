...
class TemplateUpdateQueryResourceObject(BaseModel):
    ...
    attributes: TemplateUpdateQueryResourceObjectAttributes = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TemplateUpdateQueryResourceObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TemplateUpdateQueryResourceObject:
        """Create an instance of TemplateUpdateQueryResourceObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TemplateUpdateQueryResourceObject.parse_obj(obj)

        _obj = TemplateUpdateQueryResourceObject.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": TemplateUpdateQueryResourceObjectAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
