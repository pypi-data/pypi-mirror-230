...
class TemplateCreateQueryResourceObject(BaseModel):
    ...
    attributes: TemplateCreateQueryResourceObjectAttributes = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TemplateCreateQueryResourceObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TemplateCreateQueryResourceObject:
        """Create an instance of TemplateCreateQueryResourceObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TemplateCreateQueryResourceObject.parse_obj(obj)

        _obj = TemplateCreateQueryResourceObject.parse_obj({
            "type": obj.get("type"),
            "attributes": TemplateCreateQueryResourceObjectAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
