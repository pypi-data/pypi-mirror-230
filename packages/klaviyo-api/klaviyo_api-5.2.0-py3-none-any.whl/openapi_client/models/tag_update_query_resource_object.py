...
class TagUpdateQueryResourceObject(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TagUpdateQueryResourceObject:
        """Create an instance of TagUpdateQueryResourceObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TagUpdateQueryResourceObject:
        """Create an instance of TagUpdateQueryResourceObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TagUpdateQueryResourceObject.parse_obj(obj)

        _obj = TagUpdateQueryResourceObject.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
