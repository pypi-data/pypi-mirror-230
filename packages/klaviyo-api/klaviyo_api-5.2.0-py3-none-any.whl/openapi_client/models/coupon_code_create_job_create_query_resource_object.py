...
class CouponCodeCreateJobCreateQueryResourceObject(BaseModel):
    ...
    """
    type: CouponCodeBulkCreateJobEnum = Field(...)
    attributes: CouponCodeCreateJobCreateQueryResourceObjectAttributes = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CouponCodeCreateJobCreateQueryResourceObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CouponCodeCreateJobCreateQueryResourceObject:
        """Create an instance of CouponCodeCreateJobCreateQueryResourceObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CouponCodeCreateJobCreateQueryResourceObject.parse_obj(obj)

        _obj = CouponCodeCreateJobCreateQueryResourceObject.parse_obj({
            "type": obj.get("type"),
            "attributes": CouponCodeCreateJobCreateQueryResourceObjectAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
