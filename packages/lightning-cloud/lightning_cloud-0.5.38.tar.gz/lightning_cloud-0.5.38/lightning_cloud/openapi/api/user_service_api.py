...
class UserServiceApi(object):
    ...
    def user_service_complete_onboarding(
            self, **kwargs) -> 'V1CompleteOnboardingResponse':  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.user_service_complete_onboarding_with_http_info(
                **kwargs)  # noqa: E501
        else:
            (data) = self.user_service_complete_onboarding_with_http_info(
                **kwargs)  # noqa: E501
            return data

    def user_service_complete_onboarding_with_http_info(
            self, **kwargs) -> 'V1CompleteOnboardingResponse':  # noqa: E501
        """user_service_complete_onboarding  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s'"
                                " to method user_service_complete_onboarding" %
                                key)
            params[key] = val
        del params['kwargs']
