...
class V1ClusterSpec(object):
    ...
    def __init__(
            ...
            google_cloud_v1: 'V1GoogleCloudDirectV1' = None,
            gridlet_version: 'str' = None,
            overprovisioning: 'list[V1InstanceOverprovisioningSpec]' = None,
            padding_factor: 'str' = None,
            pause_automation: 'bool' = None,
            performance_profile: 'V1ClusterPerformanceProfile' = None,
            slurm_v1: 'V1SLURMDirectV1' = None,
    ...
    def overprovisioning(
            self, overprovisioning: 'list[V1InstanceOverprovisioningSpec]'):
