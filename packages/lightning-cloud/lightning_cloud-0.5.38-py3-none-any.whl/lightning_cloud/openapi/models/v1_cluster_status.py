...
class V1ClusterStatus(object):
    ...
    def __init__(self,
                 aws_v1_region_status: 'list[V1AWSDirectV1Status]' = None,
                 ...
                 queue_endpoint: 'str' = None,
                 reason: 'str' = None,
                 slurm_v1_status: 'V1SLURMDirectV1Status' = None,
                 ssh_gateway_endpoint: 'str' = None,
                 storage_endpoint: 'str' = None):  # noqa: E501
    ...
    def aws_v1_region_status(
            self, aws_v1_region_status: 'list[V1AWSDirectV1Status]'):
