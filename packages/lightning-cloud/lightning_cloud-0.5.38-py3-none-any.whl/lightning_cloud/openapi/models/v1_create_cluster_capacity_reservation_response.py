...
class V1CreateClusterCapacityReservationResponse(object):
    ...
    attribute_map = {
        'cloud_provider_capacity_reservation_id':
        'cloudProviderCapacityReservationId',
        'id': 'id',
        'match_pattern': 'matchPattern'
    }

    def __init__(self,
                 cloud_provider_capacity_reservation_id: 'str' = None,
                 id: 'str' = None,
                 match_pattern: 'str' = None):  # noqa: E501
    ...
    def cloud_provider_capacity_reservation_id(
            self, cloud_provider_capacity_reservation_id: 'str'):
    ...
    def __eq__(self,
               other: 'V1CreateClusterCapacityReservationResponse') -> bool:
