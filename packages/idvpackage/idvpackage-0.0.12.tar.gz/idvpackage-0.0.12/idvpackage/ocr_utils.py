...
## pending entire
def visual_authenticity_check(data, face_detected, facial_similarity):
    visual_authenticity = {
      "breakdown": {
...
def form_final_data_document_report(data, front_id, front_id_text, back_id, back_id_text, coloured, facial_similarity, blurred, glare, missing_fields):
    document_report = {
        ...
        "breakdown": {
            ...
            "data_consistency": data_consistency_check(data),
            ...
            "police_record": {},
            "visual_authenticity": visual_authenticity_check(data, facial_similarity),
            ## pending - to be filled by dev
            "check_id": "", 
...
def form_final_facial_similarity_report(facial_similarity, ):
    facial_report = {
        ## pending - to be filled by dev
        "created_at": "",
        ## pending - to be filled by dev
