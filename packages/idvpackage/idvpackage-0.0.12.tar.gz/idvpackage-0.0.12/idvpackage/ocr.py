...
class IdentityVerification:
    ...
    def get_blurred_and_glared_for_doc(self, front_id, back_id):
        ...
        glare1 = self.find_bright_areas(front_id_arr)
        glare2 = self.find_bright_areas(back_id_arr)
    ...
    def check_for_liveness(self, video):
    ...
    def extract_ocr_info(self, selfie, video, front_id, back_id, country='UAE'):
        ...
        if country=='UAE':
            ...
            try:
                ...
                print(e)
            # facial_report = ocr_utils.form_final_facial_similarity_report(info_dict, front_id, front_id_text, back_id, text, colour_picture, similarity, blurred, glare, missing_fields)

        else:
            pass
        
        #json_object = json.dumps(df, indent = 4) 
        return info_dict, document_report
