classdef Stage < handle
  ...
  methods
    ...
    function varargout = subject_to(obj,varargin)
      ...
      % Arguments: constr, grid=None, include_first=True, include_last=True, scale=1, refine=1, group_refine=<rockit.grouping_techniques.GroupingTechnique object at 0x7f748aef8cd0>, group_dim=<rockit.grouping_techniques.GroupingTechnique object at 0x7f748aef8d10>, group_control=<rockit.grouping_techniques.GroupingTechnique object at 0x7f748aefe890>, meta=None
      % 
      %         Parameters
      %         ----------
