...
try:
    ...
    from profile_local.src.constants_profiles_local import *
...
def generic_profile_insert(profle_json: str, lang_code: str = user_context.get_curent_lang_code()) -> int:
    ...
    if "location" in keys:
        ...
        location_id = location_obj.insert(location_data=location_data, lang_code=lang_code, is_approved=True)
