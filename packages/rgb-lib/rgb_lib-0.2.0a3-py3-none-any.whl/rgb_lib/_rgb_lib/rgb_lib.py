...
class AssetCfa:
    ...
    def __init__(self, asset_id, asset_iface, name, description, precision, issued_supply, timestamp, balance, data_paths):
    ...
    def __str__(self):
        return "AssetCfa(asset_id={}, asset_iface={}, name={}, description={}, precision={}, issued_supply={}, timestamp={}, balance={}, data_paths={})".format(self.asset_id, self.asset_iface, self.name, self.description, self.precision, self.issued_supply, self.timestamp, self.balance, self.data_paths)
...
class AssetNia:
    ...
    def __init__(self, asset_id, asset_iface, ticker, name, precision, issued_supply, timestamp, balance):
        self.asset_id = asset_id
        self.asset_iface = asset_iface
        self.ticker = ticker
        self.name = name
    ...
    def __str__(self):
        return "AssetNia(asset_id={}, asset_iface={}, ticker={}, name={}, precision={}, issued_supply={}, timestamp={}, balance={})".format(self.asset_id, self.asset_iface, self.ticker, self.name, self.precision, self.issued_supply, self.timestamp, self.balance)
...
class RgbLibError:  # type: ignore
    ...
    class BlindedUtxoAlreadyUsed(UniFFITempRgbLibError):
        def __init__(self):
            pass
        def __repr__(self):
            return "RgbLibError.BlindedUtxoAlreadyUsed({})".format(str(self))
    UniFFITempRgbLibError.BlindedUtxoAlreadyUsed = BlindedUtxoAlreadyUsed  # type: ignore
    ...
    class CannotSendToSelf(UniFFITempRgbLibError):
        def __init__(self):
            pass
        def __repr__(self):
            return "RgbLibError.CannotSendToSelf({})".format(str(self))
    UniFFITempRgbLibError.CannotSendToSelf = CannotSendToSelf  # type: ignore
    ...
    class ScriptAlreadyUsed(UniFFITempRgbLibError):
        def __init__(self):
            pass
        def __repr__(self):
            return "RgbLibError.ScriptAlreadyUsed({})".format(str(self))
    UniFFITempRgbLibError.ScriptAlreadyUsed = ScriptAlreadyUsed  # type: ignore
...
class FfiConverterTypeRgbLibError(FfiConverterRustBuffer):
    ...
    def read(buf):
        ...
        if variant == 47:
            return RgbLibError.ScriptAlreadyUsed(
            )
        if variant == 48:
    ...
    def write(value, buf):
        ...
        if isinstance(value, RgbLibError.Proxy):
            buf.writeI32(46)
            FfiConverterString.write(value.details, buf)
        if isinstance(value, RgbLibError.ScriptAlreadyUsed):
            buf.writeI32(47)
