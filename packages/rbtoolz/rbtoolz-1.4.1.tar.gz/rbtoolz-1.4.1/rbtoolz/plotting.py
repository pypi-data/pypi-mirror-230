...
def auto_plot(df: pd.DataFrame, height: int = 800, width: int = None, mode: str = 'line', text_axis: str = None,
              ...
              xaxis_label: str = None, yaxis_label: str = None, colors_override: list[str] = None,
              legend_size: int = None, fill: str = None, opacity: float = 0.7, colorscale: str = 'jet_r',
              delta_colors: bool = False, relative_colors: bool = False,
