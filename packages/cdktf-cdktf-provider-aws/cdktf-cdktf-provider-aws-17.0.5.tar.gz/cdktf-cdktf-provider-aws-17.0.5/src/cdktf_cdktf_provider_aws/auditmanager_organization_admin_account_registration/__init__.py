...
class AuditmanagerOrganizationAdminAccountRegistration(
    ...
    def __init__(
        ...
        *,
        ...
        :param admin_account_id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.16.2/docs/resources/auditmanager_organization_admin_account_registration#admin_account_id AuditmanagerOrganizationAdminAccountRegistration#admin_account_id}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
