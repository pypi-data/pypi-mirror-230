...
class BaseUserIdModel(BaseModel):
    id: PydanticUUID


class BaseUserIdSoftModel(BaseModel):
    id: PydanticUUID | None



class KeycloakUserBaseModel(BaseUserIdModel):
    ...
    totp: bool
    emailVerified: bool
    disableCredentialTypes: list[str]
