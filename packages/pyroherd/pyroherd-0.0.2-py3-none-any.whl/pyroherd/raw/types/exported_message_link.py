...
class ExportedMessageLink(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.ExportedMessageLink`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`channels.ExportMessageLink <pyroherd.raw.functions.channels.ExportMessageLink>`
    """
