...
class BotResults(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.messages.BotResults`.
    ...
    Parameters:
        ...
        switch_pm (optional): :obj:`InlineBotSwitchPM <pyroherd.raw.base.InlineBotSwitchPM>`
        switch_webview (optional): :obj:`InlineBotWebView <pyroherd.raw.base.InlineBotWebView>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetInlineBotResults <pyroherd.raw.functions.messages.GetInlineBotResults>`
    """
