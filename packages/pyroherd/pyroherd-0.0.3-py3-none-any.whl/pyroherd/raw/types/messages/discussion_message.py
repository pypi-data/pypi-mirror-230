...
class DiscussionMessage(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.messages.DiscussionMessage`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetDiscussionMessage <pyroherd.raw.functions.messages.GetDiscussionMessage>`
    """
