...
class InactiveChats(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.messages.InactiveChats`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`channels.GetInactiveChannels <pyroherd.raw.functions.channels.GetInactiveChannels>`
    """
