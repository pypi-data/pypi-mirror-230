...
class ForumTopics(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.messages.ForumTopics`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`channels.GetForumTopics <pyroherd.raw.functions.channels.GetForumTopics>`
            - :obj:`channels.GetForumTopicsByID <pyroherd.raw.functions.channels.GetForumTopicsByID>`
    """
