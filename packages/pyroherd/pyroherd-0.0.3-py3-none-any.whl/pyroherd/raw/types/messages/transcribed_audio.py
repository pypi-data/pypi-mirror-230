...
class TranscribedAudio(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.messages.TranscribedAudio`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.TranscribeAudio <pyroherd.raw.functions.messages.TranscribeAudio>`
    """
