...
class SearchCounter(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.messages.SearchCounter`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetSearchCounters <pyroherd.raw.functions.messages.GetSearchCounters>`
    """
