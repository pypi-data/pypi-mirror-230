...
class Channel(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.Chat`.
    ...
    Parameters:
        ...
        admin_rights (optional): :obj:`ChatAdminRights <pyroherd.raw.base.ChatAdminRights>`
        banned_rights (optional): :obj:`ChatBannedRights <pyroherd.raw.base.ChatBannedRights>`
        default_banned_rights (optional): :obj:`ChatBannedRights <pyroherd.raw.base.ChatBannedRights>`
        participants_count (optional): ``int`` ``32-bit``
        usernames (optional): List of :obj:`Username <pyroherd.raw.base.Username>`
    """
