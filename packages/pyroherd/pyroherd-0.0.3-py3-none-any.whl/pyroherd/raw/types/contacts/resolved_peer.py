...
class ResolvedPeer(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.contacts.ResolvedPeer`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`contacts.ResolveUsername <pyroherd.raw.functions.contacts.ResolveUsername>`
            - :obj:`contacts.ResolvePhone <pyroherd.raw.functions.contacts.ResolvePhone>`
    """
