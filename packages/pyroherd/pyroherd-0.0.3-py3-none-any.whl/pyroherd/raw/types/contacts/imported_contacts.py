...
class ImportedContacts(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.contacts.ImportedContacts`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`contacts.ImportContacts <pyroherd.raw.functions.contacts.ImportContacts>`
    """
