...
class ExportedAuthorization(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.auth.ExportedAuthorization`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`auth.ExportAuthorization <pyroherd.raw.functions.auth.ExportAuthorization>`
    """
