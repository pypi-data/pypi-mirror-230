...
class PasswordRecovery(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.auth.PasswordRecovery`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`auth.RequestPasswordRecovery <pyroherd.raw.functions.auth.RequestPasswordRecovery>`
    """
