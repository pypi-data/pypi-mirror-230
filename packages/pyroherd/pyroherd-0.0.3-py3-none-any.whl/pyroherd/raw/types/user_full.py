...
class UserFull(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.UserFull`.
    ...
    Parameters:
        ...
        about (optional): ``str``
        personal_photo (optional): :obj:`Photo <pyroherd.raw.base.Photo>`
        profile_photo (optional): :obj:`Photo <pyroherd.raw.base.Photo>`
        fallback_photo (optional): :obj:`Photo <pyroherd.raw.base.Photo>`
        bot_info (optional): :obj:`BotInfo <pyroherd.raw.base.BotInfo>`
        ...
        bot_group_admin_rights (optional): :obj:`ChatAdminRights <pyroherd.raw.base.ChatAdminRights>`
        bot_broadcast_admin_rights (optional): :obj:`ChatAdminRights <pyroherd.raw.base.ChatAdminRights>`
        premium_gifts (optional): List of :obj:`PremiumGiftOption <pyroherd.raw.base.PremiumGiftOption>`
        wallpaper (optional): :obj:`WallPaper <pyroherd.raw.base.WallPaper>`
    """
