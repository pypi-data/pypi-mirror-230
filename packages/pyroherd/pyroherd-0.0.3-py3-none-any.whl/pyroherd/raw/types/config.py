...
class Config(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.Config`.
    ...
    Parameters:
        ...
        reactions_default (optional): :obj:`Reaction <pyroherd.raw.base.Reaction>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`help.GetConfig <pyroherd.raw.functions.help.GetConfig>`
    """
