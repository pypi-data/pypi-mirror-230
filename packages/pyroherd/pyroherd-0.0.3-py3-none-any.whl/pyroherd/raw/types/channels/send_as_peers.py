...
class SendAsPeers(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.channels.SendAsPeers`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`channels.GetSendAs <pyroherd.raw.functions.channels.GetSendAs>`
    """
