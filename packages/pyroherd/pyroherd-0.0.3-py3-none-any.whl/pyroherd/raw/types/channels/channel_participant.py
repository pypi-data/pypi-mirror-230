...
class ChannelParticipant(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.channels.ChannelParticipant`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`channels.GetParticipant <pyroherd.raw.functions.channels.GetParticipant>`
    """
