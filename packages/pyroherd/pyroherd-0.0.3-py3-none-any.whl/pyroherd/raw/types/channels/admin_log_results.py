...
class AdminLogResults(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.channels.AdminLogResults`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`channels.GetAdminLog <pyroherd.raw.functions.channels.GetAdminLog>`
    """
