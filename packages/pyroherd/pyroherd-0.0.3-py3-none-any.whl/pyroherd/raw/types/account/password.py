...
class Password(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.account.Password`.
    ...
    Parameters:
        ...
        current_algo (optional): :obj:`PasswordKdfAlgo <pyroherd.raw.base.PasswordKdfAlgo>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetPassword <pyroherd.raw.functions.account.GetPassword>`
    """
