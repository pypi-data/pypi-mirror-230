...
class PasswordSettings(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.account.PasswordSettings`.
    ...
    Parameters:
        email (optional): ``str``
        secure_settings (optional): :obj:`SecureSecretSettings <pyroherd.raw.base.SecureSecretSettings>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetPasswordSettings <pyroherd.raw.functions.account.GetPasswordSettings>`
    """
