...
class Authorizations(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.account.Authorizations`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetAuthorizations <pyroherd.raw.functions.account.GetAuthorizations>`
    """
