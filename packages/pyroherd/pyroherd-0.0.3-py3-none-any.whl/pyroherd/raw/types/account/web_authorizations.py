...
class WebAuthorizations(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.account.WebAuthorizations`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetWebAuthorizations <pyroherd.raw.functions.account.GetWebAuthorizations>`
    """
