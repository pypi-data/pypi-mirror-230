...
class TmpPassword(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.account.TmpPassword`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetTmpPassword <pyroherd.raw.functions.account.GetTmpPassword>`
    """
