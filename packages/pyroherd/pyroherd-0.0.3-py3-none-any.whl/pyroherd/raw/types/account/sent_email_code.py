...
class SentEmailCode(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.account.SentEmailCode`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.SendVerifyEmailCode <pyroherd.raw.functions.account.SendVerifyEmailCode>`
    """
