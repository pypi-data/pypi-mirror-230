...
class PhoneCall(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.phone.PhoneCall`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`phone.RequestCall <pyroherd.raw.functions.phone.RequestCall>`
            - :obj:`phone.AcceptCall <pyroherd.raw.functions.phone.AcceptCall>`
            - :obj:`phone.ConfirmCall <pyroherd.raw.functions.phone.ConfirmCall>`
    """
