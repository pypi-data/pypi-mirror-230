...
class GroupCallStreamRtmpUrl(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.phone.GroupCallStreamRtmpUrl`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`phone.GetGroupCallStreamRtmpUrl <pyroherd.raw.functions.phone.GetGroupCallStreamRtmpUrl>`
    """
