...
class AttachMenuBotsBot(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.AttachMenuBotsBot`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetAttachMenuBot <pyroherd.raw.functions.messages.GetAttachMenuBot>`
    """
