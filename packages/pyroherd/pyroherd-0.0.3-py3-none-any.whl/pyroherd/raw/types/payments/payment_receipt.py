...
class PaymentReceipt(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.payments.PaymentReceipt`.
    ...
    Parameters:
        ...
        info (optional): :obj:`PaymentRequestedInfo <pyroherd.raw.base.PaymentRequestedInfo>`
        shipping (optional): :obj:`ShippingOption <pyroherd.raw.base.ShippingOption>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`payments.GetPaymentReceipt <pyroherd.raw.functions.payments.GetPaymentReceipt>`
    """
