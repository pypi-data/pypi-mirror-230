...
class SavedInfo(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.payments.SavedInfo`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`payments.GetSavedInfo <pyroherd.raw.functions.payments.GetSavedInfo>`
    """
