...
class Message(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.Message`.
    ...
    Parameters:
        ...
        from_id (optional): :obj:`Peer <pyroherd.raw.base.Peer>`
        fwd_from (optional): :obj:`MessageFwdHeader <pyroherd.raw.base.MessageFwdHeader>`
        via_bot_id (optional): ``int`` ``64-bit``
        reply_to (optional): :obj:`MessageReplyHeader <pyroherd.raw.base.MessageReplyHeader>`
        media (optional): :obj:`MessageMedia <pyroherd.raw.base.MessageMedia>`
        reply_markup (optional): :obj:`ReplyMarkup <pyroherd.raw.base.ReplyMarkup>`
        ...
        replies (optional): :obj:`MessageReplies <pyroherd.raw.base.MessageReplies>`
        edit_date (optional): ``int`` ``32-bit``
        post_author (optional): ``str``
        grouped_id (optional): ``int`` ``64-bit``
        reactions (optional): :obj:`MessageReactions <pyroherd.raw.base.MessageReactions>`
        restriction_reason (optional): List of :obj:`RestrictionReason <pyroherd.raw.base.RestrictionReason>`
