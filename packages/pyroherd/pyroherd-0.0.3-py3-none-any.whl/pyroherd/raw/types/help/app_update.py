...
class AppUpdate(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.help.AppUpdate`.
    ...
    Parameters:
        ...
        url (optional): ``str``
        sticker (optional): :obj:`Document <pyroherd.raw.base.Document>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`help.GetAppUpdate <pyroherd.raw.functions.help.GetAppUpdate>`
    """
