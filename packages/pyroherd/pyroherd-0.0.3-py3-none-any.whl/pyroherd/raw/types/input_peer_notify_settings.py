...
class InputPeerNotifySettings(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.InputPeerNotifySettings`.
    ...
    Parameters:
        ...
        sound (optional): :obj:`NotificationSound <pyroherd.raw.base.NotificationSound>`
    """
