...
class WebPage(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.WebPage`.
    ...
    Parameters:
        ...
        author (optional): ``str``
        document (optional): :obj:`Document <pyroherd.raw.base.Document>`
        cached_page (optional): :obj:`Page <pyroherd.raw.base.Page>`
        attributes (optional): List of :obj:`WebPageAttribute <pyroherd.raw.base.WebPageAttribute>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetWebPage <pyroherd.raw.functions.messages.GetWebPage>`
    """
