...
class Authorization(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.Authorization`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`auth.AcceptLoginToken <pyroherd.raw.functions.auth.AcceptLoginToken>`
    """
