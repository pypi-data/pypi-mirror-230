...
class SuggestedShortName(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.stickers.SuggestedShortName`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`stickers.SuggestShortName <pyroherd.raw.functions.stickers.SuggestShortName>`
    """
