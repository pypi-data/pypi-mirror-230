...
class ChatlistUpdates(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.chatlists.ChatlistUpdates`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`chatlists.GetChatlistUpdates <pyroherd.raw.functions.chatlists.GetChatlistUpdates>`
    """
