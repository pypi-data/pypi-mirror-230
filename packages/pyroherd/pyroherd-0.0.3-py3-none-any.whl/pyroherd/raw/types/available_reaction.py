...
class AvailableReaction(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.AvailableReaction`.
    ...
    Parameters:
        ...
        around_animation (optional): :obj:`Document <pyroherd.raw.base.Document>`
        center_icon (optional): :obj:`Document <pyroherd.raw.base.Document>`
    """
