...
class InputWebFileAudioAlbumThumbLocation(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.InputWebFileLocation`.
    ...
    Parameters:
        small (optional): ``bool``
        document (optional): :obj:`InputDocument <pyroherd.raw.base.InputDocument>`
        title (optional): ``str``
