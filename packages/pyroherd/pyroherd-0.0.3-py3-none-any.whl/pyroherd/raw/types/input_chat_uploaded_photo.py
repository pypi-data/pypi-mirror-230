...
class InputChatUploadedPhoto(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.InputChatPhoto`.
    ...
    Parameters:
        file (optional): :obj:`InputFile <pyroherd.raw.base.InputFile>`
        video (optional): :obj:`InputFile <pyroherd.raw.base.InputFile>`
        video_start_ts (optional): ``float`` ``64-bit``
        video_emoji_markup (optional): :obj:`VideoSize <pyroherd.raw.base.VideoSize>`
    """
