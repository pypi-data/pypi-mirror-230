...
class BotInfo(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.BotInfo`.
    ...
    Parameters:
        ...
        description_photo (optional): :obj:`Photo <pyroherd.raw.base.Photo>`
        description_document (optional): :obj:`Document <pyroherd.raw.base.Document>`
        commands (optional): List of :obj:`BotCommand <pyroherd.raw.base.BotCommand>`
        menu_button (optional): :obj:`BotMenuButton <pyroherd.raw.base.BotMenuButton>`
    """
