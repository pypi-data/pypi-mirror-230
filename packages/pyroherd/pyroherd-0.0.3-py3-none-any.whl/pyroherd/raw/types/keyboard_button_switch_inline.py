...
class KeyboardButtonSwitchInline(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.KeyboardButton`.
    ...
    Parameters:
        ...
        peer_types (optional): List of :obj:`InlineQueryPeerType <pyroherd.raw.base.InlineQueryPeerType>`
    """
