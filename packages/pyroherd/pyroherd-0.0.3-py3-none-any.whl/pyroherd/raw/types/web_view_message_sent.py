...
class WebViewMessageSent(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyroherd.raw.base.WebViewMessageSent`.
    ...
    Parameters:
        msg_id (optional): :obj:`InputBotInlineMessageID <pyroherd.raw.base.InputBotInlineMessageID>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.SendWebViewResultMessage <pyroherd.raw.functions.messages.SendWebViewResultMessage>`
    """
