...
class InitConnection(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        lang_pack: ``str``
        lang_code: ``str``
        query: Any method from :obj:`~pyroherd.raw.functions`
        proxy (optional): :obj:`InputClientProxy <pyroherd.raw.base.InputClientProxy>`
        params (optional): :obj:`JSONValue <pyroherd.raw.base.JSONValue>`
