...
class GetAdminLog(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        min_id: ``int`` ``64-bit``
        limit: ``int`` ``32-bit``
        events_filter (optional): :obj:`ChannelAdminLogEventsFilter <pyroherd.raw.base.ChannelAdminLogEventsFilter>`
        admins (optional): List of :obj:`InputUser <pyroherd.raw.base.InputUser>`
