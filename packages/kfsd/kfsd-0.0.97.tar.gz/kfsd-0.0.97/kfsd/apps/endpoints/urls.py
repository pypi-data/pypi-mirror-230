...
from kfsd.apps.endpoints.views.common.media import MediaModelViewSet
from kfsd.apps.endpoints.views.common.platform import PlatformModelViewSet
...
router.register("platform", PlatformModelViewSet, basename="platform")
