...
class EncryptedUnsigned64(Encrypted):
    ...
    def __add__(self, other) -> "Encrypted":
        raise NotImplementedError("Addition is not implemented for unsigned64 class")

    def __radd__(self, other) -> "Encrypted":
        raise NotImplementedError("Addition is not implemented for unsigned64 class")

    def __sub__(self, other) -> "Encrypted":
        raise NotImplementedError("Subtraction is not implemented for unsigned64 class")
    ...
    def __mul__(self, other) -> "Encrypted":
        raise NotImplementedError(
            "Multiplication is not implemented for unsigned64 class"
        )
    ...
    def __div__(self, other) -> "Encrypted":
        raise NotImplementedError("Division is not implemented for unsigned64 class")
