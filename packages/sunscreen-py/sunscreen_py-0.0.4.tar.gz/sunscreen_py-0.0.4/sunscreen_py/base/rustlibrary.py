...
class RustLibrary:
    ...
    def __initialize_library(self):
        ...
        # Get noise for cipher
        self.rust_lib.get_noise_budget_for_cipher.argtypes = (
            ctypes.c_void_p,
            ctypes.c_void_p,
            ctypes.c_void_p,
        )
        self.rust_lib.get_noise_budget_for_cipher.restype = ctypes.c_uint32
        ...
        # Sum with cipher
        self.rust_lib.sum_with_cipher.argtypes = (
            ctypes.c_void_p,
            ctypes.c_void_p,
            ctypes.c_void_p,
            ctypes.c_void_p,
        )
        self.rust_lib.sum_with_cipher.restype = ctypes.c_void_p

        # Sum with plain
        self.rust_lib.sum_with_plain.argtypes = (
            ctypes.c_void_p,
            ctypes.c_void_p,
            ctypes.c_void_p,
            ctypes.c_double,
        )
        self.rust_lib.sum_with_plain.restype = ctypes.c_void_p

        # Product with cipher
        self.rust_lib.product_with_cipher.argtypes = (
            ctypes.c_void_p,
            ctypes.c_void_p,
            ctypes.c_void_p,
            ctypes.c_void_p,
        )
        self.rust_lib.product_with_cipher.restype = ctypes.c_void_p

        # Product with plain
        self.rust_lib.product_with_plain.argtypes = (
            ctypes.c_void_p,
            ctypes.c_void_p,
            ctypes.c_void_p,
            ctypes.c_double,
        )
        self.rust_lib.product_with_plain.restype = ctypes.c_void_p

        # Difference with cipher
        self.rust_lib.difference_with_cipher.argtypes = (
            ctypes.c_void_p,
            ctypes.c_void_p,
            ctypes.c_void_p,
            ctypes.c_void_p,
        )
        self.rust_lib.difference_with_cipher.restype = ctypes.c_void_p

        # Difference with plain
        self.rust_lib.difference_with_plain.argtypes = (
            ctypes.c_void_p,
            ctypes.c_void_p,
            ctypes.c_void_p,
            ctypes.c_double,
        )
        self.rust_lib.difference_with_plain.restype = ctypes.c_void_p

        # Difference with plain reverse
        self.rust_lib.difference_with_plain_reverse.argtypes = (
            ctypes.c_void_p,
            ctypes.c_void_p,
            ctypes.c_void_p,
            ctypes.c_double,
        )
        self.rust_lib.difference_with_plain_reverse.restype = ctypes.c_void_p

        self.rust_lib.release_public_key.argtypes = (ctypes.c_void_p,)
        self.rust_lib.release_private_key.argtypes = (ctypes.c_void_p,)

        # Encrypt Array
        #self.rust_lib.encrypt_float_array.argtypes = (
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #    ctypes.POINTER(InteropBuffer),
        #)
        #self.rust_lib.encrypt_float_array.restype = ctypes.c_void_p

        # Decrypt Array
        #self.rust_lib.decrypt_float_array.argtypes = (
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #    ctypes.POINTER(InteropBuffer),
        #)
        #self.rust_lib.decrypt_float_array.restype = ctypes.c_int32

        # Dot product with Plain
        #self.rust_lib.dot_product_with_plain.argtypes = (
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #    ctypes.POINTER(InteropBuffer),
        #)
        #self.rust_lib.dot_product_with_plain.restype = ctypes.c_void_p

        # Dot product with cipher
        #self.rust_lib.dot_product_with_cipher.argtypes = (
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #)
        #self.rust_lib.dot_product_with_cipher.restype = ctypes.c_void_p

        # Vector sum with Plain
        #self.rust_lib.vector_sum_with_plain.argtypes = (
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #    ctypes.POINTER(InteropBuffer),
        #)
        #self.rust_lib.vector_sum_with_plain.restype = ctypes.c_void_p

        # Vector sum with cipher
        #self.rust_lib.vector_sum_with_cipher.argtypes = (
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #)
        #self.rust_lib.vector_sum_with_cipher.restype = ctypes.c_void_p

        # Vector difference with Plain
        #self.rust_lib.vector_difference_with_plain.argtypes = (
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #    ctypes.POINTER(InteropBuffer),
        #)
        #self.rust_lib.vector_difference_with_plain.restype = ctypes.c_void_p

        # Vector difference with cipher
        #self.rust_lib.vector_difference_with_cipher.argtypes = (
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #)
        #self.rust_lib.vector_difference_with_cipher.restype = ctypes.c_void_p

        # Vector product with Plain
        #self.rust_lib.vector_product_with_plain.argtypes = (
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #    ctypes.POINTER(InteropBuffer),
        #)
        #self.rust_lib.vector_product_with_plain.restype = ctypes.c_void_p

        # Vector product with cipher
        #self.rust_lib.vector_product_with_cipher.argtypes = (
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #)
        #self.rust_lib.vector_product_with_cipher.restype = ctypes.c_void_p

        # Vector scale with Plain
        #self.rust_lib.vector_scale_with_plain.argtypes = (
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #    ctypes.c_double,
        #)
        #self.rust_lib.vector_scale_with_plain.restype = ctypes.c_void_p

        # Vector scale with cipher
        #self.rust_lib.vector_scale_with_cipher.argtypes = (
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #    ctypes.c_void_p,
        #)
        #self.rust_lib.vector_scale_with_cipher.restype = ctypes.c_void_p
