def plot_comp(st,axoff=1,ayoff=1,titleoff=1,picks=None,eid=None,mag=None,ifmap=0,staloc=None,evloc=None,staname=None,ptime=None,stime=None,figname=None,showf=True,**kwargs):
	"""
	...
	from pylib.plot import plot_traces; 
	plot_traces(obspy.read("newwaveforms/texnet2022ugad.mseed")[0:10]);
	
	demos/test_plot_traces_picks.py
	demos/test_34_delaware_verifypicks2.py
	"""
	ntr=len(st)
	if ifmap == 0:
