...
def run(runtime:PMRuntime)->dict:
    ...
    chunk_size = runtime.params.script.chunk_size
    chunk_overlap = runtime.params.script.chunk_overlap
    separators = runtime.params.separators.split(",")
    text_splitter = TextSegmentation(
        chunk_size=chunk_size,
        chunk_overlap=chunk_overlap,
        separators=separators,
    )
    text = runtime.inputs.text
    texts = text_splitter.split_text(text)
    result = "\n\n".join(texts)
    result_ojb = {"output":result}
