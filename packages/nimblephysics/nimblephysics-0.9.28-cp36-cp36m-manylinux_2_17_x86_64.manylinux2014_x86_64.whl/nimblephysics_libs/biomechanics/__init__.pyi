...
class DynamicsFitter():
    ...
    def writeSubjectOnDisk(self, outputPath: str, openSimFilePath: str, init: DynamicsInitialization, biologicalSex: str, massKg: float, heightM: float, ageYears: int, useAdjustedGRFs: bool = False, trialNames: list[str] = [], subjectTags: list[str] = [], trialTags: list[list[str]] = [], href: str = '', notes: str = '', emgObservationTrials: list[list[dict[str, numpy.ndarray[numpy.float64, _Shape[m, 1]]]]] = []) -> None: ...
...
class SubjectOnDisk():
    ...
    def getTrialTimestep(self, trial: int) -> float: 
        ...
        """
    def readFrames(self, trial: int, startFrame: int, numFramesToRead: int = 1, stride: int = 1, contactThreshold: float = 1.0) -> list[Frame]: 
        """
    ...
    def readSkel(self, geometryFolder: str = '') -> nimblephysics_libs._nimblephysics.dynamics.Skeleton: 
        ...
        """
    @staticmethod
    def writeSubject(outputPath: str, openSimFilePath: str, trialTimesteps: list[float], trialPoses: list[numpy.ndarray[numpy.float64, _Shape[m, n]]], trialVels: list[numpy.ndarray[numpy.float64, _Shape[m, n]]], trialAccs: list[numpy.ndarray[numpy.float64, _Shape[m, n]]], probablyMissingGRF: list[list[bool]], missingGRFReason: list[list[MissingGRFReason]], dofPositionsObserved: list[list[bool]], dofVelocitiesFiniteDifferenced: list[list[bool]], dofAccelerationsFiniteDifferenced: list[list[bool]], trialTaus: list[numpy.ndarray[numpy.float64, _Shape[m, n]]], trialComPoses: list[numpy.ndarray[numpy.float64, _Shape[m, n]]], trialComVels: list[numpy.ndarray[numpy.float64, _Shape[m, n]]], trialComAccs: list[numpy.ndarray[numpy.float64, _Shape[m, n]]], trialResidualNorms: list[list[float]], groundForceBodies: list[str], trialGroundBodyWrenches: list[numpy.ndarray[numpy.float64, _Shape[m, n]]], trialGroundBodyCopTorqueForce: list[numpy.ndarray[numpy.float64, _Shape[m, n]]], customValueNames: list[str], customValues: list[list[numpy.ndarray[numpy.float64, _Shape[m, n]]]], markerObservations: list[list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]], accObservations: list[list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]], gyroObservations: list[list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]], emgObservations: list[list[dict[str, numpy.ndarray[numpy.float64, _Shape[m, 1]]]]], forcePlates: list[list[ForcePlate]], biologicalSex: str, heightM: float, massKg: float, ageYears: int, trialNames: list[str] = [], subjectTags: list[str] = [], trialTags: list[list[str]] = [], sourceHref: str = '', notes: str = '') -> None: 
        """
