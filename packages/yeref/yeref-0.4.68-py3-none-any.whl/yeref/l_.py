...
l_canswer_user_text = {
    'ru': "💭 <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> режим нейро-ответа на сообщения пользователя с помощью нейросети (на основе контента всех блоков)",
    'en': "💭 <b>Press</b> ✅/☑️ to <b>turn on/off</b> auto-reply to text messages using neural network",
    'es': "💭 <b>Presione</b> ✅/☑️ para <b>activar/desactivar</b> la respuesta automática a los mensajes de texto usando la red neuronal",
    'fr': "💭 <b>Appuyez sur</b> ✅/☑️ pour <b>activer/désactiver</b> la réponse automatique aux messages texte à l'aide du réseau neuronal",
    'zh': "💭<b>按</b>✅/☑️ 使用神经网络<b>打开/关闭</b>自动回复短信",
...
# region cservice_
l_cservice_text = {
    'ru': "👥 <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> <i>сервисные <b>статусы</b>/<b>пересылку</b> входящих себе (в том числе не отредактированных/<u>удаленных</u> сообщений)/оповещение когда пользователь <b>в сети</b>/авто-замена голосовых/телескопов на <b>audio/video</b></i>\n\n👩🏽‍💻 [✅☑Вкл сервисные статусы] означает показ у пользователей <b>статусов</b>: <i>печатает..ищет стикер..</i>\n[✅☑Вкл audio/video замена] рекомендуется, если premium-пользователи установили запрет на <i>voice/telescope</i>",
