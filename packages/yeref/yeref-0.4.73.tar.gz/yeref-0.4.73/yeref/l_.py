...
# region cservice_
l_cservice_text = {
    'ru': "👥 <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> <i><b>пересылку</b> входящих себе (в том числе не отредактированных/<u>удаленных</u> сообщений)/оповещение когда пользователь <b>в сети</b>/авто-замена голосовых/телескопов на <b>audio/video</b></i>\n\n[✅☑Вкл audio/video замена] рекомендуется, если premium-пользователи установили запрет на <i>voice/telescope</i>",
...
l_cservice_user_online = {
    'ru': f"<b>👩🏽‍💻 Пользователь</b>: {0} в сети",
    'en': "☑️☐Off audio/video replacement",
    'es': "☑️☐Reemplazo de audio/video apagado",
    'fr': "☑️☐Off remplacement audio/vidéo",
    'zh': "☑️☐关闭音频/视频替换",
