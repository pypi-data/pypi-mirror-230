...
# region cservice_
l_cservice_text = {
    'ru': "💬 <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> <i>сервисные <b>статусы</b>/<b>пересылку</b> входящих себе (в том числе не отредактированных/<u>удаленных</u> сообщений)/оповещение когда пользователь <b>в сети</b></i>\n\n👩🏽‍💻 [✅☑Вкл сервисные статусы] означает показ у пользователей <b>статусов</b>: <i>печатает..ищет стикер..</i>",
