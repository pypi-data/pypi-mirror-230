...
MetaCHIP2 circos -o circos.pdf -i cir_plot_matrix.csv
MetaCHIP2 circos -o circos.pdf -l detected_HGTs.txt -g grouping.txt
...
MetaCHIP2 circos -i cir_plot_matrix.csv -o cir_plot_matrix.pdf -s 11
...
Rscript circos_HGT.R -m cir_plot_matrix.csv -p cir_plot_matrix.pdf -s 11
'''
