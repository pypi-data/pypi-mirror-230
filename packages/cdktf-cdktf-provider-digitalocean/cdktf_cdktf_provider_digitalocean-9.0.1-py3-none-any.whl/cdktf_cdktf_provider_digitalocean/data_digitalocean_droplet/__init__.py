...
class DataDigitaloceanDroplet(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: name of the Droplet. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.30.0/docs/data-sources/droplet#name DataDigitaloceanDroplet#name}
        :param tag: unique tag of the Droplet. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.30.0/docs/data-sources/droplet#tag DataDigitaloceanDroplet#tag}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
