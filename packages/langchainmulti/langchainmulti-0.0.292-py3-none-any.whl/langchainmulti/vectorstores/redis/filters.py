...
from langchainmulti.utilities.redis import TokenEscaper
...
class RedisTag(RedisFilterField):
    ...
    def __eq__(self, other: Union[List[str], str]) -> "RedisFilterExpression":
        ...
        Example:
            >>> from langchainmulti.vectorstores.redis import RedisTag
...
class RedisNum(RedisFilterField):
    ...
    def __eq__(self, other: Union[int, float]) -> "RedisFilterExpression":
        ...
        Example:
            >>> from langchainmulti.vectorstores.redis import RedisNum
...
class RedisText(RedisFilterField):
    ...
    def __eq__(self, other: str) -> "RedisFilterExpression":
        ...
        Example:
            >>> from langchainmulti.vectorstores.redis import RedisText
...
class RedisFilterExpression:
    ...
    Examples:
        ...
        >>> from langchainmulti.vectorstores.redis import RedisTag, RedisNum
