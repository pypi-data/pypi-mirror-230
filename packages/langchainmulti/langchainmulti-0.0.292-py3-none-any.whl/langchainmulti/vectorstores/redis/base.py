...
from langchainmulti._api import deprecated
from langchainmulti.callbacks.manager import (
    AsyncCallbackManagerForRetrieverRun,
    CallbackManagerForRetrieverRun,
)
from langchainmulti.docstore.document import Document
from langchainmulti.embeddings.base import Embeddings
from langchainmulti.utilities.redis import (
    _array_to_buffer,
    _buffer_to_array,
    check_redis_module_exist,
    get_client,
)
from langchainmulti.utils import get_from_dict_or_env
from langchainmulti.vectorstores.base import VectorStore, VectorStoreRetriever
from langchainmulti.vectorstores.redis.constants import (
    REDIS_REQUIRED_MODULES,
    REDIS_TAG_SEPARATOR,
)
from langchainmulti.vectorstores.utils import maximal_marginal_relevance
...
if TYPE_CHECKING:
    ...
    from langchainmulti.vectorstores.redis.filters import RedisFilterExpression
    from langchainmulti.vectorstores.redis.schema import RedisModel
...
class Redis(VectorStore):
    ...
    .. code-block:: python
        ...
        from langchainmulti.vectorstores import Redis
        from langchainmulti.embeddings import OpenAIEmbeddings
    ...
    schema according to the following rules:
        ...
        - All lists of strings are indexed as tag fields (joined by
            langchainmulti.vectorstores.redis.constants.REDIS_TAG_SEPARATOR)
    ...
    def from_texts_return_keys(
        ...
        **kwargs: Any,
        ...
        always present in the langchainmulti schema.
        ...
        try:
            ...
            from langchainmulti.vectorstores.redis.schema import read_schema
    ...
    def _get_schema_with_defaults(
        ...
        from langchainmulti.vectorstores.redis.schema import RedisModel, read_schema
