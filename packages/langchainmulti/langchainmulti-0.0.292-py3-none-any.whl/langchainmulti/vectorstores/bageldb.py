...
class Bagel(VectorStore):
    ...
    Example:
        .. code-block:: python
                ...
                from langchainmulti.vectorstores import Bagel
                vectorstore = Bagel(cluster_name="langchainmulti_store")
    """

    _langchainmulti_DEFAULT_CLUSTER_NAME = "langchainmulti"

    def __init__(
        self,
        cluster_name: str = _langchainmulti_DEFAULT_CLUSTER_NAME,
