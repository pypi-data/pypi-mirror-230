...
from langchainmulti.docstore.base import AddableMixin, Docstore
...
from langchainmulti.vectorstores.utils import DistanceStrategy, maximal_marginal_relevance
...
class FAISS(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from langchainmulti.vectorstores import FAISS

            embeddings = OpenAIEmbeddings()
            texts = ["FAISS is an important library", "langchainmulti supports FAISS"]
        ...
        **kwargs: Any,
        ...
        Example:
            .. code-block:: python
                ...
                from langchainmulti import FAISS
