...
class Rockset(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from langchainmulti.vectorstores import Rockset
            ...
            collection_name = "langchainmulti_demo"
    ...
    def __init__(
        ...
        Args:
            ...
            embeddings: langchainmulti Embeddings object to use to generate
        ...
        try:
            self._client.set_application("langchainmulti")
