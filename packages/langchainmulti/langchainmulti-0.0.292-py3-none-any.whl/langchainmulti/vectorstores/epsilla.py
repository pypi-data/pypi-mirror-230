...
class Epsilla(VectorStore):
    ...
    Args:
        ...
        db_path (Optional[str]): The path where the database will be persisted.
                                 Defaults to "/tmp/langchainmulti-epsilla".
        db_name (Optional[str]): Give a name to the loaded database.
                                 Defaults to "langchainmulti_store".
    Example:
        .. code-block:: python

            from langchainmulti.vectorstores import Epsilla
            from pyepsilla import vectordb

            client = vectordb.Client()
            embeddings = OpenAIEmbeddings()
            db_path = "/tmp/vectorstore"
            db_name = "langchainmulti_store"
            epsilla = Epsilla(client, embeddings, db_path, db_name)
    """

    _langchainmulti_DEFAULT_DB_NAME = "langchainmulti_store"
    _langchainmulti_DEFAULT_DB_PATH = "/tmp/langchainmulti-epsilla"
    _langchainmulti_DEFAULT_TABLE_NAME = "langchainmulti_collection"

    def __init__(
        self,
        client: Any,
        embeddings: Embeddings,
        db_path: Optional[str] = _langchainmulti_DEFAULT_DB_PATH,
        db_name: Optional[str] = _langchainmulti_DEFAULT_DB_NAME,
    ):
        ...
        self._collection_name = Epsilla._langchainmulti_DEFAULT_TABLE_NAME
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            collection_name (Optional[str]): Which collection to use.
                        Defaults to "langchainmulti_collection".
    ...
    def similarity_search(
        ...
        Args:
            ...
            collection_name (Optional[str]): Collection to use.
                Defaults to "langchainmulti_store" or the one provided before.
        Returns:
    ...
    def from_texts(
        ...
        db_path: Optional[str] = _langchainmulti_DEFAULT_DB_PATH,
        db_name: Optional[str] = _langchainmulti_DEFAULT_DB_NAME,
        collection_name: Optional[str] = _langchainmulti_DEFAULT_TABLE_NAME,
        drop_old: Optional[bool] = False,
        **kwargs: Any,
    ) -> Epsilla:
