...
class Meilisearch(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from langchainmulti.vectorstores import Meilisearch
            ...
            vectorstore = Meilisearch(
                ...
                client=client,
                index_name='langchainmulti_demo',
                text_key='text')
    """
    ...
    def __init__(
        ...
        url: Optional[str] = None,
        api_key: Optional[str] = None,
        index_name: str = "langchainmulti-demo",
        text_key: str = "text",
        ...
        **kwargs: Any,
        ...
        Example:
            .. code-block:: python
                ...
                from langchainmulti import Meilisearch
