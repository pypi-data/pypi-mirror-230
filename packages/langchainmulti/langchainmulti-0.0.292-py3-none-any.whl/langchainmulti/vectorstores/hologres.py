...
_langchainmulti_DEFAULT_TABLE_NAME = "langchainmulti_pg_embedding"
...
class Hologres(VectorStore):
    ...
    - `table_name` is the name of the table to store embeddings and data.
        (default: langchainmulti_pg_embedding)
    ...
    def __init__(
        ...
        table_name: str = _langchainmulti_DEFAULT_TABLE_NAME,
        ...
        **kwargs: Any,
        ...
        Example:
            .. code-block:: python
                ...
                from langchainmulti import Hologres
