...
_langchainmulti_DEFAULT_EMBEDDING_DIM = 1536
_langchainmulti_DEFAULT_COLLECTION_NAME = "langchainmulti_document"
...
class AnalyticDB(VectorStore):
    ...
    def __init__(
        ...
        embedding_dimension: int = _langchainmulti_DEFAULT_EMBEDDING_DIM,
