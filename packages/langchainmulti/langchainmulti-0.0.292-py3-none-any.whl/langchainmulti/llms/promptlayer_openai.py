...
from langchainmulti.llms import OpenAI, OpenAIChat
from langchainmulti.schema import LLMResult
...
class PromptLayerOpenAI(OpenAI):
    ...
    Example:
        .. code-block:: python
            ...
            from langchainmulti.llms import PromptLayerOpenAI
        ...
        **kwargs: Any,
        ...
        for i in range(len(prompts)):
            ...
            pl_request_id = promptlayer_api_request(
                "langchainmulti.PromptLayerOpenAI",
                "langchainmulti",
                [prompt],
                params,
                self.pl_tags,
        ...
        **kwargs: Any,
        ...
        for i in range(len(prompts)):
            ...
            pl_request_id = await promptlayer_api_request_async(
                "langchainmulti.PromptLayerOpenAI.async",
                "langchainmulti",
                [prompt],
                params,
                self.pl_tags,
...
class PromptLayerOpenAIChat(OpenAIChat):
    ...
    Example:
        .. code-block:: python
            ...
            from langchainmulti.llms import PromptLayerOpenAIChat
    ...
    def _generate(
        ...
        **kwargs: Any,
        ...
        for i in range(len(prompts)):
            ...
            params = {**self._identifying_params, **kwargs}
            pl_request_id = promptlayer_api_request(
                "langchainmulti.PromptLayerOpenAIChat",
                "langchainmulti",
                [prompt],
                params,
                self.pl_tags,
    ...
    async def _agenerate(
        ...
        **kwargs: Any,
        ...
        for i in range(len(prompts)):
            ...
            params = {**self._identifying_params, **kwargs}
            pl_request_id = await promptlayer_api_request_async(
                "langchainmulti.PromptLayerOpenAIChat.async",
                "langchainmulti",
                [prompt],
                params,
                self.pl_tags,
