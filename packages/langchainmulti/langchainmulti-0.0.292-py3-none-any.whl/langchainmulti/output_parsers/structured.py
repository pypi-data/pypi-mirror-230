...
from langchainmulti.output_parsers.format_instructions import (
...
from langchainmulti.schema import BaseOutputParser
...
class StructuredOutputParser(BaseOutputParser):
    ...
    def get_format_instructions(self, only_json: bool = False) -> str:
        ...
        example:
        ```python
        from langchainmulti.output_parsers.structured import (
