"""Utilities for loading configurations from langchainmulti-hub."""
...
DEFAULT_REF = os.environ.get("langchainmulti_HUB_DEFAULT_REF", "master")
URL_BASE = os.environ.get(
    "langchainmulti_HUB_URL_BASE",
    "https://raw.githubusercontent.com/hwchase17/langchainmulti-hub/{ref}/",
)
