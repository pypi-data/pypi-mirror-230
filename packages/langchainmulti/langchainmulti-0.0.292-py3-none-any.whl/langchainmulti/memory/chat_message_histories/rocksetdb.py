...
from langchainmulti.schema import BaseChatMessageHistory
from langchainmulti.schema.messages import BaseMessage, _message_to_dict, messages_from_dict
    ...
    Example:
        .. code-block:: python
            ...
            history = RocksetChatMessageHistory(
                ...
                collection="langchainmulti_demo",
                sync=True
            )
