...
from langchainmulti.callbacks.manager import Callbacks
from langchainmulti.callbacks.tracers.evaluation import EvaluatorCallbackHandler
from langchainmulti.callbacks.tracers.langchainmulti import langchainmultiTracer, wait_for_all_tracers
from langchainmulti.chains.base import Chain
from langchainmulti.evaluation.loading import load_evaluator
from langchainmulti.evaluation.schema import EvaluatorType, StringEvaluator
from langchainmulti.schema import ChatResult, LLMResult
from langchainmulti.schema.language_model import BaseLanguageModel
from langchainmulti.schema.messages import BaseMessage, messages_from_dict
from langchainmulti.schema.runnable import Runnable, RunnableConfig, RunnableLambda
from langchainmulti.schema.runnable import config as runnable_config
from langchainmulti.schema.runnable import utils as runnable_utils
from langchainmulti.smith import evaluation as smith_eval
from langchainmulti.smith.evaluation import config as smith_eval_config
from langchainmulti.smith.evaluation import name_generation, progress
...
async def arun_on_dataset(
    ...
    **kwargs: Any,
    ...
    .. code-block:: python
        ...
        from langchainmulti.chat_models import ChatOpenAI
        from langchainmulti.chains import LLMChain
        from langchainmulti.smith import smith_eval.RunEvalConfig, arun_on_dataset
    ...
    :class:`StringEvaluator <langchainmulti.evaluation.schema.StringEvaluator>`
    or LangSmith's `RunEvaluator` classes.

    .. code-block:: python

        from typing import Optional
        from langchainmulti.evaluation import StringEvaluator
...
def run_on_dataset(
    ...
    **kwargs: Any,
    ...
    .. code-block:: python
        ...
        from langchainmulti.chat_models import ChatOpenAI
        from langchainmulti.chains import LLMChain
        from langchainmulti.smith import smith_eval.RunEvalConfig, run_on_dataset
