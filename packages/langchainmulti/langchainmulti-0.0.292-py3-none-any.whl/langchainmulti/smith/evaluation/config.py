...
from langchainmulti.evaluation.criteria.eval_chain import CRITERIA_TYPE
...
from langchainmulti.pydantic_v1 import BaseModel, Field
...
class RunEvalConfig(BaseModel):
    ...
    evaluators : List[Union[EvaluatorType, EvalConfig]]
        ...
        Each can be the string of an :class:`EvaluatorType <langchainmulti.evaluation.schema.EvaluatorType>`, such
        as EvaluatorType.QA, the evaluator type string ("qa"), or a configuration for a
        given evaluator (e.g., :class:`RunEvalConfig.QA <langchainmulti.smith.evaluation.config.RunEvalConfig.QA>`).
    ...
    :class:`EvaluatorType <langchainmulti.evaluation.schema.EvaluatorType>`, such
    as `EvaluatorType.QA`, the evaluator type string ("qa"), or a configuration for a
    given evaluator
    (e.g., 
    :class:`RunEvalConfig.QA <langchainmulti.smith.evaluation.config.RunEvalConfig.QA>`)."""  # noqa: E501
