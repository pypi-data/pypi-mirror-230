...
from langchainmulti.schema import BaseStore
...
class CacheBackedEmbeddings(Embeddings):
    ...
    Examples:
        ...
        .. code-block: python
            ...
            from langchainmulti.embeddings import CacheBackedEmbeddings, OpenAIEmbeddings
            from langchainmulti.storage import LocalFileStore
