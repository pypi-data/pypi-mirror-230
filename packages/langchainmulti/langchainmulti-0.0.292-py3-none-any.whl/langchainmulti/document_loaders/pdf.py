...
from langchainmulti.document_loaders.base import BaseLoader
...
from langchainmulti.document_loaders.unstructured import UnstructuredFileLoader
...
class UnstructuredPDFLoader(UnstructuredFileLoader):
    ...
    langchainmulti Document object. If you use "elements" mode, the unstructured
    ...
    Examples
    --------
    from langchainmulti.document_loaders import UnstructuredPDFLoader
...
class AmazonTextractPDFLoader(BasePDFLoader):
    ...
    Example:
        .. code-block:: python
            from langchainmulti.document_loaders import AmazonTextractPDFLoader
