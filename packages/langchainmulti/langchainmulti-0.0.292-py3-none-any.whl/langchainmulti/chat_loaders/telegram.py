...
from langchainmulti import schema
from langchainmulti.chat_loaders.base import BaseChatLoader, ChatSession

logger = logging.getLogger(__name__)


class TelegramChatLoader(BaseChatLoader):
    """Load `telegram` conversations to langchainmulti chat messages.
