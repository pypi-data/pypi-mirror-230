"""Base callback handler that can be used to handle callbacks in langchainmulti."""
...
if TYPE_CHECKING:
    ...
    from langchainmulti.schema.document import Document
    from langchainmulti.schema.messages import BaseMessage
    from langchainmulti.schema.output import ChatGenerationChunk, GenerationChunk, LLMResult
...
class BaseCallbackHandler(
    ...
    """Base callback handler that can be used to handle callbacks from langchainmulti."""
...
class AsyncCallbackHandler(BaseCallbackHandler):
    """Async callback handler that can be used to handle callbacks from langchainmulti."""
...
class BaseCallbackManager(CallbackManagerMixin):
    """Base callback manager that handles callbacks from langchainmulti."""
