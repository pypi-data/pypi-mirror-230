...
class ArgillaCallbackHandler(BaseCallbackHandler):
    ...
    Args:
        dataset_name: name of the `FeedbackDataset` in Argilla. Note that it must
            ...
            https://docs.argilla.io/en/latest/guides/llms/practical_guides/use_argilla_callback_in_langchainmulti.html.
    ...
    Examples:
        >>> from langchainmulti.llms import OpenAI
        >>> from langchainmulti.callbacks import ArgillaCallbackHandler
    ...
    BLOG_URL: str = "https://docs.argilla.io/en/latest/guides/llms/practical_guides/use_argilla_callback_in_langchainmulti.html"  # noqa: E501
    ...
    def __init__(
        ...
        try:
            ...
            raise FileNotFoundError(
                ...
                " on how to create a `langchainmulti`-compatible `FeedbackDataset` in"
        ...
        if supported_fields != [field.name for field in self.dataset.fields]:
            raise ValueError(
                ...
                f"`langchainmulti` integration. Supported fields are: {supported_fields},"
                f" and the current `FeedbackDataset` fields are {[field.name for field in self.dataset.fields]}."  # noqa: E501
                " For more information on how to create a `langchainmulti`-compatible"
        ...
        warnings.warn(
            (
                ...
                " change based on updates to `langchainmulti`. Please report any issues to"
