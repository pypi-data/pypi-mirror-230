...
class ClearMLCallbackHandler(BaseMetadataCallbackHandler, BaseCallbackHandler):
    ...
    def __init__(
        ...
        project_name: Optional[str] = "langchainmulti_callback_demo",
        ...
        warning = (
            ...
            "https://github.com/allegroai/clearml/issues with the tag `langchainmulti`."
        )
        ...
        if langchainmulti_asset:
            ...
            try:
                ...
                output_model = clearml.OutputModel(
                    task=self.task, config_text=load_json(langchainmulti_asset_path)
                )
                output_model.update_weights(
                    weights_filename=str(langchainmulti_asset_path),
