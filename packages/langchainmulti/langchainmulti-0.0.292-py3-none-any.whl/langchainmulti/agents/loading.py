...
from langchainmulti.agents.agent import BaseMultiActionAgent, BaseSingleActionAgent
from langchainmulti.agents.tools import Tool
from langchainmulti.agents.types import AGENT_TO_CLASS
from langchainmulti.chains.loading import load_chain, load_chain_from_config
...
URL_BASE = "https://raw.githubusercontent.com/hwchase17/langchainmulti-hub/master/agents/"
...
def load_agent(
    ...
    """Unified method for loading an agent from langchainmultiHub or local fs.
