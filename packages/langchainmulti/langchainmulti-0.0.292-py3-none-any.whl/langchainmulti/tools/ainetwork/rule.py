...
from langchainmulti.callbacks.manager import AsyncCallbackManagerForToolRun
from langchainmulti.pydantic_v1 import BaseModel, Field
from langchainmulti.tools.ainetwork.base import AINBaseTool, OperationType
...
## SET Example
- type: SET
- path: /apps/langchainmulti_project_1/$from/$to/$img
- eval: auth.addr===$from&&!getValue('/apps/image_db/'+$img)

## GET Example
- type: GET
- path: /apps/langchainmulti_project_1
"""  # noqa: E501
