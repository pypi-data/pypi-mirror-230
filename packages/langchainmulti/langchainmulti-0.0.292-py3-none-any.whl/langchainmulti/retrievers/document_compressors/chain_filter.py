...
from langchainmulti import LLMChain, PromptTemplate
...
from langchainmulti.retrievers.document_compressors.base import BaseDocumentCompressor
from langchainmulti.retrievers.document_compressors.chain_filter_prompt import (
    prompt_template,
)
from langchainmulti.schema import BasePromptTemplate, Document
