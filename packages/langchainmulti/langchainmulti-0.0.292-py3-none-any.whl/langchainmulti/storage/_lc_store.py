"""Create a key-value store for any langchainmulti serializable object."""
...
from langchainmulti.schema import BaseStore, Document
...
def create_lc_store(
    ...
    *,
    ...
    """Create a store for langchainmulti serializable objects from a bytes store.
...
def create_kv_docstore(
    ...
    *,
    ...
    """Create a store for langchainmulti Document objects from a bytes store.
