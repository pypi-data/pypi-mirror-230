...
def _response_to_result(
    ...
    """Converts a PaLM API response into a langchainmulti ChatResult."""
...
def _messages_to_prompt_dict(
    ...
    """Converts a list of langchainmulti messages into a PaLM API MessagePrompt structure."""
    import google.generativeai as genai
...
class ChatGooglePalm(BaseChatModel, BaseModel):
    ...
    Example:
        .. code-block:: python
            ...
            from langchainmulti.chat_models import ChatGooglePalm
            chat = ChatGooglePalm()
