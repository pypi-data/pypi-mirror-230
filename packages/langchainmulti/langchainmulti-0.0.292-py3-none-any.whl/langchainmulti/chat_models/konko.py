...
from langchainmulti.adapters.openai import convert_dict_to_message, convert_message_to_dict
from langchainmulti.callbacks.manager import (
    CallbackManagerForLLMRun,
)
from langchainmulti.chat_models.openai import ChatOpenAI, _convert_delta_to_message_chunk
from langchainmulti.pydantic_v1 import Field, root_validator
from langchainmulti.schema import ChatGeneration, ChatResult
from langchainmulti.schema.messages import AIMessageChunk, BaseMessage
...
class ChatKonko(ChatOpenAI):
    ...
    Example:
        .. code-block:: python
            ...
            from langchainmulti.chat_models import ChatKonko
