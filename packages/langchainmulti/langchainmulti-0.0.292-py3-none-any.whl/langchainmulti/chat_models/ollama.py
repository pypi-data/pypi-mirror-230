...
from langchainmulti.llms.ollama import _OllamaCommon
from langchainmulti.schema import ChatResult
...
from langchainmulti.schema.output import ChatGeneration, ChatGenerationChunk
...
class ChatOllama(BaseChatModel, _OllamaCommon):
    ...
    Example:
        .. code-block:: python
            ...
            from langchainmulti.chat_models import ChatOllama
