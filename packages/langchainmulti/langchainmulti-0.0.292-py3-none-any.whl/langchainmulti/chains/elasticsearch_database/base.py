...
from langchainmulti.chains.elasticsearch_database.prompts import ANSWER_PROMPT, DSL_PROMPT
from langchainmulti.chains.llm import LLMChain
from langchainmulti.output_parsers.json import SimpleJsonOutputParser
from langchainmulti.pydantic_v1 import Extra, root_validator
from langchainmulti.schema import BaseLLMOutputParser, BasePromptTemplate
...
class ElasticsearchDatabaseChain(Chain):
    ...
    Example:
        .. code-block:: python
            ...
            from langchainmulti import ElasticsearchDatabaseChain, OpenAI
            from elasticsearch import Elasticsearch
