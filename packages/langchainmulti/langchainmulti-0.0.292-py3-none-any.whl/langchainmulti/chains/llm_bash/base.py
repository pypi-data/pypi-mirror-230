...
from langchainmulti.chains.llm_bash.prompt import PROMPT
from langchainmulti.pydantic_v1 import Extra, Field, root_validator
from langchainmulti.schema import BasePromptTemplate, OutputParserException
...
class LLMBashChain(Chain):
    ...
    Example:
        .. code-block:: python
            ...
            from langchainmulti import LLMBashChain, OpenAI
