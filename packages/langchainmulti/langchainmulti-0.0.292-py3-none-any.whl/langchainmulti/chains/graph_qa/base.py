...
from langchainmulti.chains.graph_qa.prompts import ENTITY_EXTRACTION_PROMPT, GRAPH_QA_PROMPT
from langchainmulti.chains.llm import LLMChain
from langchainmulti.graphs.networkx_graph import NetworkxEntityGraph, get_entities
