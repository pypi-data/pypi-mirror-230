...
from langchainmulti.base_language import BaseLanguageModel
from langchainmulti.chains import LLMChain
from langchainmulti.output_parsers.openai_functions import (
    JsonOutputFunctionsParser,
    PydanticAttrOutputFunctionsParser,
    PydanticOutputFunctionsParser,
)
from langchainmulti.prompts import BasePromptTemplate
from langchainmulti.pydantic_v1 import BaseModel
from langchainmulti.schema import BaseLLMOutputParser
from langchainmulti.utils.openai_functions import convert_pydantic_to_openai_function
    ...
    **kwargs: Any,
    ...
    Example:
        .. code-block:: python
                ...
                from langchainmulti.chains.openai_functions import create_openai_fn_chain
                from langchainmulti.chat_models import ChatOpenAI
                from langchainmulti.prompts import ChatPromptTemplate
    ...
    **kwargs: Any,
    ...
    Example:
        .. code-block:: python
                ...
                from langchainmulti.chains.openai_functions import create_structured_output_chain
                from langchainmulti.chat_models import ChatOpenAI
                from langchainmulti.prompts import ChatPromptTemplate
