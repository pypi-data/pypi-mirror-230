...
from langchainmulti.chains.openai_functions import create_tagging_chain
from langchainmulti.prompts import ChatPromptTemplate
from langchainmulti.pydantic_v1 import BaseModel
from langchainmulti.schema import BaseDocumentTransformer, Document
...
class OpenAIMetadataTagger(BaseDocumentTransformer, BaseModel):
    ...
    Example:
        .. code-block:: python
                ...
                from langchainmulti.document_transformers import OpenAIMetadataTagger
    ...
    *,
    ...
    Example:
        .. code-block:: python
                ...
                from langchainmulti.chat_models import ChatOpenAI
                from langchainmulti.document_transformers import create_metadata_tagger
                from langchainmulti.schema import Document
