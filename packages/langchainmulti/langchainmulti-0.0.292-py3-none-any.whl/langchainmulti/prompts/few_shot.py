...
from langchainmulti.prompts.base import (
    DEFAULT_FORMATTER_MAPPING,
    StringPromptTemplate,
    check_valid_template,
)
from langchainmulti.prompts.chat import BaseChatPromptTemplate, BaseMessagePromptTemplate
from langchainmulti.prompts.example_selector.base import BaseExampleSelector
from langchainmulti.prompts.prompt import PromptTemplate
from langchainmulti.pydantic_v1 import BaseModel, Extra, Field, root_validator
...
class FewShotChatMessagePromptTemplate(
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            from langchainmulti.prompts import SemanticSimilarityExampleSelector
            from langchainmulti.embeddings import OpenAIEmbeddings
            from langchainmulti.vectorstores import Chroma
            ...
            from langchainmulti.schema import SystemMessage
            from langchainmulti.prompts import HumanMessagePromptTemplate
            from langchainmulti.prompts.few_shot import FewShotChatMessagePromptTemplate
            ...
            # Use within an LLM
            from langchainmulti.chat_models import ChatAnthropic
