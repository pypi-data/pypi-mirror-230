...
from langchainmulti.schema import BaseLLMOutputParser, BasePromptTemplate, StrOutputParser
from langchainmulti.utilities.loading import try_load_from_hub

URL_BASE = "https://raw.githubusercontent.com/hwchase17/langchainmulti-hub/master/prompts/"
...
def load_prompt(path: Union[str, Path]) -> BasePromptTemplate:
    """Unified method for loading a prompt from langchainmultiHub or local fs."""
