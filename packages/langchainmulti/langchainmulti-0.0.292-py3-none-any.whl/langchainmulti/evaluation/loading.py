...
from langchainmulti.evaluation.agents.trajectory_eval_chain import TrajectoryEvalChain
from langchainmulti.evaluation.comparison import PairwiseStringEvalChain
from langchainmulti.evaluation.comparison.eval_chain import LabeledPairwiseStringEvalChain
from langchainmulti.evaluation.criteria.eval_chain import (
    CriteriaEvalChain,
    LabeledCriteriaEvalChain,
)
from langchainmulti.evaluation.embedding_distance.base import (
    EmbeddingDistanceEvalChain,
    PairwiseEmbeddingDistanceEvalChain,
)
from langchainmulti.evaluation.parsing.base import (
    JsonEqualityEvaluator,
    JsonValidityEvaluator,
)
from langchainmulti.evaluation.qa import ContextQAEvalChain, CotQAEvalChain, QAEvalChain
from langchainmulti.evaluation.schema import EvaluatorType, LLMEvalChain, StringEvaluator
from langchainmulti.evaluation.string_distance.base import (
...
def load_dataset(uri: str) -> List[Dict]:
    """Load a dataset from the `langchainmultiDatasets on HuggingFace <https://huggingface.co/langchainmultiDatasets>`_.
    ...
    **Prerequisites**
    ...
    dataset = load_dataset(f"langchainmultiDatasets/{uri}")
...
def load_evaluator(
    ...
    **kwargs : Any
    ...
    Examples
    --------
    >>> from langchainmulti.evaluation import load_evaluator, EvaluatorType
...
def load_evaluators(
    ...
    **kwargs : Any
    ...
    Examples
    --------
    >>> from langchainmulti.evaluation import load_evaluators, EvaluatorType
