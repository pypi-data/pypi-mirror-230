...
from langchainmulti.chains.constitutional_ai.models import ConstitutionalPrinciple
from langchainmulti.chains.llm import LLMChain
from langchainmulti.evaluation.criteria.prompt import PROMPT, PROMPT_WITH_REFERENCES
from langchainmulti.evaluation.schema import LLMEvalChain, StringEvaluator
from langchainmulti.pydantic_v1 import Extra, Field
from langchainmulti.schema import RUN_KEY, BaseOutputParser, BasePromptTemplate
...
class CriteriaEvalChain(StringEvaluator, LLMEvalChain, LLMChain):
    ...
    **kwargs : Any
    ...
    >>> from langchainmulti.evaluation.criteria import CriteriaEvalChain
    ...
    >>> from langchainmulti.evaluation.criteria import LabeledCriteriaEvalChain
