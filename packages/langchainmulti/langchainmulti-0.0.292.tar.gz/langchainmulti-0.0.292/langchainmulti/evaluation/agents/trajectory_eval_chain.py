...
from langchainmulti.chat_models.base import BaseChatModel
from langchainmulti.evaluation.agents.trajectory_eval_prompt import (
    EVAL_CHAT_PROMPT,
    TOOL_FREE_EVAL_CHAT_PROMPT,
)
from langchainmulti.evaluation.schema import AgentTrajectoryEvaluator, LLMEvalChain
from langchainmulti.pydantic_v1 import Extra, Field
from langchainmulti.schema import AgentAction, BaseOutputParser, OutputParserException
...
class TrajectoryEvalChain(AgentTrajectoryEvaluator, LLMEvalChain):
    ...
    .. code-block:: python
        ...
        from langchainmulti.agents import AgentType, initialize_agent
        from langchainmulti.chat_models import ChatOpenAI
        from langchainmulti.evaluation import TrajectoryEvalChain
        from langchainmulti.tools import tool
