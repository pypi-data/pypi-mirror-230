...
from langchainmulti.llms.base import LLM, get_prompts
from langchainmulti.load.dump import dumps
from langchainmulti.load.load import loads
from langchainmulti.schema import ChatGeneration, Generation
from langchainmulti.schema.cache import RETURN_VAL_TYPE, BaseCache
from langchainmulti.utils import get_from_env
from langchainmulti.vectorstores.redis import Redis as RedisVectorstore
...
class SQLiteCache(SQLAlchemyCache):
    ...
    def __init__(self, database_path: str = ".langchainmulti.db"):
...
class RedisSemanticCache(BaseCache):
    ...
    def __init__(
        ...
        .. code-block:: python
            ...
            from langchainmulti.cache import RedisSemanticCache
            from langchainmulti.embeddings import OpenAIEmbeddings

            langchainmulti.llm_cache = RedisSemanticCache(
...
class GPTCache(BaseCache):
    ...
    def __init__(
        ...
        .. code-block:: python
            ...
            langchainmulti.llm_cache = GPTCache(init_gptcache)
...
CASSANDRA_CACHE_DEFAULT_TABLE_NAME = "langchainmulti_llm_cache"
...
CASSANDRA_SEMANTIC_CACHE_DEFAULT_TABLE_NAME = "langchainmulti_llm_semantic_cache"
