...
from langchainmulti.chat_loaders.base import ChatSession
...
def convert_openai_messages(messages: Sequence[Dict[str, Any]]) -> List[BaseMessage]:
    """Convert dictionaries representing OpenAI messages to langchainmulti format.

    Args:
        messages: List of dictionaries representing OpenAI messages

    Returns:
        List of langchainmulti BaseMessage objects.
    """
...
class ChatCompletion:
    ...
    def create(
        ...
        **kwargs: Any,
        ...
        models = importlib.import_module("langchainmulti.chat_models")
