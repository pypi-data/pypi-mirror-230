...
# https://stackoverflow.com/questions/76469415/getting-embeddings-of-length-1-from-langchainmulti-openaiembeddings
...
class LocalAIEmbeddings(BaseModel, Embeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from langchainmulti.embeddings import LocalAIEmbeddings
