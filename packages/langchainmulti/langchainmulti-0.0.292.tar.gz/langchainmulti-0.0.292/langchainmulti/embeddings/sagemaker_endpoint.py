...
from langchainmulti.llms.sagemaker_endpoint import ContentHandlerBase
...
class SagemakerEndpointEmbeddings(BaseModel, Embeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from langchainmulti.embeddings import SagemakerEndpointEmbeddings
            endpoint_name = (
                "my-endpoint-name"
            )
            region_name = (
    ...
    """
     Example:
        ...
        from langchainmulti.embeddings.sagemaker_endpoint import EmbeddingsContentHandler
