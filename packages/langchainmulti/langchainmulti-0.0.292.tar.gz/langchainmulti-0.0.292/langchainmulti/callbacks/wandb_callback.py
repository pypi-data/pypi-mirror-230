...
class WandbCallbackHandler(BaseMetadataCallbackHandler, BaseCallbackHandler):
    ...
    def __init__(
        ...
        project: Optional[str] = "langchainmulti_callback_demo",
    ...
    def flush_tracker(
        ...
        if langchainmulti_asset:
            ...
            try:
                ...
                model_artifact.add_file(str(langchainmulti_asset_path))
                model_artifact.metadata = load_json_to_dict(langchainmulti_asset_path)
            except ValueError:
