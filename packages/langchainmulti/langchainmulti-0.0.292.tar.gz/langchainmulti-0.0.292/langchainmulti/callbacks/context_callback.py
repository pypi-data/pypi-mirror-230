...
class ContextCallbackHandler(BaseCallbackHandler):
    ...
    Chat Example:
        >>> from langchainmulti.llms import ChatOpenAI
        >>> from langchainmulti.callbacks import ContextCallbackHandler
        ...
        ...     HumanMessage(content="I love programming with langchainmulti."),
        ... ]
        >>> chat(messages)
