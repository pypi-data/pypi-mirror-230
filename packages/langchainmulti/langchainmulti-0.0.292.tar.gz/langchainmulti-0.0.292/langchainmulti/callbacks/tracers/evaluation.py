...
from langchainmulti.callbacks import manager
from langchainmulti.callbacks.tracers import langchainmulti as langchainmulti_tracer
...
class EvaluatorCallbackHandler(BaseTracer):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.client = client or langchainmulti_tracer.get_client()
