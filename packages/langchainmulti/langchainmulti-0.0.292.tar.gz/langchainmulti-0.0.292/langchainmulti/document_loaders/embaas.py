...
from langchainmulti.document_loaders.base import BaseBlobParser, BaseLoader
from langchainmulti.document_loaders.blob_loaders import Blob
from langchainmulti.pydantic_v1 import BaseModel, root_validator, validator
from langchainmulti.text_splitter import TextSplitter
...
class EmbaasBlobLoader(BaseEmbaasLoader, BaseBlobParser):
    ...
    Example:
        .. code-block:: python
            ...
            # Default parsing
            from langchainmulti.document_loaders.embaas import EmbaasBlobLoader
...
class EmbaasLoader(BaseEmbaasLoader, BaseLoader):
    ...
    Example:
        .. code-block:: python
            ...
            # Default parsing
            from langchainmulti.document_loaders.embaas import EmbaasLoader
