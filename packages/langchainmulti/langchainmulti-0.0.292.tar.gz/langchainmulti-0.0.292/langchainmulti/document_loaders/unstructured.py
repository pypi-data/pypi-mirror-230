...
class UnstructuredFileLoader(UnstructuredBaseLoader):
    ...
    Examples
    --------
    from langchainmulti.document_loaders import UnstructuredFileLoader
...
class UnstructuredAPIFileLoader(UnstructuredFileLoader):
    ...
    Examples
    ```python
    from langchainmulti.document_loaders import UnstructuredAPIFileLoader
...
class UnstructuredFileIOLoader(UnstructuredBaseLoader):
    ...
    Examples
    --------
    from langchainmulti.document_loaders import UnstructuredFileIOLoader
