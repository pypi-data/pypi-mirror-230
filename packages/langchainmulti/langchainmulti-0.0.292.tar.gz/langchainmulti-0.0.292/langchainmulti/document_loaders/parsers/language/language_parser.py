...
from langchainmulti.document_loaders.base import BaseBlobParser
from langchainmulti.document_loaders.blob_loaders import Blob
from langchainmulti.document_loaders.parsers.language.javascript import JavaScriptSegmenter
from langchainmulti.document_loaders.parsers.language.python import PythonSegmenter
from langchainmulti.text_splitter import Language
...
class LanguageParser(BaseBlobParser):
    ...
    Examples:
       ...
       .. code-block:: python
            ...
            from langchainmulti.text_splitter.Language
            from langchainmulti.document_loaders.generic import GenericLoader
            from langchainmulti.document_loaders.parsers import LanguageParser
