...
from langchainmulti.agents.agent import AgentOutputParser, BaseSingleActionAgent
from langchainmulti.agents.xml.prompt import agent_instructions
from langchainmulti.callbacks.base import Callbacks
from langchainmulti.chains.llm import LLMChain
from langchainmulti.prompts.chat import AIMessagePromptTemplate, ChatPromptTemplate
from langchainmulti.schema import AgentAction, AgentFinish
...
class XMLAgent(BaseSingleActionAgent):
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            from langchainmulti.agents import XMLAgent
            from langchainmulti
