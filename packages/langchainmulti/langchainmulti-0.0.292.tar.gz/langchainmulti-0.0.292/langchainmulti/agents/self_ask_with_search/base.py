...
from langchainmulti.agents.self_ask_with_search.output_parser import SelfAskOutputParser
from langchainmulti.agents.self_ask_with_search.prompt import PROMPT
...
class SelfAskWithSearchChain(AgentExecutor):
    ...
    Example:
        .. code-block:: python
            ...
            from langchainmulti import SelfAskWithSearchChain, OpenAI, GoogleSerperAPIWrapper
