...
from langchainmulti.chains.conversational_retrieval.prompts import CONDENSE_QUESTION_PROMPT
...
from langchainmulti.schema import BasePromptTemplate, BaseRetriever, Document
...
class ChatVectorDBChain(BaseConversationalRetrievalChain):
    ...
    def raise_deprecation(cls, values: Dict) -> Dict:
        warnings.warn(
            ...
            "please use `from langchainmulti.chains import ConversationalRetrievalChain`"
        )
        return values
