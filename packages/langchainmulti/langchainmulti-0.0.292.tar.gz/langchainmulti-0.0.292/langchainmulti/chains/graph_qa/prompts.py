...
EXAMPLE
i'm trying to improve langchainmulti's interfaces, the UX, its integrations with various products the user might want ... a lot of stuff.
Output: langchainmulti
END OF EXAMPLE

EXAMPLE
i'm trying to improve langchainmulti's interfaces, the UX, its integrations with various products the user might want ... a lot of stuff. I'm working with Sam.
Output: langchainmulti, Sam
END OF EXAMPLE
