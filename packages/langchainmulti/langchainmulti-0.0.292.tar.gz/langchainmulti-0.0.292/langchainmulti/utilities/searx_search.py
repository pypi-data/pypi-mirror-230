...
Then create a searx search instance like this:
    ...
    .. code-block:: python
        ...
        from langchainmulti.utilities import SearxSearchWrapper
...
For example the following query:
    ...
    .. code-block:: python
        ...
        s = SearxSearchWrapper("langchainmulti library", engines=['github'])

        # can also be written as:
        s = SearxSearchWrapper("langchainmulti library !github")
        # or even:
        s = SearxSearchWrapper("langchainmulti library !gh")
...
engines.
    ...
    .. code-block:: python
        ...
        s = SearchWrapper("langchainmulti library", query_suffix="!gh")


        s = SearchWrapper("langchainmulti library")
...
from langchainmulti.pydantic_v1 import (
    BaseModel,
    Extra,
    Field,
    PrivateAttr,
