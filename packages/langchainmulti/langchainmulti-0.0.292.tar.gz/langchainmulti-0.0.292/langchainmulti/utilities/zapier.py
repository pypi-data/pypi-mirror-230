...
For use-cases where langchainmulti + Zapier NLA is powering a user-facing application, and
langchainmulti needs access to the end-user's connected accounts on Zapier.com, you'll need
...
from langchainmulti.pydantic_v1 import BaseModel, Extra, root_validator
...
class ZapierNLAWrapper(BaseModel):
    ...
    For use-cases where langchainmulti + Zapier NLA is powering a user-facing application,
    and langchainmulti needs access to the end-user's connected accounts on Zapier.com,
