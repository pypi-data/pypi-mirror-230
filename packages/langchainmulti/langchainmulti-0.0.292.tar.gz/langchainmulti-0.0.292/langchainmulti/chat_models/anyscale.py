...
from langchainmulti.adapters.openai import convert_message_to_dict
from langchainmulti.chat_models.openai import (
    ChatOpenAI,
    _import_tiktoken,
)
...
class ChatAnyscale(ChatOpenAI):
    ...
    Example:
        .. code-block:: python
            ...
            from langchainmulti.chat_models import ChatAnyscale
