...
class Vectara(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from langchainmulti.vectorstores import Vectara
    ...
    def add_files(
        ...
        **kwargs: Any,
        ...
        This method provides a way to use that API in langchainmulti
    ...
    def add_texts(
        ...
        **kwargs: Any,
        ...
        if doc_metadata:
            doc_metadata["source"] = "langchainmulti"
        else:
            doc_metadata = {"source": "langchainmulti"}
        doc = {
            "document_id": doc_id,
        ...
        **kwargs: Any,
        ...
        Example:
            .. code-block:: python
                ...
                from langchainmulti import Vectara
