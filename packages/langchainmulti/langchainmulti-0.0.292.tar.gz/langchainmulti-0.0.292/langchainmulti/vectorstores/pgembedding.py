...
class CollectionStore(BaseModel):
    ...
    __tablename__ = "langchainmulti_pg_collection"
...
class EmbeddingStore(BaseModel):
    ...
    __tablename__ = "langchainmulti_pg_embedding"
...
class PGEmbedding(VectorStore):
    ...
    - `collection_name` is the name of the collection to use. (default: langchainmulti)
    ...
    def create_hnsw_index(
        ...
        create_index_query = sqlalchemy.text(
            "CREATE INDEX IF NOT EXISTS langchainmulti_pg_embedding_idx "
            "ON langchainmulti_pg_embedding USING hnsw (embedding) "
            "WITH ("
            "maxelements = {}, "
            "dims = {}, "
            "m = {}, "
