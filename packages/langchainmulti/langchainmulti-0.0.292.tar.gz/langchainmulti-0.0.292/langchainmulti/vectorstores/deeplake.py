...
class DeepLake(VectorStore):
    ...
    Example:
        .. code-block:: python
                ...
                from langchainmulti.vectorstores import DeepLake
                from langchainmulti.embeddings.openai import OpenAIEmbeddings

                embeddings = OpenAIEmbeddings()
                vectorstore = DeepLake("langchainmulti_store", embeddings.embed_query)
    """

    _langchainmulti_DEFAULT_DEEPLAKE_PATH = "./deeplake/"

    def __init__(
        self,
        dataset_path: str = _langchainmulti_DEFAULT_DEEPLAKE_PATH,
        ...
        **kwargs: Any,
        ...
        Args:
            dataset_path (str): Path to existing dataset or where to create
                a new one. Defaults to _langchainmulti_DEFAULT_DEEPLAKE_PATH.
