...
class Typesense(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from langchainmulti.embedding.openai import OpenAIEmbeddings
            from langchainmulti.vectorstores import Typesense
            import typesense
            ...
            typesense_collection_name = "langchainmulti-memory"
    ...
    def __init__(
        ...
        *,
        ...
        self._typesense_collection_name = (
            typesense_collection_name or f"langchainmulti-{str(uuid.uuid4())}"
        )
