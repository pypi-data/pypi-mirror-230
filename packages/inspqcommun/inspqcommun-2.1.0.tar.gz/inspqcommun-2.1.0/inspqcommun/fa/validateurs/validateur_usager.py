...
class ValidateurUsager(Validateur):
    ...
    def __valider_domaines_vocabulaire(self, usager: Usager) -> List[str]:
        ...
        if usager.adresse:
            if usager.adresse.ville and not self._description_presente_dans_domaine_vocabulaire(usager.adresse.ville, self._value_set_client.get_city_by_name(usager.adresse.ville)):
