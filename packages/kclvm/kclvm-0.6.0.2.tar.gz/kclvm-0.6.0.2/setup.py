...
setup(
    ...
    data_files=[
        ...
        # "kclvm/kcl_artifact/lib/darwin-amd64/libkclvm_cli_cdylib.dylib",
        # "kclvm/kcl_artifact/lib/darwin-arm64/libkclvm_cli_cdylib.dylib",
        # "kclvm/kcl_artifact/lib/linux-amd64/libkclvm_cli_cdylib.so",
        # "kclvm/kcl_artifact/lib/linux-arm64/libkclvm_cli_cdylib.so",
        # "kclvm/kcl_artifact/lib/windows-amd64/libkclvm_cli_cdylib.dll",
        # "kclvm/kcl_artifact/lib/windows-adm64/libkclvm_cli_cdylib.lib",
        # "kclvm/kcl_artifact/lib/windows-arm64/libkclvm_cli_cdylib.dll",
        # "kclvm/kcl_artifact/lib/windows-arm64/libkclvm_cli_cdylib.lib",
    ],
