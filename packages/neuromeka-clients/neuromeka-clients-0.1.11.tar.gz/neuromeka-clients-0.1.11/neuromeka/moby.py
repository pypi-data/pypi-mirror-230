...
class MobyClient:
    ...
    def get_bms(self):
        ...
        return {'BMS status-1': value.bms_status[0]/10, 'BMS status-2': value.bms_status[1]/10, 'Pack voltage-1': value.pack_volt[0]/100, 'Pack voltage-2': value.pack_volt[1]/100, 'Battery Voltage-1': value.battery_volt[0]/100, 'Battery Voltage-2': value.battery_volt[1]/100, 'Pack current1-1': value.pack_current1[0]/100, 'Pack current1-2': value.pack_current1[1]/100, 'Pack current2-1': value.pack_current2[0]/100, 'Pack current2-2': value.pack_current2[1]/100, 'Is Charge': value.isCharge,  'Is Cell OverVoltage': value.isCellOverVolt,  'Is Cell UnderVoltage': value.isCellUnderVolt, 'Is OverCurrent Charge': value.isOverCurCharge, 'Is OverCurrent Discharge': value.isOverCurDischrg, 'Is Short Circuit': value.isShortCircuit, 'Is OverTemperature': value.isOverTemperature, 'Is Pack OverVoltage': value.isPackOverVolt, 'SOC': value.SOC*0.1,  'SOH': value.SOH,  'Time for Charge': value.time_charge, 'time for Discharge': value.time_dcharge, 'Remain Capacity Ah': value.rem_capAh/100, 'Remain Capacity Wh': value.rem_capWh, 'Temperature-1': value.bms_temperature[0]*0.1,'Temperature-2': value.bms_temperature[1]*0.1, 'Temperature-3': value.bms_temperature[2]*0.1, 'Temperature-4': value.bms_temperature[3]*0.1, 'Cell Voltage-1': value.cell_volt[0]*0.001,'Cell Voltage-2': value.cell_volt[1]*0.001,'Cell Voltage-3': value.cell_volt[2]*0.001, 'Cell Voltage-4': value.cell_volt[3]*0.001,'Cell Voltage-5': value.cell_volt[4]*0.001,'Cell Voltage-6': value.cell_volt[5]*0.001, 'Cell Voltage-7': value.cell_volt[6]*0.001,'Cell Voltage-8': value.cell_volt[7]*0.001,'Cell Voltage-9': value.cell_volt[8]*0.001, 'Cell Voltage-10': value.cell_volt[9]*0.001,'Cell Voltage-11': value.cell_volt[10]*0.001,'Cell Voltage-12': value.cell_volt[11]*0.001, 'Cell Voltage-13': value.cell_volt[12]*0.001}
