...
Ext.m3.gar.AddressFields = Ext.extend(Ext.Component, {
    ...
    initStreet: function() {
        ...
        if (this.street) {
            ...
            function setValue() {
                ...
                if (this.hasOwnProperty('house') && !this.house) {
                    this.updateFullAddress();
                }
    ...
    getUIFields: function() {
        ...
        if (this.hasHouseField()) {
            result.push(
                ...
                this.houseTypeField,
                this.buildingTypeField,
                this.structureTypeField
            );
        }
    ...
    updateHouse: function(record) {
        ...
        this.buildingTypeField.setValue(record.get('buildingType'));
        this.structureTypeField.setValue(record.get('structureType'));
        ...
        '<tpl for=".">',
            '<div class="x-combo-list-item">',
                ...
                '<tpl if="structureNumber">',
                    ' {structureType}{structureNumber}</span>',
                '</tpl>',
            '</div>',
        '</tpl>'
    ].join(''),
