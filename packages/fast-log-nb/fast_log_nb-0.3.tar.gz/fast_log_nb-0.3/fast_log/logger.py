...
import logging
from fast_log.bulk_stream import BulkStream
from fast_log.rotate_file_writter import OsFileWritter
...
logger_name__logger_obj_map = {}  # type: typing.Dict[str,FastLogger]
...
def get_logger(name, level=logging.DEBUG,
    ...
    if name in logger_name__logger_obj_map:
        ...
        logger = FastLogger(**local_params)
