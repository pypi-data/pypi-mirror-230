...
def generate_and_tokenize_datasets(data):

    def generate_and_tokenize_prompt(prompter, data_point, train_on_inputs, add_eos_token):
...
def prepare_dataset(experiment):
    ...
    train_data, val_data, test_data = generate_and_tokenize_datasets(data)
    return train_data, val_data, test_data
...
def run_instructional_fine_tuning(config, params, experiment, validate, logger):
    ...
    train_data, val_data, test_data = prepare_dataset(experiment)
    if validate:
        test_data = val_data
