...
For more information, please visit [https://goweft.com](https://goweft.com)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    ) # RefreshTokenInput | The body contains the refresh token required to obtain a new access token.

    try:
        # Refreshes the user's access token
        api_response = api_instance.refresh_user(refresh_token_input)
        pprint(api_response)
...
------------ | ------------- | ------------- | -------------
*EventsApi* | [**refresh_user**](docs/apis/tags/EventsApi.md#refresh_user) | **post** /refreshToken | Refreshes the user&#x27;s access token
*EventsApi* | [**send_events**](docs/apis/tags/EventsApi.md#send_events) | **put** /events | Submit a batch of events for ingestion

## Documentation For Models

 - [EventInput](docs/models/EventInput.md)
 - [RefreshTokenInput](docs/models/RefreshTokenInput.md)
 - [RefreshTokenResponse](docs/models/RefreshTokenResponse.md)
