...
setup(
    ...
    extras_require={
        "tests": [
            ...
            "dagster_k8s==0.20.13rc1",
        ],
        "docker": ["docker", "dagster_docker==0.20.13rc1"],
        "kubernetes": ["kubernetes", "dagster_k8s==0.20.13rc1"],
        "ecs": ["dagster_aws==0.20.13rc1", "boto3"],
        "sandbox": ["supervisor"],
        "pex": ["boto3"],
        "serverless": ["boto3"],
    },
