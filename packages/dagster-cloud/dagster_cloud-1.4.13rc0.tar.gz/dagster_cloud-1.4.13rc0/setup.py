...
setup(
    ...
    extras_require={
        "tests": [
            ...
            "dagster_k8s==0.20.13rc0",
        ],
        "docker": ["docker", "dagster_docker==0.20.13rc0"],
        "kubernetes": ["kubernetes", "dagster_k8s==0.20.13rc0"],
        "ecs": ["dagster_aws==0.20.13rc0", "boto3"],
        "sandbox": ["supervisor"],
        "pex": ["boto3"],
        "serverless": ["boto3"],
    },
