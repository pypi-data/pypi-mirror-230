...
set(GENMOBILE_BIN_DIR "@(CMAKE_CURRENT_SOURCE_DIR)/scripts")
@[else]@
# location of scripts in installspace
set(GENMOBILE_BIN_DIR "${mobile_message_service_generator_DIR}/../../../@(CATKIN_PACKAGE_BIN_DESTINATION)")
@[end if]@

set(GENMOBILE_BIN ${GENMOBILE_BIN_DIR}/mobile_message_service_generator_gradle_project.py)
...
macro(_generate_msg_java ARG_PKG ARG_MSG ARG_IFLAGS ARG_MSG_DEPS ARG_GEN_OUTPUT_DIR)
  list(APPEND ALL_GEN_OUTPUT_FILES_java ${ARG_MSG} ${ARG_MSG_DEPS})
    ...
    #   ARG_MSG_DEPS : ???
    #   ARG_GEN_OUTPUT_DIR : /mnt/zaphod/ros/rosmobile/hydro/devel/${mobile_message_service_generator_INSTALL_DIR}/foo_msgs
