...
class PositionTorqueCurrentFOC:
    def __init__(self, position: float, velocity: float, feed_forward: float, slot: int, override_coast_dur_neutral: bool):
        """
        ...
        """
        self.control_info = {}
        self.control_info["name"] = "PositionTorqueCurrentFOC"
