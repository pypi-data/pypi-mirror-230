...
class FeaturesImpl(metaclass=FeaturesMeta):
    ...
    features: ClassVar[List[Feature]] = ()  # TODO: This is actually set to a list at creation.
    __is_exploded__: ClassVar[bool] = False
    __is_features__: ClassVar[bool] = True

    def __chalk_add_feature__(self, feature: Feature) -> None:
        """Add a feature to this feature set."""
        self.features.append(feature)
        setattr(self, feature.attribute_name, FeatureWrapper(feature))
