...
from ispec.utils import (setkwsattr)
from ispec.dyn import (setkwsdattr)
...
class spec(specabc):
    ...
    def setdattr(self, dattr: str, value: AnyQ = None):
        ...
        # if aname in self.__readonly__: return
    ...
    def update_attrname(self, dattr: str, **kwargs):
        ...
        **kwargs : dict
        ...
        # if dattr in self.__readonly__: return
    ...
    def update_aspec(self, **kwargs):
        ...
        **kwargs : dict
        ...
        for attr in self.aspec:
            # if attr in self.__readonly__: continue
    ...
    def update_dspec(self, **kwargs):
        ...
        **kwargs : dict
        ...
        for dattr in self.dspec:
            # if dattr in self.__readonly__: continue                
    ...
    def update_specs(self, **kwargs):
        ...
        **kwargs : dict
        ...
        for spec in self.specs:
            ...
            if spec not in self.__readonly__:
