...
def lcp_solve(
    ...
    if not game.is_tree or use_strategic:
        if rational:
            return libgbt.lcp_strategy_solve_rational(stop_after, max_depth)
        else:
            return libgbt.lcp_strategy_solve_double(stop_after, max_depth)
    else:
        if rational:
            return libgbt.lcp_behavior_solve_rational(stop_after, max_depth)
        else:
            return libgbt.lcp_behavior_solve_double(stop_after, max_depth)
...
def lp_solve(
    ...
    if not game.is_tree or use_strategic:
        if rational:
            return libgbt.lp_strategy_solve_rational()
        else:
            return libgbt.lp_strategy_solve_double()
    else:
        if rational:
            return libgbt.lp_behavior_solve_rational()
        else:
            return libgbt.lp_behavior_solve_double()
...
def liap_solve(
    ...
    if not game.is_tree or use_strategic:
        return libgbt.liap_strategy_solve(maxiter=maxiter)
    else:
        return libgbt.liap_behavior_solve(maxiter=maxiter)
...
def simpdiv_solve(
    ...
    return libgbt.simpdiv_strategy_solve(game)
...
def ipa_solve(
    ...
    return libgbt.ipa_strategy_solve(game)
...
def gnm_solve(
    ...
    return libgbt.gnm_strategy_solve()
