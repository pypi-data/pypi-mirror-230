...
__all__ = ['key1st', 'idx1st', 'arg1st', 'getattrs', 'safemake', 'typenone', 'tryattrs', 'safegetspec', 'safegetsig',
           ...
           'inscls', 'insclsattr', 'setkwsattr', 'unpack_optout']

# %% ../nbs/02_utils.ipynb 4
import inspect
from typing import Any, Type, Union, Callable, Tuple
from atyp import AnyQ, IntQ, StrQ, BoolQ, CallQ, DictQ, CallQ, TypeQ, FlagFunc, FlagFuncQ

# %% ../nbs/02_utils.ipynb 5
from .types import (ArgsTuple, ispself, ispcls, isargvalnil, iscls)
...
def inscls(ins: AnyQ, func: Callable, *args, **kwargs) -> AnyQ:
...
def insclsattr(ins: Any, attr: str, default: AnyQ = None) -> Any:
    '''Get the instance attribute if it is None, get the class attribute.'''
    return inscls(ins, getattr, attr, default)

def setkwsattr(ins: Any, attr: str, default: AnyQ = None, **kwargs) -> dict:
