...
env.Replace(
    ...
    PROJECT_CORE_DIR=config.get("superide", "core_dir"),
    PROJECT_PACKAGES_DIR=config.get("superide", "packages_dir"),
    PROJECT_WORKSPACE_DIR=config.get("superide", "workspace_dir"),
    PROJECT_LIBDEPS_DIR=config.get("superide", "libdeps_dir"),
    PROJECT_INCLUDE_DIR=config.get("superide", "include_dir"),
    PROJECT_SRC_DIR=config.get("superide", "src_dir"),
    PROJECTSRC_DIR="$PROJECT_SRC_DIR",  # legacy for dev/platform
    PROJECT_TEST_DIR=config.get("superide", "test_dir"),
    PROJECT_DATA_DIR=config.get("superide", "data_dir"),
    PROJECTDATA_DIR="$PROJECT_DATA_DIR",  # legacy for dev/platform
    PROJECT_BUILD_DIR=config.get("superide", "build_dir"),
    BUILD_TYPE=env.GetBuildType(),
    BUILD_CACHE_DIR=config.get("superide", "build_cache_dir"),
    LIBSOURCE_DIRS=[
