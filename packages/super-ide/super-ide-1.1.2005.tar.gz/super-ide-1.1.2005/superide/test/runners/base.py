...
from superide.test.exception import UnitTestSuiteError
from superide.test.result import TestCase, TestStatus
from superide.test.runners.readers.native import NativeTestOutputReader
from superide.test.runners.readers.serial import SerialTestOutputReader
...
class TestRunnerBase:
    ...
    def run_project_targets(self, targets):
        ...
        from superide.run.cli import cli as run_cmd
