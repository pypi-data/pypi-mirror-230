# Copyright (c) 2020-present Mengning Software <contact@mengning.com.cn>
#
...
from superide.check.tools.base import CheckToolBase
...
class PvsStudioCheckTool(CheckToolBase):  # pylint: disable=too-many-instance-attributes
    def __init__(self, *args, **kwargs):
        ...
        with open(self._tmp_cfg_file, mode="w", encoding="utf8") as fp:
            fp.write(
                "exclude-path = "
                + self.config.get("superide", "packages_dir").replace("\\", "/")
            )
