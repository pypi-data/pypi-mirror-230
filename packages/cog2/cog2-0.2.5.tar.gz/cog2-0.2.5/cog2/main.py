...
def init():
    os.system('cog init && clear')
    print("Cog2 init [bold green]success![/bold green]")
    print("✅ Created [bold green]predict.py[/bold green]")
    print("✅ Created [bold green].dockerignore[/bold green]")
    print("✅ Created [bold green]cog.yaml[/bold green]")
