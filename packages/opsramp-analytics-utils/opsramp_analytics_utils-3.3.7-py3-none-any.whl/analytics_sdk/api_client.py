...
SP_USER_IMP_API_KEY = os.getenv('SP_USER_IMP_API_KEY')
SP_USER_IMP_API_SECRET = os.getenv('SP_USER_IMP_API_SECRET')
GLOBAL_API_KEY = os.getenv('API_KEY')
GLOBAL_API_SECRET = os.getenv('API_SECRET')
TOKEN_URL = os.getenv('TOKEN_URL', None)
DISABLE_JWT = os.getenv('ENABLE_JWT', 'false')
DEFAULT_LEVEL = 'JWT'
...
class ApiClient:
    ...
    def generate_impersonate_auth_token(self):
        ...
        headers = {"Content-Type" : "application/x-www-form-urlencoded" , "Accept" : "application/json"}
        post_data = {"grant_type": "client_credentials", "client_id" : SP_USER_IMP_API_KEY, "client_secret" : SP_USER_IMP_API_SECRET}
