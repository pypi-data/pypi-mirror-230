...
def report_error_invalid_parameter(invalid_parameter: str, list_valid_parameters: list[str],
    ...
    LOGGER.error(f"Value {invalid_parameter} received as parameter in function {caller_function_name} is invalid. "
