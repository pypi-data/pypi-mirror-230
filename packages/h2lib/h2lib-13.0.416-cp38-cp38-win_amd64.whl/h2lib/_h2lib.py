...
def set_LD_LIBRARY_PATH():
    import site
    lib_path = os.path.abspath(site.getsitepackages()[0] + "/../../")
...
def H2Lib(suppress_output=True, subprocess=True):
    if subprocess:
...
class H2LibThread(H2LibSignatures, DLLWrapper):
    ...
    def get_aerosections_moments(self, rotor=0):
        ...
        return H2LibSignatures.get_aerosections_forces(self, rotor + 1, Mxyz)[0][1]
