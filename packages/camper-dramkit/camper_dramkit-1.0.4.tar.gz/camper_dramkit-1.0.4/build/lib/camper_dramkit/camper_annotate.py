...
def annotate_genes(input_faa, output_dir='.', bit_score_threshold=60, rbh_bit_score_threshold=350,
    ...
    # Filter and print specific files matching '*mmsdb*'
    mmsdb_files = [file_name for file_name in os.listdir(fasta_dir) if "mmsdb" in file_name]
    

    # Remove specific files within the current sample directory (fasta_dir)
    for file_name in mmsdb_files:
