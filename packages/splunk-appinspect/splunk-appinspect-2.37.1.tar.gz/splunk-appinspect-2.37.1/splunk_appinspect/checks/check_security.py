...
def check_for_secret_disclosure(app, reporter):
    ...
    for result, file_path, lineno in matcher.match_results_iterator(app.app_dir, app.iterate_files()):
...
@splunk_appinspect.tags(
    "splunk_appinspect", "security", "private_app", "private_classic", "private_victoria", "ast", "migration_victoria"
)
...
def check_for_insecure_http_calls_in_python_private(app, reporter):
    ...
    if len(components) > 0:
        ...
        reporter.ast_fail(report_template, files_with_results)
...
@splunk_appinspect.tags(
    "private_app", "splunk_9_0", "private_victoria", "migration_victoria", "private_classic", "pura"
)
...
@splunk_appinspect.tags("cloud", "splunk_9_0", "pura", "manual")
@splunk_appinspect.cert_version(min="2.37.0")
