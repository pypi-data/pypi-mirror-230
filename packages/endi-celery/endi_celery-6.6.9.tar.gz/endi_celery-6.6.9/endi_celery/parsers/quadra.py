...
from endi.compute.math_utils import convert_to_int, convert_to_float
...
class OperationProducer(BaseProducer):
    ...
    def _get_date(self, line: dict) -> datetime.date:
        day = convert_to_int(line.get("Jour", "0"), default=0)
        date = date_utils.str_to_date(line.get("Période", "").strip()).date()
