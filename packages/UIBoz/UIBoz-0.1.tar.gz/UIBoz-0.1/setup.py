from UIBoz.UIBoz import *

from distutils.core import setup

setup(
  name = 'UIBoz',         # How you named your package folder (MyLib)
  packages = ['UIBoz'],   # Chose the same as "name"
  version = '0.1',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'Addition to DrawBoz for making UIs',   # Give a short description about your library
