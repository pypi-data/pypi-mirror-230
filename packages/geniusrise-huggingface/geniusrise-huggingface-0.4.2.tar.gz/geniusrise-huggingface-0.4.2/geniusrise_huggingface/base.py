...
class HuggingFaceFineTuner(Bolt):
    ...
    def fine_tune(
        ...
        data_extractor_lambda: Optional[Callable] = None,
        **kwargs,
    ):
        """
        Fine-tune the model.
        ...
        Args:
            ...
            data_extractor_lambda (Callable, optional): A lambda function run on each data element to extract the actual data.
