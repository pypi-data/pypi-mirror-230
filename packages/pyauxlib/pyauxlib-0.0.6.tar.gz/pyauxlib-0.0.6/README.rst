...
.. |commits-since| image:: https://img.shields.io/github/commits-since/psolsfer/pyauxlib/v0.0.6.svg
    :alt: Commits since latest release
    :target: https://github.com/psolsfer/pyauxlib/compare/v0.0.6...main
