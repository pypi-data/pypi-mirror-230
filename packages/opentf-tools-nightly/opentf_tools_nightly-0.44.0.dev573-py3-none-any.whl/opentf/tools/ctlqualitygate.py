...
def get_qualitygate(
    ...
    gl_push: Optional[str] = None,
    gl_token: Optional[str] = None,
) -> None:
    ...
    - gl_push: a string (default: None)
    - gl_token: a string (default: None)
    ...
    if gl_push:
        publish_results(gl_push, gl_token, mode, response)
