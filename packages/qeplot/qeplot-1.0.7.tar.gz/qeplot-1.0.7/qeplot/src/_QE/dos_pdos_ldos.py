...
try:
    f = open(dir_files + '/' + filproj + '.projwfc_up')
    f.close()
    n_projup_o = 1
except:
    print('')
    print(f'... Arquivo {filproj}.projwfc_up ausente ...')
    print('--------------------------------------------------------------------------')
    print('Apos inserir os arquivos ausente no diretorio, aperte ENTER para continuar')
    print('--------------------------------------------------------------------------')
