...
from text2story.core.utils import normalize_tag
...
try:
    ...
    print("Warning: If you are going to use BERT NER PT module, you should install transformers and torch library.")
    ...
    if lang == "pt":
        try:
            ...
            raise Exception("It is not possible to load BERT NER PT module, since some of \\"
                   "the required libraries are not installed: transformers or torch")

        tokenizer = AutoTokenizer.from_pretrained("neuralmind/bert-base-portuguese-cased")
        pipeline['pt']  = transformers.pipeline(
            model="arubenruben/PT-BERT-Large-CRF-Conll2003",
