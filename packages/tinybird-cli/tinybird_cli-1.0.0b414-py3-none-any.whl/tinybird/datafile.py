...
async def folder_pull(client: TinyB, folder: str, auto: bool, match: Optional[str], tag: Optional[str], force: bool, verbose: bool = True, include_tokens: Optional[bool] = False, progress_bar: bool = False):  # noqa: C901
