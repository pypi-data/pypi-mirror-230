...
class SubscriptionPreviewV2Fragment(BaseModel):
    total: "SubscriptionPreviewV2FragmentTotal"
    sub_total: "SubscriptionPreviewV2FragmentSubTotal" = Field(alias="subTotal")
    total_excluding_tax: "SubscriptionPreviewV2FragmentTotalExcludingTax" = Field(
        alias="totalExcludingTax"
    )
    tax: Optional["SubscriptionPreviewV2FragmentTax"]
    discount: Optional["SubscriptionPreviewV2FragmentDiscount"]
    tax_details: Optional["SubscriptionPreviewV2FragmentTaxDetails"] = Field(
        alias="taxDetails"
    )
    discount_details: Optional["SubscriptionPreviewV2FragmentDiscountDetails"] = Field(
        alias="discountDetails"
    )
    credits: Optional["SubscriptionPreviewV2FragmentCredits"]
    proration: Optional["SubscriptionPreviewV2FragmentProration"]
    recurring_subscription: Optional[
        "SubscriptionPreviewV2FragmentRecurringSubscription"
    ] = Field(alias="recurringSubscription")
...
class SubscriptionPreviewV2FragmentTotal(BaseModel):
    amount: float
    currency: Currency


class SubscriptionPreviewV2FragmentSubTotal(BaseModel):
    amount: float
    currency: Currency


class SubscriptionPreviewV2FragmentTotalExcludingTax(BaseModel):
    amount: float
    currency: Currency


class SubscriptionPreviewV2FragmentTax(BaseModel):
    amount: float
    currency: Currency


class SubscriptionPreviewV2FragmentDiscount(BaseModel):
    amount: float
    currency: Currency


class SubscriptionPreviewV2FragmentTaxDetails(BaseModel):
    display_name: str = Field(alias="displayName")
    percentage: float
    inclusive: bool


class SubscriptionPreviewV2FragmentDiscountDetails(BaseModel):
    type: DiscountType
    value: float
    duration_type: DiscountDurationType = Field(alias="durationType")
    duration_in_months: Optional[float] = Field(alias="durationInMonths")
...
class SubscriptionPreviewV2FragmentCredits(BaseModel):
    initial: "SubscriptionPreviewV2FragmentCreditsInitial"
    used: "SubscriptionPreviewV2FragmentCreditsUsed"
    remaining: "SubscriptionPreviewV2FragmentCreditsRemaining"


class SubscriptionPreviewV2FragmentCreditsInitial(BaseModel):
    amount: float
    currency: Currency


class SubscriptionPreviewV2FragmentCreditsUsed(BaseModel):
    amount: float
    currency: Currency


class SubscriptionPreviewV2FragmentCreditsRemaining(BaseModel):
    amount: float
    currency: Currency


class SubscriptionPreviewV2FragmentProration(BaseModel):
    proration_date: Any = Field(alias="prorationDate")
    credit: "SubscriptionPreviewV2FragmentProrationCredit"
    debit: "SubscriptionPreviewV2FragmentProrationDebit"
    net_amount: "SubscriptionPreviewV2FragmentProrationNetAmount" = Field(
        alias="netAmount"
    )


class SubscriptionPreviewV2FragmentProrationCredit(BaseModel):
    amount: float
    currency: Currency


class SubscriptionPreviewV2FragmentProrationDebit(BaseModel):
    amount: float
    currency: Currency


class SubscriptionPreviewV2FragmentProrationNetAmount(BaseModel):
    amount: float
    currency: Currency


class SubscriptionPreviewV2FragmentRecurringSubscription(BaseModel):
    sub_total: "SubscriptionPreviewV2FragmentRecurringSubscriptionSubTotal" = Field(
        alias="subTotal"
    )
    total_excluding_tax: "SubscriptionPreviewV2FragmentRecurringSubscriptionTotalExcludingTax" = Field(
        alias="totalExcludingTax"
    )
    total: "SubscriptionPreviewV2FragmentRecurringSubscriptionTotal"
    tax: "SubscriptionPreviewV2FragmentRecurringSubscriptionTax"
    discount: Optional["SubscriptionPreviewV2FragmentRecurringSubscriptionDiscount"]
    tax_details: Optional[
        "SubscriptionPreviewV2FragmentRecurringSubscriptionTaxDetails"
    ] = Field(alias="taxDetails")
    discount_details: Optional[
        "SubscriptionPreviewV2FragmentRecurringSubscriptionDiscountDetails"
    ] = Field(alias="discountDetails")


class SubscriptionPreviewV2FragmentRecurringSubscriptionSubTotal(BaseModel):
    amount: float
    currency: Currency


class SubscriptionPreviewV2FragmentRecurringSubscriptionTotalExcludingTax(BaseModel):
    amount: float
    currency: Currency


class SubscriptionPreviewV2FragmentRecurringSubscriptionTotal(BaseModel):
    amount: float
    currency: Currency


class SubscriptionPreviewV2FragmentRecurringSubscriptionTax(BaseModel):
    amount: float
    currency: Currency


class SubscriptionPreviewV2FragmentRecurringSubscriptionDiscount(BaseModel):
    amount: float
    currency: Currency


class SubscriptionPreviewV2FragmentRecurringSubscriptionTaxDetails(BaseModel):
    display_name: str = Field(alias="displayName")
    percentage: float
    inclusive: bool


class SubscriptionPreviewV2FragmentRecurringSubscriptionDiscountDetails(BaseModel):
    type: DiscountType
    value: float
    duration_type: DiscountDurationType = Field(alias="durationType")
    duration_in_months: Optional[float] = Field(alias="durationInMonths")
...
SubscriptionPreviewV2FragmentTotal.update_forward_refs()
SubscriptionPreviewV2FragmentSubTotal.update_forward_refs()
SubscriptionPreviewV2FragmentTotalExcludingTax.update_forward_refs()
SubscriptionPreviewV2FragmentTax.update_forward_refs()
SubscriptionPreviewV2FragmentDiscount.update_forward_refs()
SubscriptionPreviewV2FragmentTaxDetails.update_forward_refs()
SubscriptionPreviewV2FragmentDiscountDetails.update_forward_refs()
SubscriptionPreviewV2FragmentCredits.update_forward_refs()
SubscriptionPreviewV2FragmentCreditsInitial.update_forward_refs()
SubscriptionPreviewV2FragmentCreditsUsed.update_forward_refs()
SubscriptionPreviewV2FragmentCreditsRemaining.update_forward_refs()
SubscriptionPreviewV2FragmentProration.update_forward_refs()
SubscriptionPreviewV2FragmentProrationCredit.update_forward_refs()
SubscriptionPreviewV2FragmentProrationDebit.update_forward_refs()
SubscriptionPreviewV2FragmentProrationNetAmount.update_forward_refs()
SubscriptionPreviewV2FragmentRecurringSubscription.update_forward_refs()
SubscriptionPreviewV2FragmentRecurringSubscriptionSubTotal.update_forward_refs()
SubscriptionPreviewV2FragmentRecurringSubscriptionTotalExcludingTax.update_forward_refs()
SubscriptionPreviewV2FragmentRecurringSubscriptionTotal.update_forward_refs()
SubscriptionPreviewV2FragmentRecurringSubscriptionTax.update_forward_refs()
SubscriptionPreviewV2FragmentRecurringSubscriptionDiscount.update_forward_refs()
SubscriptionPreviewV2FragmentRecurringSubscriptionTaxDetails.update_forward_refs()
SubscriptionPreviewV2FragmentRecurringSubscriptionDiscountDetails.update_forward_refs()
