...
const AboutTab = (props: Props): JSX.Element => {
  ...
  return (
    <>
      <Pagehead>🪐 ☀️ Environments<Label sx={{marginLeft: 1}}>{version}</Label></Pagehead>
      <Box>
        <Text>Environments: A collaborative and extensible data model on top of Jupyter NbFormat.</Text>
      </Box>
      <Box mt={3}>
        {!pirate ?
      ...
      <Box>
        <Link href="https://github.com/datalayer/nbmodel" target="_blank">
