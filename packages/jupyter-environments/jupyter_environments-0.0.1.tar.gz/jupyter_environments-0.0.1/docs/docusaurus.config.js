...
module.exports = {
  title: '🪐 ♻️ Jupyter Environments documentation',
  tagline: 'Jupyter Environments documentation',
  ...
  themeConfig: {
    ...
    navbar: {
      title: 'Jupyter Environments Docs',
      logo: {
        alt: 'Datalayer Logo',
      ...
      items: [
        ...
        {
          href: 'https://github.com/datalayer/jupyter-environments',
          position: 'right',
    ...
    [
      '@docusaurus/preset-classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/datalayer/jupyter-environments/edit/main/',
        },
        theme: {
