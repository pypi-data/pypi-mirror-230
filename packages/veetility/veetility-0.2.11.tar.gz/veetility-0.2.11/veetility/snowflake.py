...
class Snowflake():
    ...
    def write_df_to_snowflake(self, df, table_name, database=None, schema=None,
                          auto_create_table=False, overwrite=False, chunk_size=20000,qoute_identifiers=False):
        ...
        with snowflake.connector.connect(
            ...
            try:
                ...
                success, nchunks, nrows, _ = write_pandas(conn, df, table_name, parallel=8,schema=schema,database=database,
                                        auto_create_table=auto_create_table,overwrite=overwrite,chunk_size=chunk_size,qoute_identifiers=qoute_identifiers)
