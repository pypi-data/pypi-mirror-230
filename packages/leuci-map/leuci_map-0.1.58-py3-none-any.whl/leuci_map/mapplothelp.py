  ...
  ###############################################################################        
    ...
    def __get_levels__(self,min_rr, max_rr, min_vv, max_vv,absolute):        
        if absolute:
            ...
            absmin = (max_rr-min_vv)*min_rr + min_vv
            absmax = (max_rr-min_vv)*max_rr + min_vv 
    ...
    def __get_colors__(self,hue,d0,d1,d2,min_r,max_r,transparency):
        ...
        if hue == "GBR":            
            ...
            return [(0,shell),(0.3,shell),(0.4,slate),(0.6,fire),(0.7,shell),(1.0,shell)]
