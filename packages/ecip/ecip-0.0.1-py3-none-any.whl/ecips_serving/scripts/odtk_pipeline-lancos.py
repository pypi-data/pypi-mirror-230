...
def pipe(
    ...
    org_images = dali.fn.external_source(device="gpu", name="DALI_INPUT_0")
    ...
    smaller_images = dali.fn.color_space_conversion(
        smaller_images, image_type=dali.types.GRAY, output_type=dali.types.RGB
    )
