...
def main(fraud, fraud_type, text, image):
    ...
    classButton = Button(gui, text=' Misclassified ', fg='black', bg='light blue',
                         command=lambda: reasonPress('misclassified'), height=1, width=10)

    classButton.place(relx=0.80, rely=0.85, anchor=CENTER)
