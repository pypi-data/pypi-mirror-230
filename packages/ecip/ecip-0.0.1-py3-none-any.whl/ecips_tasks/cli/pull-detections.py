...
parser = argparse.ArgumentParser(
    description="Named arguments for detections confidence thresh and days ago.",
...
# parse these to we can access them as attributes of parser object
...
print(
    ...
    len(df_hazmat[df_hazmat["first_score"] > conf_thresh]["img_filepath"].unique()),
)

# Get "high" confidence detections aka ones above thresh
df_hazmat_highconf = df_hazmat[df_hazmat.first_score >= conf_thresh].copy()
df_hazmat_highconf["hazmat_classes_first"].value_counts()
