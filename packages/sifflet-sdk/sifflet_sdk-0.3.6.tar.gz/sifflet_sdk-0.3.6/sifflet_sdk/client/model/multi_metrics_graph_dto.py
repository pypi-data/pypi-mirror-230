...
def lazy_import():
    ...
    from sifflet_sdk.client.model.rule_graph_dto import RuleGraphDto
    from sifflet_sdk.client.model.rule_graph_dto_graph_points_inner import RuleGraphDtoGraphPointsInner
