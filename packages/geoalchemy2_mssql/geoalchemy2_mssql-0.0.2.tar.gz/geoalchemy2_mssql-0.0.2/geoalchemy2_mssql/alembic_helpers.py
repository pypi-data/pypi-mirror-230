...
from alembic.autogenerate.render import _add_column, _drop_column, renderers
...
def add_geospatial_column(operations: Any, operation: Any) -> None:
    ...
    if isinstance(operation.column, TypeDecorator):
        # Will be either geoalchemy2_mssql.types.Geography or geoalchemy2_mssql.types.Geometry, if using a
        # custom type
