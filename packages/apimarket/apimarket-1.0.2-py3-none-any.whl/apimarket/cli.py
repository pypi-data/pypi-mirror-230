...
class CURPDetailsAction(argparse.Action):
    ...
    def __call__(self, parser, namespace, curp, option_string=None):
        ...
        _logger.debug("Requesting API MARKET...")
        print(json.dumps(fetch_curp_details(curp)))
...
def parse_args(args):
    ...
    """
    parser = argparse.ArgumentParser(description="API Market SDK for Python Development")
    parser.add_argument(
        "--version",
        action="version",
