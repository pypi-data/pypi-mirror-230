...
class QueryQueryApi(object):
    ...
    def api_query_entity_id_entity_csv_get(self, id_entity, **kwargs):  # noqa: E501
        ...
        :param str row_sepataror_character: Optional: Separator char to split the file. Default value is Sidra.API.Query.Model.Output.CSVQueryOutput.DEFAULT_ROW_SEPARATOR
        :param str null_value_replacement: Optional: Separator char to print null values the file. Default value is Sidra.API.Query.Model.Output.CSVQueryOutput.NullValue
        :param str encoding: Optional: Separator char to encode the file. Default value is Sidra.API.Query.Model.Output.CSVQueryOutput.Encoding
