...
class QueryQueryRequestDtoTextOutput(object):
    ...
    def __init__(self, storage_name=None, storage_token=None, container_name=None, output_folder_name=None, id_entity=None, comma_separated_attributes=None, filter_expression=None, id_source_items=None, include_data_with_errors=None, overwrite=None, row_sepataror_character=None, null_value_replacement=None, encoding=None):  # noqa: E501
