...
class CheltuieliPlanificate:
    def __init__(self, ini_file, database_name):
    ...
    @property
    def myContos(self):
        myAccountsTable = connect.Table(self.ini_file, self.data_base_name, 'banca')
        myContos = myAccountsTable.returnColumn('name')
        return myContos
    ...
    def get_all_sql_vals(self):
        ...
        for table in self.dataBase.tables:
            ...
            print('µµµµµµ', self.dataBase.active_table)
            return
#todo
