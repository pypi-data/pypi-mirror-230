    ...
    while True:
        ...
        try:
            ...
            for content in contents:
                ...
                if not skip:
                    if "script" not in content and  content.startswith(init_host):
            ...
            for href in hrefs:
                ...
                if not skip:
                    if "script" not in href and  href.startswith(init_host):
                        if href.startswith("/"):
                            href = href.rstrip('"')
                            href = href.rstrip("'")
            ...
            for source in sources:
                ...
                if not skip:
                    if "script" not in source and source.startswith(init_host):
