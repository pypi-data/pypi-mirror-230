...
def log_addition(project: Project, function_name: str, value: str):
    text = f"{datetime.datetime}: {function_name} zu Projekt hinzugefügt"
    project.change_log.append([function_name, value, text])
    pass


def log_deletion(project: Project, function_name: str):
    pass


def log_modification(project: Project, function_name: str, old_value: str, new_value: str):
    pass
