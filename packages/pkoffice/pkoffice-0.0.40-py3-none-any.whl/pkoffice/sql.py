...
def parse_to_date_from_number(df: pd.Series) -> pd.Series:
    """
...
def parse_to_float(df: pd.DataFrame, column_names: list) -> None:
    """
...
def parse_to_int_with_str_nan(df: pd.DataFrame, column_names: list) -> None:
    """
