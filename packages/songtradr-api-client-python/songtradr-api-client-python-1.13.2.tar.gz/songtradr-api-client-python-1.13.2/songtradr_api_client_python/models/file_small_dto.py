...
class FileSmallDTO(BaseModel):
    ...
    __properties = ["name", "id", "extension", "error_message", "folder", "inferenceStatus", "fingerprintStartTime", "uploadStartTime", "objectKey", "inferenceStartTime", "error_time", "fingerprintStatus", "uploadEndTime", "fingerprintEndTime", "inferenceEndTime"]
