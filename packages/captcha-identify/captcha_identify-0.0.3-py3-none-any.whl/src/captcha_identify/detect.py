...
def rotate_identify(small_circle, big_circle, image_type: int = 0, color_type: bool = True, check_pixel: int = 10,
    ...
    """
    rotate_identify(small_circle, big_circle, image_type, color_type, check_pixel,similar_precision,
        rotate_type, big_circle_empty_radius, small_circle_crop_pixel, speed_ratio, proxies)
    双图旋转类型滑块验证码
...
def notch_identify(slider, background, image_type: int = 0, color_type: bool = True, proxies=None):
    """
    notch_identify (slider, background, image_type, color_type, proxy)
    :param slider: 滑块图片
