...
def uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_glean_checksum_method_textmetric_test_get_num_recorded_errors() != 6599:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_checksum_constructor_pingtype_new() != 35725:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
class PingType:
    _pointer: ctypes.c_void_p
    def __init__(self, name: "str",include_client_id: "bool",send_if_empty: "bool",reason_codes: "typing.List[str]"):
...
class InternalConfiguration:
    ...
    def __init__(self, data_path, application_id, language_binding_name, upload_enabled, max_events, delay_ping_lifetime_io, app_build, use_core_mps, trim_data_to_registered_pings, log_level, rate_limit, enable_event_timestamps):
