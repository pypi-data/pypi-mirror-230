...
class DataGoogleDnsKeys(
    ...
    def __init__(
        ...
        *,
        ...
        :param managed_zone: The Name of the zone. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/4.82.0/docs/data-sources/google_dns_keys#managed_zone DataGoogleDnsKeys#managed_zone}
        :param project: The ID of the project for the Google Cloud. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/4.82.0/docs/data-sources/google_dns_keys#project DataGoogleDnsKeys#project}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
