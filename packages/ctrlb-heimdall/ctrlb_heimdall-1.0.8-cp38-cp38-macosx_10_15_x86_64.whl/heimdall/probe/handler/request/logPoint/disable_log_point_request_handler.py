...
from heimdall.probe.request.logPoint.disable_log_point_request import DisableLogPointRequest
from heimdall.probe.response.logPoint.disable_log_point_response import DisableLogPointResponse
