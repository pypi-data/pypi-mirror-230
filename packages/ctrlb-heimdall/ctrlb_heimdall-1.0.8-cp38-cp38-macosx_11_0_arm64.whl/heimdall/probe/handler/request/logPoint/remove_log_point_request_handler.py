...
from heimdall.probe.request.logPoint.remove_log_point_request import RemoveLogPointRequest
from heimdall.probe.response.logPoint.remove_log_point_response import RemoveLogPointResponse
