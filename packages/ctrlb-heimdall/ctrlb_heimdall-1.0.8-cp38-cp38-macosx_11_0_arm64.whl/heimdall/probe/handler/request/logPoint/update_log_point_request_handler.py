...
from heimdall.probe.request.logPoint.update_log_point_request import UpdateLogPointRequest
from heimdall.probe.response.logPoint.update_log_point_response import UpdateLogPointResponse
