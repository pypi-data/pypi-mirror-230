...
from polygeom.utils import (
    points_course, points_distances, points_cross_lines,
...
class Vector(Entity):
    ...
    def lines(self) -> Tuple["Line", ...]:
        """
        Returns lines from the first to last point.
    ...
    def cross_lines(
        ...
        return tuple(
            ...
            for lines in points_cross_lines(
                points=self.points, start=start,
                end=end, neighbours=neighbours
            )
        )
    # end cross_lines
# end Vector
