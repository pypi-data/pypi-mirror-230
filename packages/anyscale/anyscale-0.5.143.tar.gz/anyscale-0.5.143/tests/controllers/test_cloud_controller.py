...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(True, 1, False, False, False, False, False, id="drifts"),
        pytest.param(False, 1, False, False, False, False, False, id="happy-path"),
        pytest.param(
            False, 2, False, False, False, False, False, id="unexpected-stacks"
        ),
        pytest.param(False, 0, False, False, False, False, False, id="no-stacks"),
        pytest.param(False, 1, True, False, False, False, False, id="version-match"),
        pytest.param(
            False, 1, False, False, True, False, False, id="drift-detection-failed"
        ),
        pytest.param(
            False, 1, False, False, False, True, False, id="update-cfn-failed"
        ),
        pytest.param(
            False, 1, False, False, False, False, True, id="invalid-cfn-status"
        ),
        pytest.param(
            False, 1, False, True, False, False, False, id="parameters-up-to-date"
        ),
    ],
)
def test_update_managed_cloud(
    ...
    with patch.multiple(
        ...
        is_cross_account_iam_role_drifted=Mock(return_value=has_drift),
        ...
        if version_match or parameter_is_up_to_date:
            ...
            return
        detect_drift_mock.assert_called_once_with(
            stack_name=mock_stack_name,
            region=mock_cloud.region,
            logger=cloud_controller.log,
        )
        if has_drift:
            mock_confirm.assert_called_once()
