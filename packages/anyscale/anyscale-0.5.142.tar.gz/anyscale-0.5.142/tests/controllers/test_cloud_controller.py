...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(True, 1, False, False, False, False, id="drifts"),
        pytest.param(False, 1, False, False, False, False, id="happy-path"),
        pytest.param(False, 2, False, False, False, False, id="unexpected-stacks"),
        pytest.param(False, 0, False, False, False, False, id="no-stacks"),
        pytest.param(False, 1, True, False, False, False, id="version-match"),
        pytest.param(False, 1, False, True, False, False, id="drift-detection-failed"),
        pytest.param(False, 1, False, False, True, False, id="update-cfn-failed"),
        pytest.param(False, 1, False, False, False, True, id="invalid-cfn-status"),
    ],
)
