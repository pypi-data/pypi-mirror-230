...
class AicaModel(object):
    ...
    openapi_types = {
        ...
        'default_configuration_json': 'object',
    ...
    attribute_map = {
        ...
        'default_configuration_json': 'default_configuration_json',
    ...
    def __init__(self, name=None, emoji=None, description=None, base_canonical_model_id=None, min_aviary_version=None, max_aviary_version=None, default_configuration_json=None, model_object_storage_uri=None, is_model_stored_in_anyscale_account=None, created_at=None, cloud_id=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._default_configuration_json = None
        ...
        self.default_configuration_json = default_configuration_json
    ...
    @property
    def default_configuration_json(self):
        """Gets the default_configuration_json of this AicaModel.  # noqa: E501


        :return: The default_configuration_json of this AicaModel.  # noqa: E501
        :rtype: object
        """
        return self._default_configuration_json

    @default_configuration_json.setter
    def default_configuration_json(self, default_configuration_json):
        """Sets the default_configuration_json of this AicaModel.


        :param default_configuration_json: The default_configuration_json of this AicaModel.  # noqa: E501
        :type: object
        """
        if self.local_vars_configuration.client_side_validation and default_configuration_json is None:  # noqa: E501
            raise ValueError("Invalid value for `default_configuration_json`, must not be `None`")  # noqa: E501

        self._default_configuration_json = default_configuration_json
