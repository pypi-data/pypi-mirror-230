...
class Word2Img:
    """
    This API allows you to transform text descriptions into corresponding image representations and is available at https://api.segmind.com/v1/w2imgsd1.5-img2img.

    The API accepts the following parameters:
        image: The link to the image to be used as the base image.
    ...
    def __init__(self, api_key=None):
        self.url = "https://api.segmind.com/v1/w2imgsd1.5-img2img"
