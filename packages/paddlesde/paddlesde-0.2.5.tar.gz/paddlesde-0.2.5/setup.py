...
with open(os.path.join(here, 'paddlesde', '__init__.py')) as f:
...
setuptools.setup(
    ...
    description="SDE solvers and stochastic adjoint sensitivity analysis in Paddle.",
    long_description=readme,
    long_description_content_type="text/markdown",
    url="https://github.com/junnyu/paddlesde",
