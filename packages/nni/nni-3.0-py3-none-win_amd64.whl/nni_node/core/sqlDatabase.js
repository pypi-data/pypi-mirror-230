...
class SqlDB {
    ...
    init(createNew, dbDir) {
        ...
        (0, assert_1.default)(fs_1.default.existsSync(dbDir));
    ...
    storeTrialJobEvent(event, trialJobId, timestamp, hyperParameter, jobDetail) {
        ...
        const envId = jobDetail?.envId;
        const args = [timestamp, trialJobId, event, hyperParameter, logPath, sequenceId, message, envId];
