...
class GpuScheduler {
    log = (0, log_1.getLogger)('GpuScheduler');
    ...
    scheduleMachine(environments, constraint, defaultRequiredGPUNum, trialDetail) {
        if (constraint.type == 'None' || constraint.type == 'GPUNumber') {
            ...
            (0, assert_1.default)(requiredGPUNum >= 0);
            ...
            (0, assert_1.default)(constraint.type === 'Device');
    ...
    scheduleGPUHost(environments, requiredGPUNumber, trial) {
        ...
        if (qualifiedEnvironments.length > 0) {
            ...
            if (gpuInfos !== undefined) {
                ...
                (0, assert_1.default)(false, 'gpuInfos is undefined');
            }
        }
        return undefined;
    }
    ...
    selectMachine(qualifiedEnvironments, allEnvironments) {
        (0, assert_1.default)(qualifiedEnvironments !== undefined && qualifiedEnvironments.length > 0);
        if (this.policyName === 'random') {
            return (0, utils_1.randomSelect)(qualifiedEnvironments);
        }
    ...
    allocateHost(requiredGPUNum, environment, gpuInfos, trialDetails) {
        (0, assert_1.default)(gpuInfos.length >= requiredGPUNum);
