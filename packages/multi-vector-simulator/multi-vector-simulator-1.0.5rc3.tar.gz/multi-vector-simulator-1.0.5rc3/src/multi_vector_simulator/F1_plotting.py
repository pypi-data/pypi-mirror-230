...
def plot_piecharts_of_costs(dict_values, file_path=None):
    ...
    for kp_indic in columns_list:
        ...
        df_temp = df_temp.loc[df_temp.label != "Total"]
        ...
        elif "upfront" in kp_indic:
            kpi_part = "Upfront Investment Costs ("
            file_name = "upfront_investment_costs"
            scheme_choosen = px.colors.diverging.BrBG
        elif "over_lifetime" in kp_indic:
            kpi_part = "Lifetime Investment Costs ("
            file_name = "lifetime_investment_costs"
            scheme_choosen = px.colors.diverging.Tropic
        elif "om" in kp_indic:
