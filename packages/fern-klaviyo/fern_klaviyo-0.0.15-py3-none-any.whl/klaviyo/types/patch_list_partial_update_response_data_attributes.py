...
class PatchListPartialUpdateResponseDataAttributes(pydantic.BaseModel):
    name: typing.Optional[str] = pydantic.Field(description="A helpful name to label the list")
