...
class PostCatalogCategoryDeleteJobResponseDataAttributes(pydantic.BaseModel):
    job_id: str = pydantic.Field(description="Unique identifier for retrieving the job. Generated by Klaviyo.")
    status: PostCatalogCategoryDeleteJobResponseDataAttributesStatus = pydantic.Field(
