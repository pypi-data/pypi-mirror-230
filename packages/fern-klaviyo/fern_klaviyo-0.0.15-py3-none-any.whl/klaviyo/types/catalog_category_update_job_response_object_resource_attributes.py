...
class CatalogCategoryUpdateJobResponseObjectResourceAttributes(pydantic.BaseModel):
    job_id: str = pydantic.Field(description="Unique identifier for retrieving the job. Generated by Klaviyo.")
    status: CatalogCategoryUpdateJobResponseObjectResourceAttributesStatus = pydantic.Field(
