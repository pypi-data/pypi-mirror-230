...
class CatalogVariantCreateQueryResourceObjectAttributes(pydantic.BaseModel):
    external_id: str = pydantic.Field(description="The ID of the catalog item variant in an external system.")
    ...
    title: str = pydantic.Field(description="The title of the catalog item variant.")
    description: str = pydantic.Field(description="A description of the catalog item variant.")
    sku: str = pydantic.Field(description="The SKU of the catalog item variant.")
    ...
    inventory_quantity: float = pydantic.Field(
    ...
    url: str = pydantic.Field(description="URL pointing to the location of the catalog item variant on your website.")
