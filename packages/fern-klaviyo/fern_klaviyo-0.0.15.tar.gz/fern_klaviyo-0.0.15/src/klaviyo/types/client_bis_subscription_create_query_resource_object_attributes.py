...
class ClientBisSubscriptionCreateQueryResourceObjectAttributes(pydantic.BaseModel):
    channels: typing.List[ClientBisSubscriptionCreateQueryResourceObjectAttributesChannelsItem] = pydantic.Field(
