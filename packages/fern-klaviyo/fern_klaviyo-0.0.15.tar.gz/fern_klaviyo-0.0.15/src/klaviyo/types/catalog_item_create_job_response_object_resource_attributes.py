...
class CatalogItemCreateJobResponseObjectResourceAttributes(pydantic.BaseModel):
    job_id: str = pydantic.Field(description="Unique identifier for retrieving the job. Generated by Klaviyo.")
    status: CatalogItemCreateJobResponseObjectResourceAttributesStatus = pydantic.Field(
