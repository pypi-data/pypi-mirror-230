...
class Collection:
    ...
    def __init__(
        ...
        self.vectorizer = vectorizer  # TODO: handle real time call to vectorizer
    ...
    def search(
        ...
        if natural_input:
            # TODO: handle call to embedding service
            raise ValueError("Assigning 'natural_input' is currently not implemented")
        ...
        return [
            ...
            for result in self._vector_serving_client.search(
                ...
                include_vector=include_vector,
                include_distance=include_distance,
                filters=None,  # TODO: implement filters
            )
        ]
    ...
    def upsert(
        ...
        if natural_inputs:
            ...
            raise NotImplementedError(
                "Assigning 'natural_inputs' is currently not implemented"
            )
