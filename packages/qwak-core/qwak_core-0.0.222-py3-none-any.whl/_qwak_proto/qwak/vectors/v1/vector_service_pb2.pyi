...
class GetVectorSampleRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["collection_name", b"collection_name", "include_id", b"include_id", "include_vector", b"include_vector", "num_samples", b"num_samples"]) -> None: ...
