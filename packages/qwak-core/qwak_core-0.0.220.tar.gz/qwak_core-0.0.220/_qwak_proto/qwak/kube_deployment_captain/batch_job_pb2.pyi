...
class ListInferenceJobFilesResponse(google.protobuf.message.Message):
    ...
    region: builtins.str
    """The Region of the requested bucket"""
    def __init__(
        self,
        *,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["failure_reason", b"failure_reason", "file_names", b"file_names", "region", b"region", "success", b"success"]) -> None: ...
