...
class Project:
    ...
    def _check_ct_creation_limit(self) -> None:
        """Check if the license limits permit creating another ContinuousTest.

        Raises:
            ValueError
                This error is raised when a ContinuousTest cannot be created as
        ...
        if limit_status == RimeLimitStatusStatus.WARN:
            ...
            # could be either within grace period or exceeded grace period
            # if the latter, let the create ContinuousTest call raise the
            # error
            print(
                "You have reached the limit of models monitored."
                " Contact the Robust Intelligence team to"
            ...
            raise ValueError(
                "Checking the continuous testing limit returned unexpected status"
                f" {limit_status}."
            )
