...
4. `FixedIncomePrmSingle`
    ...
    # setting the maturity of the financial asset to 7 years
    maturity = 7
    ...
    ```python
    model.DurationNormal(yield_curve = yield_curve,vol = "garch", interval = 25, p = 1, q = 1, alpha = 0.05)
    model.DurationNormal(yield_curve = yield_curve,vol = "ewma", interval = 25, lambda_ewma = 0.98, alpha = 0.05)
    ```
    ...
    ```python
    model.HistoricalSimulation(yield_curve = yield_curve,interval = 25, alpha = 0.05)
    ```
...
5. `FixedIncomePrmPort`
    ...
    # setting the number of bonds to 5
    number_of_bonds = 5
    ...
    ```python
    model.DurationNormal(yield_curve = yield_curve,vol = "simple", interval = 25, alpha = 0.05)
    model.DurationNormal(yield_curve = yield_curve,vol = "garch", interval = 25, p = 1, q = 1, alpha = 0.05)
    model.DurationNormal(yield_curve = yield_curve,vol = "ewma", interval = 25, lambda_ewma = 0.95, alpha = 0.05)
    ```
