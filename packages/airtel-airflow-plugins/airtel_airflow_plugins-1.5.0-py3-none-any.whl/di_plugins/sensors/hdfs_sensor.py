...
class HdfsSensor(BaseSensorOperator):
    """sensor for hdfs file system. This sensor checks for files/directory existence in hdfs.
    ...
    -fs   | --file_system  : A mandatory parameter to specify file system local or hdfs
    -ot   | --object_type  : An optional parameter to specify object type, file or directory


    by default this sensor check files in hdfs. To sense directory in hdfs then user can provide
    ...
    op_kwargs : this argument is template
        ...
        object_type -> optional parameter, type off object to sense in hdfs i.e. files or directories. default is files
    ...
    def poke(self, context):
        ...
        done_files, self.pending_files = sense_objects("hdfs", self.op_kwargs, self.pending_files)
