...
class DIShortCircuitOperator(IOperatorService):
    """
    wrapper airflow.operators.python.ShortCircuitOperator
    """
    ...
    def create_operator(self, operator_config: dict) -> ShortCircuitOperator:
        """
        this method creates ShortCircuitOperator as per given operator_config
        ...
        :return:
        """
        self.logger.debug("executing DIShortCircuitOperator.create_operator()")
        self._config = operator_config
        self.logger.debug("creating  Short Circuit Operator")
        ...
        try:
            ...
            self.logger.debug("exiting DIShortCircuitOperator.create_operator()")
            return ShortCircuitOperator(**operator_config)
        except Exception as ex:
            self.logger.error("error occurred while creating Short Circuit operator, error - %s", ex)
            raise ex
