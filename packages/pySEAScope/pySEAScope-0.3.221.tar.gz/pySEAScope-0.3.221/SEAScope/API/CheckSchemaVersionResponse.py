...
def CheckSchemaVersionResponseAddVersion(builder, version): builder.PrependUint32Slot(0, version, 20230912)
...
def CheckSchemaVersionResponseAddPythonVersionBuild(builder, pythonVersionBuild): builder.PrependUint32Slot(3, pythonVersionBuild, 221)
