...
class Api:
    ...
    # TODO: This should really return a TronContract object, not the raw dict.
    def get_contract(self, address: str) -> Optional[Dict[str, Any]]:
        ...
        params = {VALUE: coerce_to_hex(address)}  # TODO: if we requested with 'visible' we would get base58 addresses back...
