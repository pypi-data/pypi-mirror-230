...
~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    **Example 2**
    ...
    bridge site:
        ...
        ...               surface=TiO2_101, composition='TiTi')
        >>> view(atoms) 
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    **Example 3**
    ...
    setting both_sides=True. Below is an example for generating a 
    symmetric 4-layer Pt fcc111 surface slab with O adsorbed at all
    fcc sites:
        ...
        >>> from ase.visualize import view
        >>> atoms = fcc111('Pt', (4, 4, 4), vacuum=5.)
        >>> sas = SlabAdsorptionSites(atoms, surface='fcc111', both_sides=True)
        >>> fcc_sites = sas.get_sites(site='fcc')
        >>> for site in fcc_sites:
        ...     add_adsorbate_to_site(atoms, adsorbate='O', site=site)
        >>> view(atoms)
