...
class ClusterAdsorbateCoverage(object):
    ...
    **'label'**: the updated label with the name of the occupying adsorbate
    ...
    def get_sites(self, occupied=None):
        ...
        if occupied is True:
            ...
            all_sites = [s for s in all_sites if not s['occupied']]
...
class SlabAdsorbateCoverage(object):
    ...
    **'label'**: the updated label with the name of the occupying adsorbate
    ...
    to get all unoccupied adsorption sites on an anatase TiO2(101) surface
    which is not directly implemented in ACAT:
    ...
    .. code-block:: python
        ...
        >>> TiO2_101_atoms = surface(TiO2, (1, 0, 1), 4, vacuum=5)
        >>> TiO2_101 = CustomSurface(TiO2_101_atoms, n_layers=4)
        >>> # Suppose we have a surface structure resulting from some
        >>> # perturbation of the reference TiO2(101) surface structure
        >>> atoms = TiO2_101_atoms.copy()
        >>> atoms.rattle(stdev=0.2)
        >>> sac = SlabAdsorbateCoverage(atoms, surface=TiO2_101)
        >>> unoccupied_sites = sac.get_sites(occupied=False)
        >>> print(unoccupied_sites) 

    Output:

    .. code-block:: python

        [{'site': '3fold', 'surface': <acat.settings.CustomSurface object at 0x7f3a19510c40>, 
         ...
         {'site': 'bridge', 'surface': <acat.settings.CustomSurface object at 0x7f3a19510c40>, 
          ...
          'adsorbate_indices': None, 'occupied': 0, 'dentate': 0, 'fragment_indices': None}, 
         {'site': 'bridge', 'surface': <acat.settings.CustomSurface object at 0x7f3a19510c40>, 
          'morphology': 'sc-tc', 'position': array([ 3.24293684,  0.98821014, 15.99332154]), 
          'normal': array([0.3520727 , 0.        , 0.92537315]), 'indices': (36, 38), 
          'composition': None, 'subsurf_index': None, 'subsurf_element': None, 'label': 0, 
          'bonding_index': None, 'bond_length': None, 'adsorbate': None, 'fragment': None, 
          'adsorbate_indices': None, 'occupied': 0, 'dentate': 0, 'fragment_indices': None}, 
         {'site': '3fold', 'surface': <acat.settings.CustomSurface object at 0x7f3a19510c40>, 
          'morphology': 'sc-tc', 'position': array([ 2.85900148,  0.03524325, 16.20530578]), 
          'normal': array([ 0.48335322, -0.        ,  0.87542542]), 'indices': (36, 38, 38), 
          'composition': None, 'subsurf_index': None, 'subsurf_element': None, 'label': 0, 
          'bonding_index': None, 'bond_length': None, 'adsorbate': None, 'fragment': None, 
          'adsorbate_indices': None, 'occupied': 0, 'dentate': 0, 'fragment_indices': None}, 
         {'site': 'ontop', 'surface': <acat.settings.CustomSurface object at 0x7f3a19510c40>, 
          'morphology': 'terrace', 'position': array([ 9.48906214,  1.94304604, 16.23377146]), 
          'normal': array([0.22079218, 0.        , 0.97532088]), 'indices': (37,), 
          'composition': None, 'subsurf_index': None, 'subsurf_element': None, 'label': 0, 
          'bonding_index': None, 'bond_length': None, 'adsorbate': None, 'fragment': None, 
          'adsorbate_indices': None, 'occupied': 0, 'dentate': 0, 'fragment_indices': None}, 
         {'site': 'bridge', 'surface': <acat.settings.CustomSurface object at 0x7f3a19510c40>, 
          'morphology': 'terrace', 'position': array([9.48906214, 0.01204604, 16.23377150]), 
          'normal': array([0.22079218, 0.        , 0.97532088]), 'indices': (37, 37), 
          'composition': None, 'subsurf_index': None, 'subsurf_element': None, 'label': 0, 
          'bonding_index': None, 'bond_length': None, 'adsorbate': None, 'fragment': None, 
          'adsorbate_indices': None, 'occupied': 0, 'dentate': 0, 'fragment_indices': None}, 
         {'site': 'bridge', 'surface': <acat.settings.CustomSurface object at 0x7f3a19510c40>, 
          'morphology': 'sc-tc', 'position': array([ 8.26803075,  1.0858053 , 16.51018735]), 
          'normal': array([0.3520727 , 0.        , 0.92537315]), 'indices': (37, 39), 
          'composition': None, 'subsurf_index': None, 'subsurf_element': None, 'label': 0, 
          'bonding_index': None, 'bond_length': None, 'adsorbate': None, 'fragment': None, 
          'adsorbate_indices': None, 'occupied': 0, 'dentate': 0, 'fragment_indices': None}, 
         {'site': 'bridge', 'surface': <acat.settings.CustomSurface object at 0x7f3a19510c40>, 
          'morphology': 'sc-tc', 'position': array([ 8.26803075,  3.0168053 , 16.51018735]), 
          'normal': array([0.3520727 , 0.        , 0.92537315]), 'indices': (37, 39), 
          'composition': None, 'subsurf_index': None, 'subsurf_element': None, 'label': 0, 
          'bonding_index': None, 'bond_length': None, 'adsorbate': None, 'fragment': None, 
          'adsorbate_indices': None, 'occupied': 0, 'dentate': 0, 'fragment_indices': None}, 
         {'site': '3fold', 'surface': <acat.settings.CustomSurface object at 0x7f3a19510c40>, 
          'morphology': 'sc-tc', 'position': array([ 7.86102028,  2.08739172, 16.60232598]), 
          'normal': array([ 0.22079218, -0.        ,  0.97532088]), 'indices': (37, 39, 39), 
          'composition': None, 'subsurf_index': None, 'subsurf_element': None, 'label': 0, 
          'bonding_index': None, 'bond_length': None, 'adsorbate': None, 'fragment': None, 
          'adsorbate_indices': None, 'occupied': 0, 'dentate': 0, 'fragment_indices': None}]
