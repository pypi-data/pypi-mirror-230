    ...
    def sync(self):
        ...
        for device in self._home_db['devices']:
            for service in device['services']:
                ...
                did, sid, reachable, zone = device['did'], service["sid"], device['reachable'], self._find_zone(device['zid'])
                ...
                if entity:
                    ...
                    device = Device(
                        did, device['mac'], device['name'], zone)
                    args = (self, device, sid, self._ver,
                            service['attributes'], reachable)
