...
def read_xml(filename: Optional[Union[str, Path]] = None, text: Optional[str] = None, convert_types=True, normalize_none=False) -> EasyfattXML:
    ...
    return EasyfattXML.from_xml_string(bytes(xml_string, encoding='utf-8'), convert_types=convert_types, normalize_none=normalize_none)
