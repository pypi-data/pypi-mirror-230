...
subscription is the primary calendar for the user in Google."""),
    ...
    'lino_xl.lib.google.CalendarSubscription.sync_token' : _("""Token given by Google to sync later Event entries on the subscribed calendar."""),
...
synchronization."""),
    ...
    'lino_xl.lib.google.ContactSyncToken.sync_token' : _("""The nextSyncToken from google."""),
    'lino_xl.lib.google.ContactSyncToken.page_token' : _("""The nextPageToken from google."""),
