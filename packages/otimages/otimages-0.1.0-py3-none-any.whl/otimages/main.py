...
option_chart = Annotated[
    HelmChart, typer.Option("--chart", "-c", case_sensitive=False, prompt=False)
]
option_langpacks = Annotated[bool, typer.Option("--langpacks")]
option_latest = Annotated[bool, typer.Option("--latest")]
