...
summary_rag = RAGTask(client=client, task_prompt_builder=plaintext_summary_builder)
glossary_rag = RAGTask(client=client, task_prompt_builder=get_glossary_builder)
