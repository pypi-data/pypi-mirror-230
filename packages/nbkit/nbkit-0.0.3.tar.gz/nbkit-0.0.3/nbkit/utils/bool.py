# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/utils/07_bool.ipynb.

# %% auto 0
__all__ = ['is_kwcell', 'is_kwpath', 'is_kwidx', 'is_code_cell', 'has_cells', 'is_nbdev', 'has__', 'is_ipy']

# %% ../../nbs/utils/07_bool.ipynb 4
import os, re, pathlib
from nbformat import NotebookNode
from pstr.cons import EXT_IPYNB

# %% ../../nbs/utils/07_bool.ipynb 5
from .cons import (CODE, CELLS,)
from .pttn import NBDEV_ND

# %% ../../nbs/utils/07_bool.ipynb 8
