...
class NotebookPrefixer:
    ...
    Methods
    -------
    next(prefix_dir: str, prefix_nb: Optional[str] = None, maximum: bool = False, pad: int = 2) -> int:
        Class method. Get the next available notebook number in a given directory.
        
    __call__(prefix_dir: Optional[str] = None, prefix_nb: Optional[str] = None, maximum: bool = False, pad: int = 2) -> int:
    ...
    prefix_nb: Optional[str] = field(default=None, repr=False, metadata={'help': (
    ...
    @classmethod
    def next(prefix_dir: str, prefix_nb: Optional[str] = None, maximum: bool = False, pad: int = 2) -> int:
    ...
    def __call__(
        self, 
        prefix_dir: Optional[str] = None, prefix_nb: Optional[str] = None, 
