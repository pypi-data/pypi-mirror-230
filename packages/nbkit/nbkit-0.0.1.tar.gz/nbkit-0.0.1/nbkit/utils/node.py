# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/utils/10_node.ipynb.
...
# %% ../../nbs/utils/10_node.ipynb 8
def nb_add_tail(nb: NotebookNode) -> NotebookNode:
    '''Add a tail cell to a notebook i.e. `nbdev.nbdev_export()`
