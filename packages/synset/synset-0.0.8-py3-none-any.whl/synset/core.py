...
from ispec.types import isiter, isset
...
class synset(nymstr):    
    ...
    *synonyms : Iterable[str]
    ...
    aspec = ('icase', 'ispace', 'iunder', 'cutoff', 'itemattr', 'fullrepr', 'fuzzsyns', )
    ...
    def issyns(self, other: str) -> bool:
        ...
        sset = getattr(self,  'synset', None)
        oset = getattr(other, 'synset', None)
        return sset == oset
