...
def process_event(event_id: int) -> None:
    ...
    if event.type == "create":
        ...
        # if event.data.get('headquarters'):
        #     company.meta['headquarters'] = event.data['headquarters']
        # if event.data.get('designation'):
        #     company.meta['designation'] = event.data['designation']
