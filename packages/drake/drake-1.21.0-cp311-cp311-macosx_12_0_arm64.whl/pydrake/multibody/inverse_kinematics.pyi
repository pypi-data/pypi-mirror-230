...
class MinimumDistanceConstraint(pydrake.solvers.Constraint):
    ...
    @overload
    def __init__(self, plant: pydrake.multibody.plant.MultibodyPlant_𝓣AutoDiffXd𝓤, minimum_distance_lower: float, minimum_distance_upper: float, plant_context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤, penalty_function: Callable[[float,bool],tuple], influence_distance: float) -> None: ...
