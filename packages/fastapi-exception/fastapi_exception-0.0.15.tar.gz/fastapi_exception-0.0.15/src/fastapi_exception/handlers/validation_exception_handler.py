...
from fastapi_exception.base_translator_service import BastTranslatorService
...
def translate_errors(errors: list[Any]):
    translator_service: BastTranslatorService = GlobalVariable.get('translator_service')
    ...
    for error in errors:
        ...
        error['msg'] = translator_service.translate(f'validation.{error_type}', **constraints)
