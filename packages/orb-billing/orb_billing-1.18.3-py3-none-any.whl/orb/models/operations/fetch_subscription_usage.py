...
from ..shared import granularity as shared_granularity
...
class FetchSubscriptionUsageRequest:
    ...
    granularity: Optional[shared_granularity.Granularity] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'granularity', 'style': 'form', 'explode': True }})
