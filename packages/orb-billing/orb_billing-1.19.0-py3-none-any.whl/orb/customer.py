...
class Customer:
    ...
    def amend(self, request_body: operations.AmendUsageRequestBody, customer_id: str, timeframe_end: datetime, timeframe_start: datetime) -> operations.AmendUsageResponse:
        r"""Amend usage
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.RequestValidationError])
                res.request_validation_error = out
            else:
                raise errors.SDKError(f'unknown content-type received: {content_type}', http_res.status_code, http_res.text, http_res)
    ...
    def amend_by_external_id(self, request_body: operations.AmendUsageExternalCustomerIDRequestBody, external_customer_id: str, timeframe_end: datetime, timeframe_start: datetime) -> operations.AmendUsageExternalCustomerIDResponse:
    ...
    def create_balance_transaction(self, customer_id: str, new_transaction: Optional[shared.NewTransaction] = None) -> operations.CreateCustomerBalanceTransactionResponse:
    ...
    def fetch_transactions(self, customer_id: str, cursor: Optional[int] = None, limit: Optional[int] = None) -> operations.ListBalanceTransactionsResponse:
    ...
    def list(self, cursor: Optional[int] = None, limit: Optional[int] = None) -> operations.ListCustomersResponse:
        r"""List customers
