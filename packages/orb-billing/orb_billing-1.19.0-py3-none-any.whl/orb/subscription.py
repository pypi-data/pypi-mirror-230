...
class Subscription:
    ...
    def fetch_schedule(self, subscription_id: str, cursor: Optional[int] = None, limit: Optional[int] = None) -> operations.FetchSubscriptionScheduleResponse:
    ...
    def list(self, cursor: Optional[int] = None, customer_id: Optional[str] = None, external_customer_id: Optional[str] = None, limit: Optional[int] = None) -> operations.ListSubscriptionsResponse:
