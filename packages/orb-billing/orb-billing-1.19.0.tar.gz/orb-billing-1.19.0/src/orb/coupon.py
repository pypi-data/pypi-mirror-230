...
class Coupon:
    ...
    def list(self, cursor: Optional[int] = None, limit: Optional[int] = None, redemption_code: Optional[str] = None, show_archived: Optional[bool] = None) -> operations.ListCouponsResponse:
        r"""List coupons
