...
class Event:
    ...
    def ingest(self, request_body: operations.IngestRequestBody, backfill_id: Optional[str] = None, debug: Optional[bool] = None) -> operations.IngestResponse:
        r"""Ingest events
    ...
    def list_backfills(self, cursor: Optional[int] = None, limit: Optional[int] = None) -> operations.ListBackfillsResponse:
        r"""List backfills
    ...
    def search(self, event_search_criteria: Optional[shared.EventSearchCriteria] = None, cursor: Optional[int] = None, limit: Optional[int] = None) -> operations.SearchEventsResponse:
        r"""Search events
        ...
        request = operations.SearchEventsRequest(
            event_search_criteria=event_search_criteria,
            cursor=cursor,
            limit=limit,
        )
