...
class Credit:
    ...
    def fetch(self, customer_id: str, cursor: Optional[int] = None, limit: Optional[int] = None) -> operations.FetchCustomerCreditsResponse:
    ...
    def fetch_by_external_id(self, external_customer_id: str, cursor: Optional[int] = None, limit: Optional[int] = None) -> operations.FetchCustomerCreditsExternalIDResponse:
