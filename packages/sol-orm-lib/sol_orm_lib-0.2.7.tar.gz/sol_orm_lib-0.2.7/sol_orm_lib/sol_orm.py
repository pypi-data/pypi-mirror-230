...
class SolORM:
    ...
    add_paths = {
        ...
        OutputPVForecastedTACs.__name__: "OutputPVForecastedTACs/add",
    ...
    update_paths = {
        ...
        OutputPVForecastedTIC.__name__: "OutputPVForecastedTICs/update",
        StorageStatusTAC.__name__: "StorageStatusTACs/update",
        OutputPVMeasuredTAC.__name__: "OutputPVMeasuredTACs/update",
        NuTIC.__name__: "NuTICs/update",
        OutputPVForecastedTACs.__name__: "OutputPVForecastedTACs/update",
        ProgramOptUpTIC.__name__: "ProgramOptUpTICs/update",
        ProgramOptMidTIC.__name__: "ProgramOptMidTICs/update",
    ...
    get_paths = {
        ...
        OutputPVForecastedTACs.__name__: "OutputPVForecastedTACs",
    ...
    get_last_kn_paths = {
        ...
        OutputPVForecastedTACs.__name__: "OutputPVForecastedTACs/getLastKN",
    ...
    get_since_kn_paths = {
        ...
        OutputPVForecastedTACs.__name__: "OutputPVForecastedTACs/getSinceKN",
