...
from aliyun_sls_logger.util import logger, cal_md5, canonicalized_log_headers, canonicalized_resource, hmac_sha1
...
class AuthV1(AuthBase):
    ...
    def sign_request(self, method, resource, params, headers, body):
        ...
        if body:
            headers['Content-MD5'] = cal_md5(body)
        ...
        content += canonicalized_log_headers(headers)
        content += canonicalized_resource(resource, params)
        signature = hmac_sha1(content, self.access_key_secret)
