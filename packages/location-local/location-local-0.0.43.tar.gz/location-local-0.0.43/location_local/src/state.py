...
class State(GenericCRUD):
    ...
    def insert_state(
            ...
            state: str, lang_code: LanguageCode = 'en', state_name_approved: bool = False):
        logger.start(object={'coordinate': coordinate, 'state': state, 'lang_code': lang_code, 'state_name_approved': state_name_approved})
