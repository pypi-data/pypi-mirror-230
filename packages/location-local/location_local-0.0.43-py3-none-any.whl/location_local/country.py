...
class Country(GenericCRUD):
    ...
    def insert_country(self, coordinate: Dict[str, float],
        ...
        logger.start(object={'coordinate': coordinate, 'country': country, 'lang_code': lang_code, 'title_approved': title_approved, 'new_country_data': new_country_data})
        try:
    ...
    def get_country_id(self, name):
        ...
        country_id = self.cursor.fetchall()
