...
class LocationLocal(GenericCRUD):
    ...
    def insert(self, data: Dict[str, any], lang_code: LanguageCode = "en", is_approved: bool = True, new_country_data: Dict[str, any] = None):
        ...
        (neighborhood_id, county_id, region_id, state_id, country_id) = self._check_details_and_insert_if_not_exist(
            data["coordinate"], (data["neighborhood"], data["county"], data["region"], data["state"], data["country"]), lang_code, new_country_data)
    ...
    def update(self, location_id: int, data: Dict[str, any], lang_code: LanguageCode = "en", is_approved: bool = True):
    ...
    def _check_details_and_insert_if_not_exist(
            ...
            lang_code: LanguageCode = 'en', new_country_data: Dict[str, any] = None) -> tuple(
            [int, int, int, int, int]):
