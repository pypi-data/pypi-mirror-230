...
class Connection:
    ...
    def extract(self, project_id, image_id, type='index', key=fetch, tools=None, configuration=None, query=None,
        ...
        :param pre_cleaning: whether to pre-clean extracted traces,
            use `None` to use the default setting used by Hansken
        ...
        extraction = omit_empty({
            ...
            'disablePreCleaning': not pre_cleaning if pre_cleaning is not None else None,
        })
