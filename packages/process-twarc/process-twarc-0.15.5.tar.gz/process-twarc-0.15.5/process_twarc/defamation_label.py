...
def defamation_label_sweep(
    ...
    def objective(trial):
        ...
        #Variable Params
        lr_scheduler_type = suggest_parameter("lr_scheduler_type")
        ...
        wandb.init(
            ...
            "model":{
                ...
                "attention_dropout_prob": DROPOUT_RATE,
        ...
        optimizer = AdamW(
            ...
            lr=learning_rate,
            betas = (fixed_params["adam_beta1"], fixed_params["adam_beta2"]),
            eps=fixed_params["adam_epsilon"],
        ...
        if lr_scheduler_type == "constant":
            ...
            scheduler = get_constant_schedule(
                ...
                scheduler = get_linear_schedule_with_warmup(
                    optimizer=optimizer,
                    num_warmup_steps=0,
                    num_training_steps=len(train_dataset) // fixed_params["per_device_eval_batch_size"] * num_train_epochs
                )
