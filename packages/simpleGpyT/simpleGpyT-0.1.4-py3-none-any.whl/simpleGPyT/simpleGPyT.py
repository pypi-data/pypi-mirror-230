...
class Conversation:
    ...
    temperature: float
        The randomness of responses, with lower numbers being more direct and higher numbers being more random, defaults to 1
    max_tokens: int
    ...
    def say(self, message: str) -> str:
        ...
        name_settings = [
            {"role": "system", "content": f"Your name is {self.__assistant}"},
            {"role": "system","content": f"The user's name is {self.__user}, but only refer to them by name if asked to"}
            ]
