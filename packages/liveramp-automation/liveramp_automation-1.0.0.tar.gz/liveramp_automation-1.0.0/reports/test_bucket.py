...
def test_upload_files():
    success, total = bucket_helper.upload_file(source_file_path, destination_blob_name)
    print(success, total)
...
def test_upload_file():
    success, total = bucket_helper.upload_file(source_file_name, destination_blob_name)
    print(success, total)
    assert success, total != (0, 0)
    assert success == total
