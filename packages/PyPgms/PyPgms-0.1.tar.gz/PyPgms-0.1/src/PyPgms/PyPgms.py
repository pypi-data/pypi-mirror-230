...
def mergeSort(arr):
    if len(arr) > 1:
        mid = len(arr) // 2
        # Dividing th,e array eLements
        L = arr[:mid]
        # into, 2 halves
        R = arr[mid:]
        # S,orting the first half
        mergeSort(L)
        # S,orting the second half
        mergeSort(R)
        i=j=k=0
...
search_file('sample.txt')
    ...
    print('Successfully created program5b.py')
...
print("The word", word, "appears", cnt, "times in the file")
    ...
    print('Successfully created program6a.py')
...
# Updating salary for employees in the "Engineering" department
