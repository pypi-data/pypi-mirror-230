...
from ul_db_utils.conf import APPLICATION__DB_SCHEMA, APPLICATION__DB_USER, APPLICATION__DB_PASSWORD, \
    APPLICATION__DB_ADDRESS, APPLICATION__DB_PORT, APPLICATION__DB_DATABASE
...
class DbConfig:
    ...
    def __init__(
        ...
        *,
        models_path: str,
        uri: Optional[str] = f'{APPLICATION__DB_SCHEMA}://{APPLICATION__DB_USER}:{APPLICATION__DB_PASSWORD}@{APPLICATION__DB_ADDRESS}:{APPLICATION__DB_PORT}/{APPLICATION__DB_DATABASE}',
