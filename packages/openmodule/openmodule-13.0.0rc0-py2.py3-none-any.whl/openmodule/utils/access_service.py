...
def _find_lpr_accesses_ed0(medium: LPRMedium, accesses: List[LPRKnownAccess], matching_config: MatchingConfig) -> List[
    LPRKnownAccess]:
    session_plate_db = {}
...
def find_lpr_accesses(medium: LPRMedium, accesses: List[LPRKnownAccess], matching_config: MatchingConfig) -> List[
    LPRKnownAccess]:
