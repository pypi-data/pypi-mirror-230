...
from .types.create_deployment_request import CreateDeploymentRequest
...
class MarimoV1Client:
    ...
    def create_deployment_with_file(
    ...
    def create_deployment(self, *, request: CreateDeploymentRequest) -> Deployment:
        _response = httpx.request(
            "POST",
            urllib.parse.urljoin(f"{self._environment}/", "api/v1/deployments"),
            json=jsonable_encoder(request),
...
class AsyncMarimoV1Client:
    ...
    async def create_deployment_with_file(
        self, *, application_id: ApplicationId, code: str, requirements_txt: str, file: typing.IO
    ) -> Deployment:
        async with httpx.AsyncClient() as _client:
            _response = await _client.request(
    ...
    async def create_deployment(self, *, request: CreateDeploymentRequest) -> Deployment:
        async with httpx.AsyncClient() as _client:
            _response = await _client.request(
                "POST",
                urllib.parse.urljoin(f"{self._environment}/", "api/v1/deployments"),
