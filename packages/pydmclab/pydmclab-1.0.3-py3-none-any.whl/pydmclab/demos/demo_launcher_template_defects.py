...
def main():
    ...
    nelect321_vasp_configs = VASP_CONFIGS.copy()
    nelect321_vasp_configs["modify_loose_incar"] = {'NELECT' : 321,
                                                    'ISIF' : 2}
    nelect321_launch_dirs = {k : launch_dirs[k] if k in keys_w_nelect321}
    submit_calcs(launch_dirs=nelect321_launch_dirs,
                 nelect321_vasp_configs)
    
    nelect333_vasp_configs = VASP_CONFIGS.copy()
    nelect
    
    user_configs['relax_incar'] = {'NELECT' : 321,
                                   'ISIF' : 2}
    user_sub_configs.update(user_configs)
