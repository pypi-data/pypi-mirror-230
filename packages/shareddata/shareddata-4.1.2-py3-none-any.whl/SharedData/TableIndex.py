...
class TableIndex:
    ...
    def malloc_symbolidx(self, shm_name):
        ...
        self.symbollastidx = np.ndarray((hashtblsize,), dtype=np.int32, buffer=self.symbolidxshm.buf)
    ...
    def malloc_portfolioidx(self, shm_name):
        ...
        self.portlastidx = np.ndarray((hashtblsize,), dtype=np.int32, buffer=self.portidxshm.buf)
