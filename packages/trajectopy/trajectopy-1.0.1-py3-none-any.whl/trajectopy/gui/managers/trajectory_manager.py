...
class TrajectoryManager(QObject):
    ...
    def __init__(self) -> None:
        ...
        self.REQUEST_MAPPING: dict[TrajectoryManagerRequestType, Any] = {
            ...
            TrajectoryManagerRequestType.COMPARE_ABS: lambda: self.handle_trajectory_operation(
                operation=self.operation_compare_abs, inplace=False, apply_to_reference=False
            ),
            TrajectoryManagerRequestType.COMPARE_REL: lambda: self.handle_trajectory_operation(
                operation=self.operation_compare_rel, inplace=False, apply_to_reference=False
            ),
    ...
    def handle_trajectory_operation(
        ...
        for selected_entry in selected_entries:
            entry_pair = TrajectoryEntryPair(
                entry=selected_entry, reference_entry=self.reference_entry, request=self.request
            )
    ...
    @staticmethod
    def operation_switch_sorting(entry_pair: TrajectoryEntryPair) -> tuple[TrajectoryEntry]:
        """
    ...
    @staticmethod
    def operation_interpolate(entry_pair: TrajectoryEntryPair) -> tuple[TrajectoryEntry]:
        """
    ...
    @staticmethod
    def operation_interpolate_to_grid(entry_pair: TrajectoryEntryPair) -> tuple[TrajectoryEntry]:
        """
    ...
    @staticmethod
    def operation_adapt_ref_sampling(entry_pair: TrajectoryEntryPair) -> tuple[TrajectoryEntry]:
    ...
    @staticmethod
    def operation_match_timestamps(entry_pair: TrajectoryEntryPair) -> tuple[TrajectoryEntry, ...]:
        """
    ...
    @staticmethod
    def operation_approximate(entry_pair: TrajectoryEntryPair) -> tuple[TrajectoryEntry]:
        """
    ...
    def operation_compare_abs(entry_pair: TrajectoryEntryPair) -> tuple[ResultEntry]:
        ...
        comparison_result = compare_trajectories_absolute(
            traj_test=traj_test, traj_ref=traj_ref, settings=entry_pair.entry.settings.comparison
        )
    ...
    @staticmethod
    def operation_epsg_change(entry_pair: TrajectoryEntryPair) -> tuple[TrajectoryEntry]:
        """
    ...
    @staticmethod
    def operation_align(entry_pair: TrajectoryEntryPair) -> tuple[TrajectoryEntry, AlignmentEntry]:
        """
    ...
    @staticmethod
    def operation_apply_alignment(entry_pair: TrajectoryEntryPair) -> tuple[TrajectoryEntry]:
        """
    ...
    @staticmethod
    def operation_adopt_first_pose(entry_pair: TrajectoryEntryPair) -> tuple[TrajectoryEntry, ...]:
        """
    ...
    @staticmethod
    def operation_adopt_first_position(entry_pair: TrajectoryEntryPair) -> tuple[TrajectoryEntry]:
        """
    ...
    @staticmethod
    def operation_adopt_first_orientation(entry_pair: TrajectoryEntryPair) -> tuple[TrajectoryEntry]:
        """
    ...
    @staticmethod
    def operation_adopt_orientations(entry_pair: TrajectoryEntryPair) -> tuple[TrajectoryEntry]:
        """
    ...
    @staticmethod
    def operation_match_timestamps_roughly(entry_pair: TrajectoryEntryPair) -> tuple[TrajectoryEntry]:
        """
