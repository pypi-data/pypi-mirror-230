...
class SessionManager(QObject):
    ...
    def import_session(self, request: SessionManagerRequest) -> None:
        ...
        self.plot_settings_request.emit(
            PlotSettingsRequest(type=PlotSettingsRequestType.IMPORT_FROM_SESSION, file_path=request.file_path)
        )
    ...
    def export_session(self, request: SessionManagerRequest) -> None:
        ...
        self.plot_settings_request.emit(
            PlotSettingsRequest(type=PlotSettingsRequestType.EXPORT_TO_SESSION, file_path=request.file_path)
        )
