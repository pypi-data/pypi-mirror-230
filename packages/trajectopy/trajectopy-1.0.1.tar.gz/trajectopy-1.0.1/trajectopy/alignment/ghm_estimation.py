...
class Alignment:
    ...
    def variance_estimation(self, at_least_once: bool = False) -> None:
        ...
        while not global_test_result or at_least_once:
            logger.debug("Global test failed. Adjusting variance vector (%i/%i).", cnt, max_iterations)
