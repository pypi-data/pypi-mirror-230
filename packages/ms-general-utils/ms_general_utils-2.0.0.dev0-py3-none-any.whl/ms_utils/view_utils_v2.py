...
class ViewGeneralMethods:
    ...
    def get_list_without_pagination(self):
        ...
        :return: json
        """
        return generic_get_serialize_data(self.schema(many=True), self.get_queryset())
    ...
    def get_list_with_pagination(self, **kwargs):
        ...
        return generic_get_serialize_data(
            PaginationSchema(self.ma, current_app, self.schema(many=True)).pagination_sub_class, query)
