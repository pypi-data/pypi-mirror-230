...
class Story(Object, Update):
    ...
    @staticmethod
    async def _parse(
        client: "pyrogram.Client", stories: raw.base.StoryItem, user_id: int
    ) -> "Story":
        entities = [
    ...
    async def edit_animation(self, animation: Union[str, BinaryIO]) -> "types.Story":
        ...
        Raises:
            RPCError: In case of a Telegram RPC error.
        """
        return await self._client.edit_story(story_id=self.id, animation=animation)
    ...
    async def edit_photo(self, photo: Union[str, BinaryIO]) -> "types.Story":
        ...
        Raises:
            RPCError: In case of a Telegram RPC error.
        """
        return await self._client.edit_story(story_id=self.id, photo=photo)
    ...
    async def edit_video(self, video: Union[str, BinaryIO]) -> "types.Story":
        ...
        Raises:
            RPCError: In case of a Telegram RPC error.
        """
        return await self._client.edit_story(story_id=self.id, video=video)
    ...
    async def export_link(self) -> "types.ExportedStoryLink":
        ...
        return await self._client.export_story_link(
            user_id=self.from_user.id, story_id=self.id
        )
