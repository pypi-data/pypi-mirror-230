...
def data(train_set=[], train_labels=[], val_set=[], val_labels=[], test_set=[], test_labels=[], dataset_name="dataset", #checks if data is same as prev
  ...
  if sweep_global == True:
      dataset_folder = "SWP_"+str(run_id_global)+"_"+dataset_name
  else:
      dataset_folder = "Run_"+str(run_id_global)+"_"+dataset_name
...
def torch_data(train_dataloader=None, val_dataloader=None, test_dataloader=None, dataset_name="dataset", label_index=1,
...
def tensorflow_data(train_dataset=None, val_dataset=None, test_dataset=None, dataset_name="dataset", label_index=1,
         problem_type = 'binary classification',  node_name="Datasets", if_sweep_save_once = True, run_id = None):
  ...
  if save_new_data_flag == 1:
      ...
      if train_dataset:
        tf.data.Dataset.save(train_dataset, current_dir+'/data/'+dataset_folder +'/train_dataset.pkl')
        config_dict.update({'train_dataset': current_dir+'/data/'+dataset_folder +'/train_dataset.pkl'})

      if val_dataset:
        tf.data.Dataset.save(val_dataset, current_dir+'/data/'+dataset_folder +'/val_dataset.pkl')
        config_dict.update({'val_dataset': current_dir+'/data/'+dataset_folder +'/val_dataset.pkl'})

      if test_dataset:
        tf.data.Dataset.save(test_dataset, current_dir+'/data/'+dataset_folder +'/test_dataset.pkl')
