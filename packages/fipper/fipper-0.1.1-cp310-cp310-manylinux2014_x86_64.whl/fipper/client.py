...
class Client(Methods):
    ...
    APP_VERSION = f"Desktop {__version__} x64"
    DEVICE_MODEL = f"p2-1150l" #{platform.python_implementation()} {platform.python_version()}
    SYSTEM_VERSION = f"Windows 10" #{platform.system()} {platform.release()}
