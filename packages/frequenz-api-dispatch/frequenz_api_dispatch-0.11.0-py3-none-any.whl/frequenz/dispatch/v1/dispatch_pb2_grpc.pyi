...
import frequenz.dispatch.v1.dispatch_pb2
...
class MicrogridDispatchServiceStub:
    ...
    ListMicrogridDispatches: grpc.UnaryUnaryMultiCallable[
        frequenz.dispatch.v1.dispatch_pb2.DispatchListRequest,
        frequenz.dispatch.v1.dispatch_pb2.DispatchList,
    ]
    """Returns a list of all dispatches"""
    CreateMicrogridDispatch: grpc.UnaryUnaryMultiCallable[
        frequenz.dispatch.v1.dispatch_pb2.DispatchCreateRequest,
        google.protobuf.empty_pb2.Empty,
    ]
    """Create a new dispatch"""
    UpdateMicrogridDispatch: grpc.UnaryUnaryMultiCallable[
        frequenz.dispatch.v1.dispatch_pb2.DispatchUpdateRequest,
        google.protobuf.empty_pb2.Empty,
    ]
    """Update a dispatch"""
    GetMicrogridDispatch: grpc.UnaryUnaryMultiCallable[
        frequenz.dispatch.v1.dispatch_pb2.DispatchGetRequest,
        frequenz.dispatch.v1.dispatch_pb2.Dispatch,
    ]
    """Get a single dispatch"""
    DeleteMicrogridDispatch: grpc.UnaryUnaryMultiCallable[
        frequenz.dispatch.v1.dispatch_pb2.DispatchDeleteRequest,
        google.protobuf.empty_pb2.Empty,
    ]
...
class MicrogridDispatchServiceServicer(metaclass=abc.ABCMeta):
    ...
    def ListMicrogridDispatches(
        self,
        request: frequenz.dispatch.v1.dispatch_pb2.DispatchListRequest,
        context: _ServicerContext,
    ) -> typing.Union[frequenz.dispatch.v1.dispatch_pb2.DispatchList, collections.abc.Awaitable[frequenz.dispatch.v1.dispatch_pb2.DispatchList]]:
        """Returns a list of all dispatches"""
    @abc.abstractmethod
    def CreateMicrogridDispatch(
        self,
        request: frequenz.dispatch.v1.dispatch_pb2.DispatchCreateRequest,
        context: _ServicerContext,
    ...
    def UpdateMicrogridDispatch(
        self,
        request: frequenz.dispatch.v1.dispatch_pb2.DispatchUpdateRequest,
        context: _ServicerContext,
    ) -> typing.Union[google.protobuf.empty_pb2.Empty, collections.abc.Awaitable[google.protobuf.empty_pb2.Empty]]:
        """Update a dispatch"""
    @abc.abstractmethod
    def GetMicrogridDispatch(
        self,
        request: frequenz.dispatch.v1.dispatch_pb2.DispatchGetRequest,
        context: _ServicerContext,
    ) -> typing.Union[frequenz.dispatch.v1.dispatch_pb2.Dispatch, collections.abc.Awaitable[frequenz.dispatch.v1.dispatch_pb2.Dispatch]]:
        """Get a single dispatch"""
    @abc.abstractmethod
    def DeleteMicrogridDispatch(
        self,
        request: frequenz.dispatch.v1.dispatch_pb2.DispatchDeleteRequest,
        context: _ServicerContext,
    ) -> typing.Union[google.protobuf.empty_pb2.Empty, collections.abc.Awaitable[google.protobuf.empty_pb2.Empty]]:
        """Delete a given dispatch"""
