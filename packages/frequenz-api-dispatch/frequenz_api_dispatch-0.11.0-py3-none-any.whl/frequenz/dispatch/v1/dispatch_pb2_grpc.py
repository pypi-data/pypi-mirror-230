...
from frequenz.dispatch.v1 import dispatch_pb2 as frequenz_dot_dispatch_dot_v1_dot_dispatch__pb2
...
def add_MicrogridDispatchServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'frequenz.dispatch.v1.MicrogridDispatchService', rpc_method_handlers)
