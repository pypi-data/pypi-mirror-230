...
class Dispatch(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["create_time", b"create_time", "end_time", b"end_time", "payload", b"payload", "recurrence", b"recurrence", "selector", b"selector", "start_time", b"start_time", "update_time", b"update_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["create_time", b"create_time", "end_time", b"end_time", "id", b"id", "is_active", b"is_active", "is_dry_run", b"is_dry_run", "microgrid_id", b"microgrid_id", "payload", b"payload", "recurrence", b"recurrence", "selector", b"selector", "start_time", b"start_time", "type", b"type", "update_time", b"update_time"]) -> None: ...
...
class RecurrenceRule(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_count", b"_count", "count", b"count"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_count", b"_count", "byhours", b"byhours", "byminutes", b"byminutes", "bymonthdays", b"bymonthdays", "bymonths", b"bymonths", "byweekdays", b"byweekdays", "count", b"count", "freq", b"freq", "interval", b"interval"]) -> None: ...
...
class DispatchCreateRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["end_time", b"end_time", "payload", b"payload", "recurrence", b"recurrence", "selector", b"selector", "start_time", b"start_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["end_time", b"end_time", "is_active", b"is_active", "is_dry_run", b"is_dry_run", "microgrid_id", b"microgrid_id", "payload", b"payload", "recurrence", b"recurrence", "selector", b"selector", "start_time", b"start_time", "type", b"type"]) -> None: ...
...
class DispatchUpdateRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_is_active", b"_is_active", "_is_dry_run", b"_is_dry_run", "end_time", b"end_time", "is_active", b"is_active", "is_dry_run", b"is_dry_run", "payload", b"payload", "recurrence", b"recurrence", "selector", b"selector", "start_time", b"start_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_is_active", b"_is_active", "_is_dry_run", b"_is_dry_run", "end_time", b"end_time", "id", b"id", "is_active", b"is_active", "is_dry_run", b"is_dry_run", "payload", b"payload", "recurrence", b"recurrence", "selector", b"selector", "start_time", b"start_time"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_is_active", b"_is_active"]) -> typing_extensions.Literal["is_active"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_is_dry_run", b"_is_dry_run"]) -> typing_extensions.Literal["is_dry_run"] | None: ...
