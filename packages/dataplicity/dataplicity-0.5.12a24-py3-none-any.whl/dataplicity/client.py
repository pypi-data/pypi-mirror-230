...
class Client(object):
    ...
    def assign_device_class_from_file(self):
        log.info("Assigning device class from file.")
    ...
    def poll(self):
        ...
        #
        # time left is all the time we can spend
        # doing IDS analysis.
        #
        IDS_POLL_MARGIN = 3
        time_left = self.poll_rate_seconds - IDS_POLL_MARGIN
        while 0 < time_left and not self.exit_event.wait(0.1):
