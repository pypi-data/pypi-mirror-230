...
base_requirements = {
    ...
    f"cdpdev-datahub[airflow] == {package_metadata['__version__']}",
}
...
entry_points = {
    "airflow.plugins": "cdpdev-datahub-airflow-plugin = datahub_airflow_plugin.datahub_plugin:DatahubPlugin"
}
