...
MODEL_DIR = f'{TORCH_MODEL_HOME}/shufflenet/'
...
model_urls = {
    ...
    # 'shufflenetv2_x1.0': 'file:///mnt/pytorch/shufflenet/shufflenetv2_x1-5666bf0f80.pth',
...
def _shufflenetv2(arch, pretrained, progress, *args, **kwargs):
    ...
    if pretrained:
        ...
        if model_url is None:
            ...
            pre_state_dict = load_state_dict_from_url(model_url, model_dir=MODEL_DIR, map_location=lambda storage, loc: storage,
                progress=progress)
