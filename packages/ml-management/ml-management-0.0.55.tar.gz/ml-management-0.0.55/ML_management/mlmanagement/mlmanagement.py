...
def load_model(name: str, version: int, install_requirements: Optional[bool] = False, unwrap: Optional[bool] = True):
...
def load_dataset(name: str, version: int, install_requirements: Optional[bool] = False, unwrap: Optional[bool] = True):
    """Download all model's files for loading model locally."""
    if install_requirements:
...
def load_executor(name: str, version: int, install_requirements: Optional[bool] = False, unwrap: Optional[bool] = True):
    """Download all model's files for loading model locally."""
    if install_requirements:
