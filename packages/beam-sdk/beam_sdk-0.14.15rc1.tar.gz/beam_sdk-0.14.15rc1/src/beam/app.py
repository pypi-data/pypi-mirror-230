...
class FunctionTrigger:
    def __init__(
        ...
        task_policy: Optional[Union[TaskPolicy, dict]] = None,
        **kwargs,
    ):
...
class App:
    ...
    def task_queue(
        ...
        task_policy: Optional[Union[TaskPolicy, dict]] = TaskPolicy(),
    ):
        """
        ...
        Parameters:
            ...
            keep_warm_seconds (int):
                ...
                Default is 0.
            task_policy (Optional[Union[TaskPolicy, dict]]):
