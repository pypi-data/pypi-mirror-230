...
class XlsTextBoxShape (  XlsShape, ITextBoxLinkShape, TextBoxShapeBase) :
    ...
    def Text(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsTextBoxShape_get_Text(self.Ptr))
        return ret
    ...
    def TextFieldId(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsTextBoxShape_get_TextFieldId(self.Ptr))
        return ret
    ...
    def TextFieldType(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsTextBoxShape_get_TextFieldType(self.Ptr))
        return ret
    ...
    def InsetMode(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsTextBoxShape_get_InsetMode(self.Ptr))
        return ret
    ...
    def VertOverflow(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsTextBoxShape_get_VertOverflow(self.Ptr))
        return ret
    ...
    def HorzOverflow(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsTextBoxShape_get_HorzOverflow(self.Ptr))
        return ret
    ...
    def Anchor(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsTextBoxShape_get_Anchor(self.Ptr))
        return ret
    ...
    def Vert(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsTextBoxShape_get_Vert(self.Ptr))
        return ret
