...
class ConditionalFormatWrapper (  CommonWrapper, IOptimizedUpdate, IConditionalFormat, IExcelApplication) :
    ...
    def FirstFormula(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().ConditionalFormatWrapper_get_FirstFormula(self.Ptr))
        return ret
    ...
    def FirstFormulaR1C1(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().ConditionalFormatWrapper_get_FirstFormulaR1C1(self.Ptr))
        return ret
    ...
    def SecondFormulaR1C1(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().ConditionalFormatWrapper_get_SecondFormulaR1C1(self.Ptr))
        return ret
    ...
    def SecondFormula(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().ConditionalFormatWrapper_get_SecondFormula(self.Ptr))
        return ret
    ...
    def NumberFormat(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().ConditionalFormatWrapper_get_NumberFormat(self.Ptr))
        return ret
    ...
    def MakeFormula(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().ConditionalFormatWrapper_MakeFormula(self.Ptr))
        return ret
    ...
    def MakeFormula(self ,para:str)->str:
        ...
        ret = PtrToStr(GetDllLibXls().ConditionalFormatWrapper_MakeFormulaP(self.Ptr, para))
        return ret
