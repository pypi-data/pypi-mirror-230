...
class AddtionalFormatWrapper (  CommonWrapper, IInternalAddtionalFormat, IExtendIndex, IStyle) :
    ...
    def Name(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().AddtionalFormatWrapper_get_Name(self.Ptr))
        return ret
...
#        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().AddtionalFormatWrapper_get_NumberFormat(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().AddtionalFormatWrapper_get_NumberFormatLocal(self.Ptr))
        return ret
