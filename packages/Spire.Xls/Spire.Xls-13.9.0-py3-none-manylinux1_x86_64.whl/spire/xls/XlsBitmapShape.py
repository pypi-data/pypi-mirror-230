...
class XlsBitmapShape (  XlsShape, IPictureShape) :
    ...
    def RefRange(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsBitmapShape_get_RefRange(self.Ptr))
        return ret
    ...
    def FileName(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsBitmapShape_get_FileName(self.Ptr))
        return ret
    ...
    def Macro(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsBitmapShape_get_Macro(self.Ptr))
        return ret
