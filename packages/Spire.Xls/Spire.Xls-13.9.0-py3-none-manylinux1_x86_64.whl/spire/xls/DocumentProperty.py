...
class DocumentProperty (  SpireObject, IDocumentProperty) :
    ...
    def InternalName(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().DocumentProperty_get_InternalName(self.Ptr))
        return ret
    ...
    def Name(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().DocumentProperty_get_Name(self.Ptr))
        return ret
...
#        GetDllLibXls().DocumentProperty_set_Blob(self.Ptr, vArray, vCount)
    ...
    def Text(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().DocumentProperty_get_Text(self.Ptr))
        return ret
    ...
    def LinkSource(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().DocumentProperty_get_LinkSource(self.Ptr))
        return ret
