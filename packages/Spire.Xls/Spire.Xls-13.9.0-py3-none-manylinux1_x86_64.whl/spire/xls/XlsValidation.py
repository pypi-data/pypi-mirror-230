...
class XlsValidation (  IDataValidation, IExcelApplication, IOptimizedUpdate, ICloneParent) :
    ...
    def InputTitle(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsValidation_get_InputTitle(self.Ptr))
        return ret
    ...
    def InputMessage(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsValidation_get_InputMessage(self.Ptr))
        return ret
    ...
    def ErrorTitle(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsValidation_get_ErrorTitle(self.Ptr))
        return ret
    ...
    def ErrorMessage(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsValidation_get_ErrorMessage(self.Ptr))
        return ret
    ...
    def Formula1(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsValidation_get_Formula1(self.Ptr))
        return ret
    ...
    def Formula2(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsValidation_get_Formula2(self.Ptr))
        return ret
