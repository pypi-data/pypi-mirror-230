...
class XlsChartSerie (  XlsObject, IChartSerie, INamedObject) :
    ...
    def Name(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsChartSerie_get_Name(self.Ptr))
        return ret
    ...
    def NameOrFormula(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsChartSerie_get_NameOrFormula(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsChartSerie_get_StartType(self.Ptr))
        return ret
