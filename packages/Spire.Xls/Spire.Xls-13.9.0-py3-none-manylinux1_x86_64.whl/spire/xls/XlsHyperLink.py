...
class XlsHyperLink (  XlsObject, IHyperLink, ICloneParent) :
    ...
    def Address(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsHyperLink_get_Address(self.Ptr))
        return ret
    ...
    def Name(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsHyperLink_get_Name(self.Ptr))
        return ret
    ...
    def ScreenTip(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsHyperLink_get_ScreenTip(self.Ptr))
        return ret
    ...
    def SubAddress(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsHyperLink_get_SubAddress(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsHyperLink_get_TextToDisplay(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsHyperLink_get_UnicodePath(self.Ptr))
        return ret
