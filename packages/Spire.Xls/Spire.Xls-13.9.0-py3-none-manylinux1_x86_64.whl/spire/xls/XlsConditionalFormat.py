...
class XlsConditionalFormat (  XlsObject, IConditionalFormat, ICloneParent) :
    ...
    def NumberFormat(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsConditionalFormat_get_NumberFormat(self.Ptr))
        return ret
    ...
    def MakeFormula(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsConditionalFormat_MakeFormula(self.Ptr))
        return ret
    ...
    def MakeFormula(self ,para:str)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsConditionalFormat_MakeFormulaP(self.Ptr, para))
        return ret
    ...
    def MakeFormula(self ,para:float)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsConditionalFormat_MakeFormulaP1(self.Ptr, para))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsConditionalFormat_get_FirstFormula(self.Ptr))
        return ret
    ...
    def FirstFormulaR1C1(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsConditionalFormat_get_FirstFormulaR1C1(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsConditionalFormat_get_SecondFormula(self.Ptr))
        return ret
    ...
    def SecondFormulaR1C1(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsConditionalFormat_get_SecondFormulaR1C1(self.Ptr))
        return ret
