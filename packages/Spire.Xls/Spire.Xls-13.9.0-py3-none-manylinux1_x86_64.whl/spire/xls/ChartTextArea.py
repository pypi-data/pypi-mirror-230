...
class ChartTextArea (  XlsObject, IChartDataLabels) :
    ...
    def Text(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().ChartTextArea_get_Text(self.Ptr))
        return ret
...
#        return ret
    ...
    def StrikethroughType(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().ChartTextArea_get_StrikethroughType(self.Ptr))
        return ret
    ...
    def FontName(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().ChartTextArea_get_FontName(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().ChartTextArea_get_Delimiter(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().ChartTextArea_get_NumberFormat(self.Ptr))
        return ret
