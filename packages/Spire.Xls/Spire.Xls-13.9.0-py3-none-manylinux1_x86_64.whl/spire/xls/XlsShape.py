...
#
    ...
    def Name(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsShape_get_Name(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsShape_get_HtmlString(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsShape_get_AlternativeText(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsShape_get_AlternativeTextTitle(self.Ptr))
        return ret
    ...
    def OnAction(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsShape_get_OnAction(self.Ptr))
        return ret
