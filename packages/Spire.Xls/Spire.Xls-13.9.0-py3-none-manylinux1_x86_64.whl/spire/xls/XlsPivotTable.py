...
class XlsPivotTable (  XlsObject, IPivotTable) :
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsPivotTable_get_CustomTableStyleName(self.Ptr))
        return ret
...
#
    ...
    def Name(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsPivotTable_get_Name(self.Ptr))
        return ret
    ...
    def ErrorString(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsPivotTable_get_ErrorString(self.Ptr))
        return ret
    ...
    def NullString(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsPivotTable_get_NullString(self.Ptr))
        return ret
    ...
    def PageFieldStyle(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsPivotTable_get_PageFieldStyle(self.Ptr))
        return ret
