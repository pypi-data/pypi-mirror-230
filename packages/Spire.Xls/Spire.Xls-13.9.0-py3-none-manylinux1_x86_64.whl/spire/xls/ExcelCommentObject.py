...
class ExcelCommentObject (  SpireObject, IComment) :
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().ExcelCommentObject_get_Author(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().ExcelCommentObject_get_HtmlString(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().ExcelCommentObject_get_Text(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().ExcelCommentObject_get_Name(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().ExcelCommentObject_get_AlternativeText(self.Ptr))
        return ret
    ...
    def OnAction(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().ExcelCommentObject_get_OnAction(self.Ptr))
        return ret
