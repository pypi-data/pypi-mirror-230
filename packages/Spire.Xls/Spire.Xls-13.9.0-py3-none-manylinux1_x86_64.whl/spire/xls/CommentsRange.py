...
class CommentsRange (  XlsObject, IComment, ITextBoxShape, ITextBox, IShape) :
    ...
    def Author(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().CommentsRange_get_Author(self.Ptr))
        return ret
    ...
    def Text(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().CommentsRange_get_Text(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().CommentsRange_get_HtmlString(self.Ptr))
        return ret
    ...
    def Name(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().CommentsRange_get_Name(self.Ptr))
        return ret
    ...
    def AlternativeText(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().CommentsRange_get_AlternativeText(self.Ptr))
        return ret
    ...
    def OnAction(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().CommentsRange_get_OnAction(self.Ptr))
        return ret
