...
class XlsPivotField (  SpireObject, IPivotField, ICloneParent) :
    ...
    def Name(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsPivotField_get_Name(self.Ptr))
        return ret
    ...
    def NumberFormat(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsPivotField_get_NumberFormat(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsPivotField_get_SubtotalCaption(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsPivotField_get_Caption(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsPivotField_get_Formula(self.Ptr))
        return ret
