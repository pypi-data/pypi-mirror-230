...
class XlsPageSetup (  XlsPageSetupBase, IPageSetup) :
    ...
    def PrintArea(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsPageSetup_get_PrintArea(self.Ptr))
        return ret
    ...
    def PrintTitleColumns(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsPageSetup_get_PrintTitleColumns(self.Ptr))
        return ret
    ...
    def PrintTitleRows(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsPageSetup_get_PrintTitleRows(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsPageSetup_get_RelationId(self.Ptr))
        return ret
