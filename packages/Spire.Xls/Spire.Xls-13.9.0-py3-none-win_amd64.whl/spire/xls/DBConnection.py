...
class DBConnection (  ExternalConnection) :
    ...
    def ID(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().DBConnection_get_ID(self.Ptr))
        return ret
    ...
    def Name(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().DBConnection_get_Name(self.Ptr))
        return ret
    ...
    def RefreshedVersion(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().DBConnection_get_RefreshedVersion(self.Ptr))
        return ret
    ...
    def OdcFile(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().DBConnection_get_OdcFile(self.Ptr))
        return ret
    ...
    def Connection(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().DBConnection_get_Connection(self.Ptr))
        return ret
    ...
    def Command(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().DBConnection_get_Command(self.Ptr))
        return ret
