...
#
    ...
    def DecodeName(self ,name:str)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsWorkbook_DecodeName(self.Ptr, name))
        return ret
    ...
    def EncodeName(self ,strName:str)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsWorkbook_EncodeName(self.Ptr, strName))
        return ret
    ...
    def PasswordToOpen(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsWorkbook_get_PasswordToOpen(self.Ptr))
        return ret
    ...
    def RowSeparator(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsWorkbook_get_RowSeparator(self.Ptr))
        return ret
...
#
    ...
    def CodeName(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsWorkbook_get_CodeName(self.Ptr))
        return ret
    ...
    def StandardFont(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsWorkbook_get_StandardFont(self.Ptr))
        return ret
    ...
    def FullFileName(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsWorkbook_get_FullFileName(self.Ptr))
        return ret
    ...
    def Author(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsWorkbook_get_Author(self.Ptr))
        return ret
    ...
    def ArgumentsSeparator(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsWorkbook_get_ArgumentsSeparator(self.Ptr))
        return ret
...
#
    ...
    def DEF_BAD_SHEET_NAME()->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsWorkbook_DEF_BAD_SHEET_NAME())
        return ret
