...
class CellStyleObject (  SpireObject, IStyle) :
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().CellStyleObject_get_NumberFormatLocal(self.Ptr))
        return ret
...
#        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().CellStyleObject_get_Name(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().CellStyleObject_get_NumberFormat(self.Ptr))
        return ret
