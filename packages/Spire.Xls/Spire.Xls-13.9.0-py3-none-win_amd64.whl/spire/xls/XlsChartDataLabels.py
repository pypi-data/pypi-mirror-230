...
class XlsChartDataLabels (  XlsObject, IChartDataLabels, IChartTextArea, IFont, IOptimizedUpdate) :
    ...
    def Delimiter(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsChartDataLabels_get_Delimiter(self.Ptr))
        return ret
    ...
    def NumberFormat(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsChartDataLabels_get_NumberFormat(self.Ptr))
        return ret
...
#        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsChartDataLabels_get_FontName(self.Ptr))
        return ret
    ...
    def StrikethroughType(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsChartDataLabels_get_StrikethroughType(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsChartDataLabels_get_Text(self.Ptr))
        return ret
