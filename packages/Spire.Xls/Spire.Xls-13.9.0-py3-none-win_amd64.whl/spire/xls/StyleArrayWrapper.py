...
class StyleArrayWrapper (  XlsObject, IStyle, IExtendIndex) :
    ...
    def Name(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().StyleArrayWrapper_get_Name(self.Ptr))
        return ret
    ...
    def NumberFormat(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().StyleArrayWrapper_get_NumberFormat(self.Ptr))
        return ret
...
#        return ret
    ...
    def NumberFormatLocal(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().StyleArrayWrapper_get_NumberFormatLocal(self.Ptr))
        return ret
