...
#
    ...
    def IsPasswordProtected(stream:Stream)->bool:
        ...
        ret = GetDllLibXls().Workbook_IsPasswordProtectedByStream( intPtrstream)
        return ret
...
#        GetDllLibXls().Workbook_ReplaceONI(self.Ptr, oldValue,intPtrnewValues,includeColumnName)
    ...
    def GetSafeSheetName(self ,inputName:str)->str:
        ...
        ret = PtrToStr(GetDllLibXls().Workbook_GetSafeSheetName(self.Ptr, inputName))
        return ret
    ...
    def GetSafeSheetName(self ,inputName:str,replaceChar:int)->str:
        ...
        ret = PtrToStr(GetDllLibXls().Workbook_GetSafeSheetNameIR(self.Ptr, inputName,replaceChar))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().Workbook_get_CodeName(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().Workbook_get_DefaultFontName(self.Ptr))
        return ret
...
#
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().Workbook_get_FileName(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().Workbook_get_OpenPassword(self.Ptr))
        return ret
