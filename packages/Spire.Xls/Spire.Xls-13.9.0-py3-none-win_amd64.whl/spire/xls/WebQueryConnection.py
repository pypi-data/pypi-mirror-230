...
class WebQueryConnection (  ExternalConnection) :
    ...
    def ID(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().WebQueryConnection_get_ID(self.Ptr))
        return ret
    ...
    def Name(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().WebQueryConnection_get_Name(self.Ptr))
        return ret
    ...
    def RefreshedVersion(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().WebQueryConnection_get_RefreshedVersion(self.Ptr))
        return ret
    ...
    def OdcFile(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().WebQueryConnection_get_OdcFile(self.Ptr))
        return ret
    ...
    def Url(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().WebQueryConnection_get_Url(self.Ptr))
        return ret
