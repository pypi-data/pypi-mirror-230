...
class XlsValidationWrapper (  CommonWrapper, IDataValidation, IExcelApplication) :
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsValidationWrapper_get_InputTitle(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsValidationWrapper_get_InputMessage(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsValidationWrapper_get_ErrorTitle(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsValidationWrapper_get_ErrorMessage(self.Ptr))
        return ret
    ...
    def Formula1(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsValidationWrapper_get_Formula1(self.Ptr))
        return ret
    ...
    def Formula2(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsValidationWrapper_get_Formula2(self.Ptr))
        return ret
