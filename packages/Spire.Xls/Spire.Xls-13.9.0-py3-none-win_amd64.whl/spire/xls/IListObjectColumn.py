...
class IListObjectColumn (SpireObject) :
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().IListObjectColumn_get_Name(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().IListObjectColumn_get_TotalsRowLabel(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().IListObjectColumn_get_CalculatedFormula(self.Ptr))
        return ret
