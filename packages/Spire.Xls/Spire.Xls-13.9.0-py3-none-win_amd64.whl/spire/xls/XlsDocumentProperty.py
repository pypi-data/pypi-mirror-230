...
class XlsDocumentProperty (  IDocumentProperty) :
    ...
    def Name(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsDocumentProperty_get_Name(self.Ptr))
        return ret
    ...
    def Text(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsDocumentProperty_get_Text(self.Ptr))
        return ret
...
#        GetDllLibXls().XlsDocumentProperty_set_Blob(self.Ptr, vArray, vCount)
    ...
    def LinkSource(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsDocumentProperty_get_LinkSource(self.Ptr))
        return ret
    ...
    def InternalName(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsDocumentProperty_get_InternalName(self.Ptr))
        return ret
