...
#
    ...
    <returns>Returns error value or null.</returns>
        ...
        ret = PtrToStr(GetDllLibXls().XlsWorksheet_GetError(self.Ptr, row,column))
        return ret
    ...
    <returns>Returns error value or null.</returns>
        ...
        ret = PtrToStr(GetDllLibXls().XlsWorksheet_GetFormulaErrorValue(self.Ptr, row,column))
        return ret
    ...
    <returns>String contained by the cell.</returns>
        ...
        ret = PtrToStr(GetDllLibXls().XlsWorksheet_GetFormulaStringValue(self.Ptr, row,column))
        return ret
    ...
    def GetFormula(self ,row:int,column:int,bR1C1:bool)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsWorksheet_GetFormula(self.Ptr, row,column,bR1C1))
        return ret
    ...
    def GetFormula(self ,row:int,column:int,bR1C1:bool,isForSerialization:bool)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsWorksheet_GetFormulaRCBI(self.Ptr, row,column,bR1C1,isForSerialization))
        return ret
    ...
    <returns>String contained by the cell.</returns>
        ...
        ret = PtrToStr(GetDllLibXls().XlsWorksheet_GetText(self.Ptr, row,column))
        return ret
...
<value>
  <c>true</c> if this instance is OLE object; otherwise, <c>false</c>.
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsWorksheet_get_QuotedName(self.Ptr))
        return ret
...
#
    ...
    <returns>String contained by the cell.</returns>
        ...
        ret = PtrToStr(GetDllLibXls().XlsWorksheet_GetStringValue(self.Ptr, cellIndex))
        return ret
    ...
    <returns>String contained by the cell.</returns>
        ...
        ret = PtrToStr(GetDllLibXls().XlsWorksheet_GetStringValueRC(self.Ptr, row,column))
        return ret
