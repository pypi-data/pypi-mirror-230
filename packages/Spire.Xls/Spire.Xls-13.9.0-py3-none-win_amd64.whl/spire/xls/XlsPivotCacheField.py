...
class XlsPivotCacheField (SpireObject) :
    ...
    def Formula(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsPivotCacheField_get_Formula(self.Ptr))
        return ret
    ...
    def Name(self)->str:
        ...
        ret = PtrToStr(GetDllLibXls().XlsPivotCacheField_get_Name(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsPivotCacheField_get_Caption(self.Ptr))
        return ret
