...
class XlsChart (  XlsWorksheetBase, ICloneParent, IChart) :
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsChart_get_SecondaryCategoryAxisTitle(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsChart_get_SecondaryValueAxisTitle(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsChart_get_SeriesAxisTitle(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsChart_get_ValueAxisTitle(self.Ptr))
        return ret
...
#
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsChart_get_CategoryAxisTitle(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsChart_get_ChartStartType(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibXls().XlsChart_get_ChartTitle(self.Ptr))
        return ret
