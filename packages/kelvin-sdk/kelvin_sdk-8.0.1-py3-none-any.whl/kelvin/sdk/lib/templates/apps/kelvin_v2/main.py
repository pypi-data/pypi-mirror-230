...
from kelvin.sdk.datatype import Message, Number, PrimitiveBoolean, String
from kelvin.sdk.datatype.base_messages import ControlChange, Recommendation
from kelvin.sdk.datatype.krn import KRNAsset, KRNAssetDataStream, KRNWorkload
...
async def double_msg_value(cli: KelvinClient, queue: Queue[Number]) -> None:
    while True:
        msg = await queue.get()
