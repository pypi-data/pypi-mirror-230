...
if __name__ == "__main__":
    ak = "KGK7UKKCZISRFFRRL55M"
    sk = "KHmEFMahCIoXj44dBeTcKPd8eGtOE0o8gSq4PRwe"
    method = "get"
    url = "https://cdn.myhuaweicloud.com/v1.0/cdn/statistics/domain-location-stats"
    data = {"action": "location_detail", "start_time": 1694569200000, "end_time": 1694569500000, "domain_name": "chart.17chdd.com", "stat_type": "req_num", "enterprise_project_id": "all"}
    print(get_invoke_response(ak, sk, method, url, data))
