...
from thonny import get_runner, get_workbench, ui_utils, latex
...
class EditorNotebook(CustomNotebook):
    ...
    def _init_commands(self):
        ...
        get_workbench().add_command(
            ...
            "latex",
            "create_latex_pdf",
            self._cmd_create_latex,
            caption="create_latex_pdf",
            group=10,
            image="create-latex16x16",
            include_in_toolbar=True,
        )
        ...
        get_workbench().add_command(
            ...
            "latex",
            "preview_latex",
            self._cmd_preview_latex,
            caption="preview_latex",
            group=10,
            image="latex-preview16x16.png",
            include_in_toolbar=True,
        )
    ...
    def _cmd_preview_latex(self):
        editor = self.get_current_editor()
        content = editor.get_content()
        latex.preview_latex(content)

    def _cmd_create_latex(self):
        editor = self.get_current_editor()
        content = editor.get_content()
        latex.create_latex(content)
