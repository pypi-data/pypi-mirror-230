...
class MiddleWare:
    ...
    def run_circuits_async(
        ...
        qscripts_ = expand_batch(qscripts)

        # Submit batched qscripts individually.
        batch_id = self.qclient.submit(qscripts_, executors, qelectron_info, qnode_specs)

        # Make record of submission. Post-processing may be required.
        self._record_submission(batch_id, qscripts, qscripts_, qelectron_info)
