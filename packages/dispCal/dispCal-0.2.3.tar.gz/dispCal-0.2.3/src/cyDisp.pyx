...
cdef double dltarL(double[:]d,double[:]a,double[:]b,double[:]rho,double[:]Qp,double[:]Qs,double fRef,double wvno,double omega,int LN):
    ...
    c
    '''
    cdef double xkb, wvnop,wvnom,rb,e1,e2,xmu,q,y,z,cosq,fac,sinq,e10,e20,xnor,ynor,B,omegaRef
    cdef int i0
    omegaRef=fRef*2*3.141592657589793
    B = b[LN-1]
    if Qs[LN-1]>0.0:
...
cdef double dltarR(double[:]d,double[:]a,double[:]b,double[:]rho,double[:]Qp,double[:]Qs,double fRef,double wvno,double omega,int LN):
    ...
    cdef double wvno2,xka,xkb,wvnop,wvnom,ra,rb,gammk,gam,gamm1,rho1,t,p,q,tmp,dpth,znul,A,B,omegaRef
    cdef int i0=1
    omegaRef=fRef*2*3.141592657589793
    wvno2=wvno*wvno
    A = a[LN-1]
