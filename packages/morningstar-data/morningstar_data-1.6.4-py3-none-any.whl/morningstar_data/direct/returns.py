...
from .data_type import Frequency, TimeSeriesFormat, CalculationWindowType
...
def get_returns(
    ...
    if not isinstance(freq, Frequency):
        ...
        freq = Frequency[freq]
    return_data_point = {"datapointId": freq.data_point_id, "isTsdp": True,
    ...
    return investment.get_investment_data(investments=investments,
                                          data_points=[{"datapointId": "OS01W"}, return_data_point],
