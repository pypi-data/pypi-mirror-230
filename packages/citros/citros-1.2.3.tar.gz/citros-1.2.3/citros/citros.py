...
class Citros:
    ...
    def docker_login(self):
        ...
        try:
            ...
            if "credential command not supported without credential helper" in str(e):
                self.print("There was an issue with Docker's internal credential storage. " + \
                           "Please try deleting your ~/.docker/config.json file and try again.", color='red')
            else:
                raise
