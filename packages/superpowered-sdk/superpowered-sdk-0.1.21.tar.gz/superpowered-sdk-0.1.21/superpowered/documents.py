...
def create_document_via_url(knowledge_base_id: str, url: str, title: str = None, description: str = None, supp_id: str = None, chunk_header: str = None, html_exclude_tags: list[str] = None) -> dict:
    """
