...
class PipekitService:
    ...
    def __init__(self, username="", password="", token="", pipekit_url="https://pipekit.io"):
    ...
    def submit(self, workflow: Workflow, cluster, pipe_name=""):
        ...
        submit_response = requests.post(
            submit_url,
            data=workflow.json(exclude_none=True, by_alias=True, exclude_unset=True, exclude_defaults=True),
