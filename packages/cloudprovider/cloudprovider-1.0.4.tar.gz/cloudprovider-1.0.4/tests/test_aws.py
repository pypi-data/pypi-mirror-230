...
class TestCloudResourceManagement(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.aws_manager = AWSResourceManager(region='us-east-1',aws_access='',aws_secret='')
        cls.azure_manager = AzureResourceManager(subscription_id='e34397b2-486a-417d-bd5a-b9113a4a1b0c')
    ...
    def test_azure_vm_lifecycle(self):
        ...
        vm_name = 'my-azure-vm'
        resource_group_name = 'Multi_Cloud_Maha'
        location = 'eastus'
