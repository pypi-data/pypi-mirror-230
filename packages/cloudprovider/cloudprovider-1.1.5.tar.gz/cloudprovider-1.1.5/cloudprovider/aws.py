...
class AWSResourceManager:
    ...
    def create_rds_instance(self, db_instance_identifier, db_instance_class, db_name, username, password,security_group_name):
        ...
        try:
            response = self.rds.create_db_instance(
                ...
                DBName=db_name,
                VPCSecurityGroups=security_group_name,  
