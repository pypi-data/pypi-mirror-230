...
try:
    ...
    # 初始化
    def initplot(style='default',figsize=(10,8),background=True, projection='default'):
        global theme
        ...
        elif projection == 'default':
            return plt.axes()
        else:
            print('[HINT] Projection not found. Use default projection.') 
            return plt.axes()
