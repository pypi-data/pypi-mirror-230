...
def is_path(source:str) -> bool:
    ...
    Returns
    -------
    a boolean: true if the path is a file or directory
    """
...
def get_name(path : str) -> str:
    """
    Given the path, returns the name of file or directory without extension

    Parameters
    ----------
    path: str: path of a file to search for

    Returns
    -------
    str: the directory path. if it fails to find a path, returns False.
    """
    try: 
