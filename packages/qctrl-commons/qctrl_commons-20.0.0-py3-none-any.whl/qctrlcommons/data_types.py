...
class GraphDataType(DataType):
    ...
    def can_decode(self, obj: dict) -> bool:
        # Allow to decode 'pythonflow_graph' to backward support
        # objects encoded with older versions of the package.
        return self.object_key in obj or "pythonflow_graph" in obj
...
class OperationDataType(DataType):
    ...
    def can_decode(self, obj: dict) -> bool:
        # Allow to decode 'pythonflow_op' to backward support
        # objects encoded with older versions of the package.
        return self.object_key in obj or "pythonflow_op" in obj
