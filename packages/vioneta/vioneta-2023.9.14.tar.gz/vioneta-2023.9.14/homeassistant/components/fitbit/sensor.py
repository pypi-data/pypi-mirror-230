...
def request_app_setup(
    ...
    try:
        description = f"""Please create a Fitbit developer app at
                       ...
                       (Note: Your Vioneta Agro instance must be accessible via HTTPS.)
        ...
        _LOGGER.error(
            "Could not find an SSL enabled URL for your Vioneta Agro instance. "
            "Fitbit requires that your Vioneta Agro instance is accessible via HTTPS"
        )
        return
