...
def read_wav_file(filename):
    ...
    if(duration > 10.24):
        print("Warning: audio is longer than 10.24 seconds, may degrade the model performance. It's recommand to truncate your audio to 5.12 seconds before input to AudioSR to get the best performance.")
...
def save_wave(waveform, savepath, name="outwav", samplerate=16000):
    ...
    for i in range(waveform.shape[0]):
        ...
        print("Don't forget to try different seeds by setting --seed <int> so that AudioSR can have optimal performance on your hardware.")
