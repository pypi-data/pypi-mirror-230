...
class PlaybackContentMetadata(BaseModel):
    ...
    organization: Optional[StrictStr] = Field(
        None,
        description='This can be filled by gstreamers GST_TAG_ORGANIZATION. Mozart can also fill this with netradio station name like "P3" and TV content like "Netflix". This is needed so it\'s possible to show who the provider is for the playing audio track/content. ',
    )
