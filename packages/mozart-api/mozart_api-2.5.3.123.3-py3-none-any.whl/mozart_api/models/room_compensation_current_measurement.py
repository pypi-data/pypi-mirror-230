...
class RoomCompensationCurrentMeasurement(BaseModel):
    ...
    state: Optional[StrictStr] = Field(
        None,
        description="State of the measurement for the speaker. started:   The measurement has started. done:   The measurement has ended sucessfully. lastDone:   The last measurement in the run has ended sucessfully. error:   An error occurred during measurement. ",
    )
