...
class Layout(ChainRelationships):
    ...
    def _calculate_coordinates(
        ...
        Parameters:
            i (int): The index of the message.
            children_ids (List[str]): A list of IDs for the children messages.
            depth (int): The depth level of the message in the conversation tree.
            mapping (object): An object that contains the parent-child relationships of messages.
            scaling (str, optional): The type of scaling used. Defaults to ScalingType.DIRECT.
            alpha_scale (float, optional): A scaling factor between 0 and 1. Defaults to 1.
            method (str, optional): The method used for calculating coordinates. Defaults to MethodType.SPACING.
            alpha_final_z (float, optional): A scaling factor for z-coordinate between 0 and 1. Defaults to 0.7.

        Returns:
            Tuple[float, float, float, float, int]: The calculated (x, y, z, t) coordinates and number of parts (n_parts).
