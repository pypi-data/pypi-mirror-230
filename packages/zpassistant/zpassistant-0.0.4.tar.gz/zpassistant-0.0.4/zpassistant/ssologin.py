...
class SsoLoginUtil:
    ...
    def init_chrome(self):
        ...
        try:
            ...
            return webdriver.Chrome(service=ChromeService(), timeout=20)
    ...
    def init_edge(self):
        ...
        try:
            ...
            return webdriver.Edge(service=EdgeService(), timeout=20)
        except Exception as e:
            pass
    ...
    def init_firefox(self):
        ...
        try:
            ...
            return webdriver.Firefox(service=FirefoxService(), timeout=20)
        except Exception as e:
            pass
    ...
    def init_safari(self):
        ...
        try:
            ...
            return webdriver.Safari(service=SafariService(), timeout=20)
        except Exception as e:
            pass
