...
class SsoLoginUtil:
    ...
    def is_cookie_inner_authentication_expired(self,cookie):
    ...
    def check_cookie_jar_expire(self,cookie_jar,checkCookieFunc = None):
        for cookie in cookie_jar:
            if checkCookieFunc is None:
                if self.is_cookie_inner_authentication_expired(cookie):
                    return True
            else:
                checkResult = checkCookieFunc(cookie)
