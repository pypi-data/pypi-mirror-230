...
def BoolProperty(name: str = '', description: str = '', translation_context: str = '*args', default: typing.Any = False, options: typing.Set[typing.Any] = {'ANIMATABLE'}, override: typing.Set[typing.Any] = set(), tags: typing.Set[typing.Any] = set(), subtype: str = 'NONE', update: typing.Callable = None, get: typing.Callable = None, set: typing.Callable = None) -> None:
...
def BoolVectorProperty(name: str = '', description: str = '', translation_context: str = '*args', default: typing.Sequence[typing.Any] = (False, False, False), options: typing.Set[typing.Any] = {'ANIMATABLE'}, override: typing.Set[typing.Any] = set(), tags: typing.Set[typing.Any] = set(), subtype: str = 'NONE', size: int = 3, update: typing.Callable = None, get: typing.Callable = None, set: typing.Callable = None) -> None:
...
def CollectionProperty(type: typing.Type = None, name: str = '', description: str = '', translation_context: str = '*args', options: typing.Set[typing.Any] = {'ANIMATABLE'}, override: typing.Set[typing.Any] = set(), tags: typing.Set[typing.Any] = set()) -> None:
...
def EnumProperty(items: typing.Sequence[typing.Tuple[str, ...]], name: str = '', description: str = '', translation_context: str = '*args', default: str = None, options: typing.Set[typing.Any] = {'ANIMATABLE'}, override: typing.Set[typing.Any] = set(), tags: typing.Set[typing.Any] = set(), update: typing.Callable = None, get: typing.Callable = None, set: typing.Callable = None) -> None:
...
def PointerProperty(type: typing.Type = None, name: str = '', description: str = '', translation_context: str = '*args', options: typing.Set[typing.Any] = {'ANIMATABLE'}, override: typing.Set[typing.Any] = set(), tags: typing.Set[typing.Any] = set(), poll: typing.Callable = None, update: typing.Callable = None) -> None:
...
def StringProperty(name: str = '', description: str = '', translation_context: str = '*args', default: str = '', maxlen: int = 0, options: typing.Set[typing.Any] = {'ANIMATABLE'}, override: typing.Set[typing.Any] = set(), tags: typing.Set[typing.Any] = set(), subtype: str = 'NONE', update: typing.Callable = None, get: typing.Callable = None, set: typing.Callable = None, search: typing.Callable = None, search_options: typing.Set[typing.Any] = {'SUGGESTION'}) -> None:
