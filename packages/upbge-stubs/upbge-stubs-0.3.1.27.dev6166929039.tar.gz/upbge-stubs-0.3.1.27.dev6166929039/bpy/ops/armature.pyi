...
def assign_to_collection(collection: str = 'DEFAULT', new_collection_name: str = '') -> None:
...
def collection_assign(name: str = '') -> None:
...
def collection_deselect(name: str = '') -> None:
...
def collection_move(direction: str = 'UP') -> None:
...
def collection_select(name: str = '') -> None:
...
def collection_unassign(name: str = '') -> None:
...
def move_to_collection(collection: str = 'DEFAULT', new_collection_name: str = '') -> None:
...
def separate(confirm: bool = True) -> None:
