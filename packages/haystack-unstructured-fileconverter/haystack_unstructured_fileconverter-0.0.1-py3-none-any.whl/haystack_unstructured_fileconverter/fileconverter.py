...
class UnstructuredFileConverter:
    ...
    def __init__(
        ...
        **unstructured_kwargs,
        ...
        if api_key is None and api_url == is_hosted_api:
            try:
    ...
    def _create_documents(
        ...
        if document_creation_mode == "one-doc-per-file":
            ...
            docs = [Document(text=text, metadata={"name": filepath})]
            ...
            docs = [Document(text=texts_per_page[page], metadata=meta_per_page[page]) for page in texts_per_page.keys()]
            ...
            for el in elements:
                ...
                doc = Document(text=str(el), metadata=metadata)
                docs.append(doc)
