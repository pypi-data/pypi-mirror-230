...
def fragment_subscription_preview_v2_fragment():
    ...
    _frag_proration_net_amount.amount()
    _frag_proration_net_amount.currency()
    _frag_recurring_subscription = _frag.recurring_subscription()
    _frag_recurring_subscription_sub_total = _frag_recurring_subscription.sub_total()
    _frag_recurring_subscription_sub_total.amount()
    _frag_recurring_subscription_sub_total.currency()
    _frag_recurring_subscription_total_excluding_tax = _frag_recurring_subscription.total_excluding_tax()
    _frag_recurring_subscription_total_excluding_tax.amount()
    _frag_recurring_subscription_total_excluding_tax.currency()
    _frag_recurring_subscription_total = _frag_recurring_subscription.total()
    _frag_recurring_subscription_total.amount()
    _frag_recurring_subscription_total.currency()
    _frag_recurring_subscription_tax = _frag_recurring_subscription.tax()
    _frag_recurring_subscription_tax.amount()
    _frag_recurring_subscription_tax.currency()
    _frag_recurring_subscription_discount = _frag_recurring_subscription.discount()
    _frag_recurring_subscription_discount.amount()
    _frag_recurring_subscription_discount.currency()
    _frag_recurring_subscription_tax_details = _frag_recurring_subscription.tax_details()
    _frag_recurring_subscription_tax_details.display_name()
    _frag_recurring_subscription_tax_details.percentage()
    _frag_recurring_subscription_tax_details.inclusive()
    _frag_recurring_subscription_discount_details = _frag_recurring_subscription.discount_details()
    _frag_recurring_subscription_discount_details.type()
    _frag_recurring_subscription_discount_details.value()
    _frag_recurring_subscription_discount_details.duration_type()
    _frag_recurring_subscription_discount_details.duration_in_months()
    _frag_billing_period_range = _frag.billing_period_range()
    _frag_billing_period_range.start()
    _frag_billing_period_range.end()
    _frag.is_plan_downgrade()
