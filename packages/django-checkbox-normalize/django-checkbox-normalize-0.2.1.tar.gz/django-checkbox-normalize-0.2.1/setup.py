...
setup(
    ...
    author="Si KongZhi",
    author_email="sikongzhi@zencore.cn",
    maintainer="Si KongZhi",
    maintainer_email="sikongzhi@zencore.cn",
    license="MIT",
    classifiers=[
    ...
    packages=find_packages(
        ".",
        exclude=[
            "django_checkbox_normalize_example",
            "django_checkbox_normalize_example.migrations",
            "django_checkbox_normalize_demo",
        ],
    ),
