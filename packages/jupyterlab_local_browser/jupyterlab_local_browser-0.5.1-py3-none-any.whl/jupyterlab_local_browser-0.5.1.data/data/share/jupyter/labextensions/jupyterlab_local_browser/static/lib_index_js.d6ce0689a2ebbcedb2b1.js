...
/* harmony export */   newTabIcon: () => (/* binding */ newTabIcon),
...
const newTabIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.LabIcon({
    name: 'jupyterlab_local_browser:newTab',
    svgstr: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>open-in-new</title><path d="M14,3V5H17.59L7.76,14.83L9.17,16.24L19,6.41V10H21V3M19,19H5V5H12V3H5C3.89,3 3,3.9 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V12H19V19Z" /></svg>',
});
...
class LocalBrowserWidget extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.MainAreaWidget {
    constructor(options) {
        ...
        const newTabButton = new _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.ToolbarButton({
            icon: _icon__WEBPACK_IMPORTED_MODULE_5__.newTabIcon,
            iconLabel: 'Open in New Tab',
            onClick: () => {
                window.open('https://www.room3b.eu', '');
            }
        });
...
//# sourceMappingURL=lib_index_js.d6ce0689a2ebbcedb2b1.js.map