...
def env_to_openi(output_path, output_url):
    """
    upload output to openi 
    """
    try:
        mox.file.copy_parallel(output_path, output_url)
        print("Successfully upload {} to {}".format(output_path, output_url))
    except Exception as e:
        print('moxing upload {} to {} failed: '.format(output_path,output_url) + str(e))
