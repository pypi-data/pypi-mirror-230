...
class PercentageMetric(object):
    ...
    def __init__(self, column=None, exclude_column=None, include_columns=None, output_column=None, population_dataset=None, population_dimension=None, population_id_field=None):  # noqa: E501
