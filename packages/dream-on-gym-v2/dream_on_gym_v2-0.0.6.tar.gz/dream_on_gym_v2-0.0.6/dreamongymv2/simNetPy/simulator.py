...
class Simulator:
    ...
    def setAllocator(self, algorithm):
        ...
        # allocator.setNetwork(self.__controller.network)
        # allocator.setPath(self.__controller.getPaths())
        # self.__controller.setAllocator(allocator)
        # Fin revisar
    ...
    def printInitialInfo(self):
        ...
        # TO DO
        # print("Algoritmo: ", end='')
        # print(self.__controller.allocator.getName())
        print('+', end='')
        for i in range(0, 7):
            print('{:->11}'.format('+'), end='')
        print("\n|", end='')
