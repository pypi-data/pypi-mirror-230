...
def new_geometry_node_group_tool(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Create a new geometry node group for an tool :File: `startup/bl_operators/geometry_nodes.py\:300 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L300>`__
...
def repeat_zone_item_add(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Add a repeat item to the repeat zone :File: `startup/bl_operators/geometry_nodes.py\:439 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L439>`__
...
def repeat_zone_item_move(
    ...
    ''' Move a repeat item up or down in the list :File: `startup/bl_operators/geometry_nodes.py\:489 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L489>`__
...
def repeat_zone_item_remove(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Remove a repeat item from the repeat zone :File: `startup/bl_operators/geometry_nodes.py\:466 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L466>`__
...
def simulation_zone_item_add(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Add a state item to the simulation zone :File: `startup/bl_operators/geometry_nodes.py\:340 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L340>`__
