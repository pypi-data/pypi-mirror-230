...
def collection_deselect(
    ...
    :type execution_context: typing.Optional[typing.Union[str, int]]
    :type undo: typing.Optional[bool]
    :param name: Bone Collection, Name of the bone collection to deselect bones from; empty use the active bone collection
    :type name: typing.Union[str, typing.Any]
    '''
...
def collection_select(
    ...
    :type execution_context: typing.Optional[typing.Union[str, int]]
    :type undo: typing.Optional[bool]
    :param name: Bone Collection, Name of the bone collection to select bones from; empty use the active bone collection
    :type name: typing.Union[str, typing.Any]
    '''
