...
def new_geometry_node_group_assign(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Create a new geometry node group and assign it to the active modifier :File: `startup/bl_operators/geometry_nodes.py\:273 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L273>`__
...
def new_geometry_node_group_tool(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Create a new geometry node group for an tool :File: `startup/bl_operators/geometry_nodes.py\:301 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L301>`__
...
def new_geometry_nodes_modifier(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Create a new modifier with a new geometry node group :File: `startup/bl_operators/geometry_nodes.py\:249 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L249>`__
...
def repeat_zone_item_add(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Add a repeat item to the repeat zone :File: `startup/bl_operators/geometry_nodes.py\:440 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L440>`__
...
def repeat_zone_item_move(
    ...
    ''' Move a repeat item up or down in the list :File: `startup/bl_operators/geometry_nodes.py\:490 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L490>`__
...
def repeat_zone_item_remove(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Remove a repeat item from the repeat zone :File: `startup/bl_operators/geometry_nodes.py\:467 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L467>`__
...
def simulation_zone_item_add(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Add a state item to the simulation zone :File: `startup/bl_operators/geometry_nodes.py\:341 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L341>`__
...
def simulation_zone_item_move(
        ...
        *,
        direction: typing.Optional[typing.Any] = 'UP'):
    ''' Move a simulation state item up or down in the list :File: `startup/bl_operators/geometry_nodes.py\:391 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L391>`__
