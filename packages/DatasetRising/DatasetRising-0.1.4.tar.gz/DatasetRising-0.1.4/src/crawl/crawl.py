...
def get_args():
    ...
    parser.add_argument('-t', '--type', nargs='*', metavar='TYPE', type=str, help='Crawl type', required=True, choices=['search', 'index', 'tags', 'implications'])
    parser.add_argument('-s', '--source', nargs='*', metavar='SOURCE', type=str, help='Crawl source', required=True, choices=['e926', 'e621', 'gelbooru', 'danbooru'])
