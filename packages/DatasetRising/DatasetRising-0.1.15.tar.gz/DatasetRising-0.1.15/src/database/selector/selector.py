    ...
    def load(self):
        ...
        try:
            ...
            with open(abs_file, 'r') as yaml_file:
                ...
                proto_includes = [self.resolve_tag(k, True) for k in set(yaml_includes)]
                proto_excludes = [self.resolve_tag(k, True) for k in set(yaml_excludes)]
