...
def get_args():
    ...
    parser.add_argument('-c', '--category', nargs='*', metavar='CATEGORY', type=str, help='Only list tags which 1) are in this specified category; and 2) are NOT matches with any of the selectors', required=True, choices=[c for c in Category])
    ...
    parser.add_argument('-f', '--output-format', nargs='*', metavar='FORMAT', type=str, help='Output format', required=False, choices=['html', 'jsonl'], default='html')
