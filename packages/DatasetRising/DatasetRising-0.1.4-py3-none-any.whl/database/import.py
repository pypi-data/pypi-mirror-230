...
def get_args():
    ...
    parser.add_argument('-s', '--source', nargs='*', metavar='SOURCE', type=str, help='Data source', required=True, choices=['e926', 'e621', 'gelbooru', 'danbooru'])
    parser.add_argument('--tag-version', nargs='*', metavar='VERSION', type=str, help='Preferred tag format version', required=False, default='v2', choices=['v0', 'v1', 'v2'])
