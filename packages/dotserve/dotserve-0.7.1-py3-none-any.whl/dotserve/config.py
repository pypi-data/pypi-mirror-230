...
from dotserve.types import AppUser
...
class DotserveConfig:
    # Directory where the Dotagent project is located
    root = APP_ROOT
    # Dotagent server URL. Used only for cloud features
    dotserve_server: str
...
def load_config():
    ...
    dotserve_server = os.environ.get("DOTSERVE_SERVER", "https://cloud.dotagent.ai")
