...
class ReaderService():
  ...
  # Reader Functions
  # -----------------
  def read_file(self, filename, entity):
    ...
    self.logger.debug(f"[ReaderService] Read File", extra=properties)
  ...
  def _spark_generic_reader(self, filename, entity, spark_reader= None, default_options = None):
  ...
  def _get_csv_reader_options(self, entity):
  ...
  def _spark_csv_reader(self, filename, entity):
  ...
  def _pandas_excel_reader(self, sourcePath, entity):
