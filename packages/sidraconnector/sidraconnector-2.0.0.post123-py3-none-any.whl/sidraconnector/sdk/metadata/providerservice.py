...
class ProviderService():
  def __init__(self, spark):
    self.logger = Logger(spark).create_logger('ProviderService', True, False) 
  ...
  def create_provider(self, provider:dict):
    body = provider
    api_response = self._metadata_provider_api_instance.api_metadata_providers_post(body=body, api_version = constants.API_VERSION)
    return api_response
