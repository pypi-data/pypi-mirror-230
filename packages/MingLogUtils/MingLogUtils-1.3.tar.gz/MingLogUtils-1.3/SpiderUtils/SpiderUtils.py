...
class Get_Bilibili_Vedio:
    """
        ...
        Examples:
            >>> url = 'https://www.bilibili.com/video/BV12g411K7oq'
    ...
    def download(self, OnlyFlag=True):
        ...
        if OnlyFlag:
            ...
            for i, j in vedios:
                ...
                self.__save_data(self.__get_res(tmp_url).content, vedio_path)
                self.__save_data(self.__get_res(tmp_url).content, vedio_path, data_type='a')
