...
from variable_local.template import *
...
def mocker_get_variable_value_by_variable_id(mocker):
    return mocker.patch("variable_local.variable.VariablesLocal.get_variable_value_by_variable_id", return_value="mocked_value")
...
class TestVariablesLocal:
    ...
    def test_add_method(self, variable_instance):
        ...
        logger.start(object={'variable_instance': str(variable_instance)})
        variable_instance.add(variable_id=TEST_VARIABLE_ID1, variable_name=TEST_VARIABLE_NAME1)
    ...
    def test_get_variable_id_by_variable_name(self, variable_instance):
        message = 'test_get_variable_id succeed'
        logger.start(object={'variable_instance': str(variable_instance)})
        variable_instance.name2id_dict[TEST_VARIABLE_NAME1] = TEST_VARIABLE_ID1
        assert variable_instance.get_variable_id_by_variable_name(
    ...
    def test_get_variable_name(self, variable_instance):
        ...
        assert variable_instance.get_variable_name_by_variable_id(
            variable_id=TEST_VARIABLE_ID1) == TEST_VARIABLE_NAME1
        logger.end(message)

    def test_get_variable_value_by_variable_name_and_lang_code(self, variable_instance, mocker_get_variable_value_by_variable_id):
        ...
        variable_instance.name2id_dict[TEST_VARIABLE_NAME1] = TEST_VARIABLE_ID1
        result = variable_instance.get_variable_value_by_variable_name_and_lang_code(
...
class TestReplaceFieldsWithValues:
    ...
    def test_get_variable_values_and_chosen_option(self, replace_instance, mocker, mocker_get_variable_value_by_variable_id):
        ...
        mocker.patch.object(replace_instance.variable,
                            "get_variable_id_by_variable_name", return_value=TEST_VARIABLE_ID1)
