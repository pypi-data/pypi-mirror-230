...
class VariablesLocal(object):
    def __init__(self):
        ...
        for variable_id in VARIABLE_NAMES_DICT:
            self.variable_add(variable_id=variable_id, variable_name=VARIABLE_NAMES_DICT[variable_id])

    def variable_add(self, variable_id: int, variable_name: str) -> None:       
    ...
    def get_variable_value_by_variable_name(self, variable_name: str, lang_code: str ) -> str:
