...
class VariablesLocal(GenericCRUD):
    ...
    def get_variable_value_by_variable_name_and_lang_code(self, variable_name: str, lang_code: LanguageCode) -> str:
    ...
    @staticmethod
    def get_variable_value_by_variable_id(variable_id: int, lang_code: LanguageCode ) -> str:
