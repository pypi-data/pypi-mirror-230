...
class VariablesLocal(object):
    ...
    def get_variable_value_by_variable_name_and_lang_code(self, variable_name: str, lang_code: str) -> str:
        logger.start(object={'lang_code': lang_code, 'variable_name': variable_name})
        variable_id = self.get_variable_id_by_variable_name(variable_name=variable_name)
        variable_value = VariablesLocal.get_variable_value_by_variable_id(lang_code=lang_code, variable_id=variable_id)
        logger.end(object = {'variable_value': variable_value})
        return variable_value
    
    @staticmethod
    # TODO: Can we change all lang_code:str to lang_code: LangCode?
    def get_variable_value_by_variable_id(variable_id: int, lang_code: str) -> str:
