...
def getBlock(self, dz, zb=None, nz=None):
  ...
  nz: Number of vertical discretization steps (if None, discretize up to Zmax)
  """
# Get the domain size
  dom = self.getDomain()
  nx = dom.getNbNodeX()
  ...
  if (zb == None):
    zb = dom.getZrefGeo()
  if (nz == None):
    nz = int(round((dom.getZMaxGeo() - zb)/dz, 0) + 1)
