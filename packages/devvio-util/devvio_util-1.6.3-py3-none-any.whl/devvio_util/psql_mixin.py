...
class PsqlMixin:
    ...
    def select_single_record(self, relation: str, select_props: List[str], constraints: Dict[str, Any]) -> dict or None:
        stmt = "select "
        counter = 0
        if not select_props:
    ...
    def select_all_records(self, relation: str, select_props: List[str],
    ...
    def paged_query(self, select_props: List[str], constraint_filters: str, args: Dict[str, Any],
