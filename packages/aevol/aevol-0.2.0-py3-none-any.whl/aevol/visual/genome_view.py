...
class GenomeView:
    def __init__(self, nb_layers=max_layers):
        ...
        self.ax.add_patch(Circle(center, radius, angle=90, fill=False, lw=1, color='black'))
    ...
    def compute_layer(self, strand, begin_angle, end_angle):
        ...
        layer = 1
        sector_free = False  # false while we do not find an empty sector to draw the strand
        global last_layer
