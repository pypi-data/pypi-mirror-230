...
class ABIBridge:
    ...
    def get_try(self,request_url:str=None):
        request_url=self.if_default_return_obj(obj=self.abi_url,default=request_url)
        try:
            request = self.get_request(request_url=request_url)
        except:
            request = None
        return request
    ...
    def try_abi_url(self,request_url:str=None,self_abi_request:bool=False):
        ...
        if request == None:
            ...
            http_variants.append(http_variants_2[0])
            http_variants.append(http_variants_2[1])
    ...
    def get_request(self,request_url:str=None, request_type: str = None, request_min: int = 20, request_max: int = 30,
                    limit_epoch: int = 60, request_start: int = None):
        """
    ...
    def if_default_return_obj(self,obj:any,default:any=None,default_compare:any=None):
    ...
    def get_response(self,request=None):
        ...
        """
        request=self.if_default_return_obj(obj=self.request,default=request)
    ...
    def try_check_sum(self, address:str=None):
        ...
        """
        address = self.if_default_return_obj(obj=self.contract_address,default=address)
        try:
    ...
    def safe_json_loads(self, json_obj:dict=None):
        ...
        """
        json_obj = self.if_default_return_obj(obj=self.request,default=json_obj)
        try:
    ...
    def create_abi_bridge(self,contract_address:str=None,abi:list=None):
        ...
        """
        contract_address =self.if_default_return_obj(obj=self.contract_address,default=contract_address)
        abi = self.if_default_return_obj(obj=self.abi,default=abi)
        try:
            abi_bridge = self.rpc.w3.eth.contract(address=contract_address, abi=abi)
        except:
            abi_bridge = None
        return abi_bridge
    ...
    def get_required_inputs(self, function_name: str, abi: list = None):
        ...
        for item in abi:
            if item['type'] == 'function' and item["name"] == function_name:
                return item["inputs"]
    def call_function(self,function_name:str,contract_bridge=None,*args, **kwargs):
        """
        ...
        contract_bridge = self.if_default_return_obj(obj=self.contract_bridge,default=contract_bridge)
    ...
    def create_functions(self, function_name,subsinstance:str="functions",contract_bridge=None, *args, **kwargs):
        contract_bridge = self.if_default_return_obj(obj=self.contract_bridge,default=contract_bridge)
