...
class AccountManager:
    def __init__(self, env_key:str=None,address:str=None, rpc:dict=None):
        ...
        self.account_address = self.try_check_sum(if_default_return_obj(obj=self.get_address_from_private_key(self.private_key),default=address))
    ...
    def build_txn(self, contract_bridge,to_address):
        return contract_bridge.build_transaction(self.get_txn_info(self, to_address, txn_value))
