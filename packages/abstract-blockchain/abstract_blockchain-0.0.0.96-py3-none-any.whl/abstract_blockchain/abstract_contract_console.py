...
from .abstract_rpcs import rpc_win_while,get_rpc_layout,get_rpc_js,RPCData
from .abstract_abis import ABIBridge
from .abstract_accounts import AccountManager
import codecs
...
def get_account_layout():
    ...
    return agf("Frame", "Account", frame_layout)
