...
class ABIBridge:
    ...
    def get_try(self,request_url:str=None,service_name:str=None,low_limit:int=1,high_limit:int=5,limit_epoch:int=1,starting_tokens:int=5,epoch_cycle_adjustment:int=5):
        ...
        try:
            request = get_request(request_url=request_url,service_name=service_name,low_limit=low_limit,high_limit=high_limit,limit_epoch=limit_epoch,starting_tokens=starting_tokens,epoch_cycle_adjustment=epoch_cycle_adjustment)
        except:
            request = None
        return request
